    ...
    onBeforeDelete: function(fileRecord) {
      ...
      if (i !== -1) {
        ...
        if (confirm("Are you sure you want to delete this document?")) {
          ...
          this.deleteAppealDocument(fileRecord.docID);
        }
      }
    },

   deleteAppealDocument: async function (val) {
    // alert(val);
     const response = await servicesModule4.deleteAppealApprovalWritingDocument(val);
    },
