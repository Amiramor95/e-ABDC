...
export default {
  ...
  methods: {
    ...
    getAllDistApproval: async function() {
      const response = await servicesModule0.getAllDistApprovalList(92, "SECOND LEVEL APPROVAL");
    ...
    // data.append("DIST_APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("DIST_APPR_LEVEL_NAME", "SECOND LEVEL APPROVAL");
        data.append("DIST_APPR_PROCESSFLOW_ID", 92);
        try {
