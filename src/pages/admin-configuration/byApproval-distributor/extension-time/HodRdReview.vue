      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">THIRD LEVEL APPROVAL</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllDistApproval: async function() {
      const response = await servicesModule0.getAllDistApprovalList(93, "THIRD LEVEL APPROVAL");
    ...
    // data.append("DIST_APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("DIST_APPR_LEVEL_NAME", "THIRD LEVEL APPROVAL");
        data.append("DIST_APPR_PROCESSFLOW_ID", 93);
        try {
