      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">GM Recommendation Review11111111</h4>
                <div class="ml-3">
                  <form>
                    <vue-form-generator
                      tag="div"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(58, "GM RECOMMENDATION REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       const data = new FormData();
        ...
        data.append("APPR_AUTO_REJECT_DAYS", this.model.AUTO_REJECT_DAYS);
        data.append("APPR_PROCESSFLOW_ID", 58);
        data.append("APPR_LEVEL_NAME", "GM RECOMMENDATION REVIEW");
        try {
          // eslint-disable-next-line no-unused-vars
          const response = await servicesModule0.updateApprovalList(data);
