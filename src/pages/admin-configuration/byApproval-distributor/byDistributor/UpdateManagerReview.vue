...
export default {
  ...
  methods: {
    back () {
      this.$router.push("/fimm/updatedistributor-mainList");
    },
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(98, "MANAGER OF DISTRIBUTOR REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       ...
       data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_PROCESSFLOW_ID", 98);
        try {
