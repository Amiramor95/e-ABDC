        ...
        <div class="col-lg-10">
          <h4 slot="header">
            <i class="fa fa-sitemap"></i>&nbsp;&nbsp;
              CESSATION OF OPERATION - A(1)(c)(i)
          </h4>
        </div>
        <br />
        <div class="ml-5">
          <div>
            <span>FIRST LEVEL REVIEW</span>
            <button
...
export default {
  ...
  methods: {
    ...
    RdReview() {
      this.$router.push("/fimm/cessationDistributor-RdReview");
    },
      HodRdReview() {
      this.$router.push("/fimm/cessationDistributor-HodRdReview");
    },
