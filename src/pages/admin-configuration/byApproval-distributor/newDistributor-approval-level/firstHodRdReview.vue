...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(1, "FIRST LEVEL HOD REGISTRATION DEPARTMENT REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       ...
       console.log("Group Id=",this.model.GROUP_NAME.MANAGE_GROUP_ID);
        data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        data.append("APPR_LEVEL_NAME", "FIRST LEVEL HOD REGISTRATION DEPARTMENT REVIEW");
