      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">FIRST LEVEL REGISTRATION DEPARTMENT REVIEW</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(1, "FIRST LEVEL REGISTRATION DEPARTMENT REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       const data = new FormData();
        ...
        // console.log("APP_LEVEL_ID",this.APPROVAL_LEVEL_ID);
        try {
