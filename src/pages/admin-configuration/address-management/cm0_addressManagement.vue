  ...
  <va-card>
       ...
       <!-- <div class="float-right">
        ...
        <br/>
          ...
          <va-card>
              ...
              @select="filesSelectedState($event)"
              @beforedelete="onBeforeDeleteState($event)"
              v-model="fileRecords"
              ></VueFileAgent>
        <br/>
            <div class="float-right">
    ...
    <br/>
        ...
        <VueFileAgent
          ...
          @select="filesSelectedPost($event)"
          @beforedelete="onBeforeDeletePost($event)"
          v-model="fileRecords"
        ></VueFileAgent>
        <br/>
            <div class="float-right">
...
export default {
  ...
  watch: {
    '$store.getters.paletteText': function() {
      ...
      this.colorTextStyle = 'color: white';
    },
  ...
  methods: {
    ...
    handleClick (newTab) { 
      ...
      //this.tabActiveClass ="ssssssssss"
      this.term='';
      this.fileRecords=[];
       }, // end tab
...
// Country
    filesSelected: function (fileRecordsNewlySelected) {
        ...
        if(filename != 'country_bulk_upload.xlsx'){
    ...
    // State
        filesSelectedState: function (fileRecordsNewlySelected) {
        console.log(fileRecordsNewlySelected);
        //  this.uploadFileObject = [];
        var validFileRecords = fileRecordsNewlySelected.filter(
        (fileRecord) => !fileRecord.error
        ...
        if(filename != 'state_bulk_upload.xlsx'){
          this.isDisabledState= true;
          alert("Please Choose Correct File");
          this.onBeforeDeleteState(fileRecordsNewlySelected);
        }
        else{
          this.fileRecordsForUpload = this.fileRecordsForUpload.concat(
          validFileRecords
     ...
     // Post Code
        filesSelectedPost: function (fileRecordsNewlySelected) {
        console.log(fileRecordsNewlySelected);
        //  this.uploadFileObject = [];
        var validFileRecords = fileRecordsNewlySelected.filter(
        (fileRecord) => !fileRecord.error
        ...
        if(filename != 'postalcode_bulk_upload.xlsx'){
          this.isDisabledPost= true;
          alert("Please Choose Correct File");
          this.onBeforeDeletePost(fileRecordsNewlySelected);
        }
        else{
          this.fileRecordsForUpload = this.fileRecordsForUpload.concat(
          validFileRecords
    ...
    async bulkUploadState() {
      ...
      fileReader.onload = async function (e) {
        ...
        await servicesModule0.bulkUploadState(JSON.stringify(content));
          ...
          this.fileRecords="";
          this.uploadFileObject="";
          this.onBeforeDeleteState(files);
          this.isDisabledState = true;
          this.getAllState();
    ...
    // State
     onBeforeDeleteState: function (fileRecord) {
       this.isDisabledState= true;
      var i = this.fileRecordsForUpload.indexOf(fileRecord);
      if (i !== -1) {
        console.log("before delete");
    ...
    // State
     onBeforeDeletePost: function (fileRecord) {
       this.isDisabledPost= true;
      var i = this.fileRecordsForUpload.indexOf(fileRecord);
      if (i !== -1) {
        console.log("before delete");
