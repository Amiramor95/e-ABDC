      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">SECOND LEVEL LEGAL AND REGULATORY APPROVAL</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(28, "GM LRA REVIEW");
  ...
  this.APPROVAL_LEVEL_ID = response.APPROVAL_LEVEL_ID;
    ...
    // data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_LEVEL_NAME", "GM LRA REVIEW");
