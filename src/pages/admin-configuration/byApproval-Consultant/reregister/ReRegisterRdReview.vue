      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">Registration Department Review</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(36, "HEAD OF DEPARTMENT REGISTRATION DEPARTMENT REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       const data = new FormData();
        ...
        data.append("APPR_PROCESSFLOW_ID", 36);
        try {
