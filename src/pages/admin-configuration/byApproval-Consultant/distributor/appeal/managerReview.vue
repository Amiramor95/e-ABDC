...
export default {
  ...
  methods: {
    back () {
      this.$router.push("/fimm/appealConsultant-mainList");
    },
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(114, "MANAGER OF DISTRIBUTOR REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       ...
       data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_PROCESSFLOW_ID", 114);
        try {
