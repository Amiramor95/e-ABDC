...
export default {
  ...
  methods: {
    back () {
      this.$router.push("/fimm/exemptionConsultant-mainList");
    },
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(105, "ADMINISTRATOR FOR DISTRIBUTOR");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       ...
       data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_PROCESSFLOW_ID", 105);
        try {
