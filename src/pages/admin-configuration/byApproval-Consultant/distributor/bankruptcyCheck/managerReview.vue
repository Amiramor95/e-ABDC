...
export default {
  ...
  methods: {
    back () {
      this.$router.push("/fimm/bankruptcyConsultant-mainList");
    },
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(113, "MANAGER OF DISTRIBUTOR REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       ...
       data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_PROCESSFLOW_ID", 113);
        try {
