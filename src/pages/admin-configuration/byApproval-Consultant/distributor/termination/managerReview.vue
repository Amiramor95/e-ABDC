...
export default {
  ...
  methods: {
    back () {
      this.$router.push("/fimm/terminationConsultant-mainList");
    },
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(107, "MANAGER OF DISTRIBUTOR REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       ...
       data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_PROCESSFLOW_ID", 107);
        try {
