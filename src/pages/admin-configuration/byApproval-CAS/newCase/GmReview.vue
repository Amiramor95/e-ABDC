      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">FIMM GENERAL MANAGER OF REGULATORY SERVICES DIVISION </h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(96, "FIMM GENERAL MANAGER OF REGULATORY SERVICES DIVISION ");
    ...
    async submit() {
     ...
     data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_LEVEL_NAME", "FIMM GENERAL MANAGER OF REGULATORY SERVICES DIVISION ");
        data.append("APPR_PROCESSFLOW_ID", 96);
        try {
