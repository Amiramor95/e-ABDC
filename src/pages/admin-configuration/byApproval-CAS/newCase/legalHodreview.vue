      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">FIMM HOD LEGAL AND REGULATORY AFFAIR REVIEW</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(95, "FIMM HOD LEGAL AND REGULATORY AFFAIR REVIEW");
  ...
  this.APPROVAL_LEVEL_ID = response.APPROVAL_LEVEL_ID;
    ...
    async submit() {
     ...
     data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_LEVEL_NAME", "FIMM HOD LEGAL AND REGULATORY AFFAIR REVIEW");
        data.append("APPR_PROCESSFLOW_ID", 95);
        try {
