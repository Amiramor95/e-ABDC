...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(87, "PROFESSIONAL DEVELOPMENT APPROVAL");
    ...
    // data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_LEVEL_NAME", "PROFESSIONAL DEVELOPMENT APPROVAL");
        data.append("APPR_PROCESSFLOW_ID", 87);
        try {
