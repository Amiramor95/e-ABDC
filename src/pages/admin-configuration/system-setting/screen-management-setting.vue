  ...
  <div class="card-body">
    <div class="row justify-content-center">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        ...
        <div class="ml-5">
          <div>
            <span>Division, Department, Group and Authorization Level</span>
...
export default {
  ...
  methods: {
    ...
    screenModule() {
      this.$router.push("/fimm/screen-module");
    },
     screenAccess() {
      //this.$router.push("/fimm/screen-access");
      this.$router.push("/fimm/role-matrix-setting");
    },
    approvalLevel() {
    ...
    inactiveUser(id){
      ...
      this.$router.push("/fimm/inactive-user/"+id);
    },
  }
};
</script>
