    ...
    <div class="row justify-content-center">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        <h5>
          ...
          <b>Other Access Setup</b>
        </h5>
        <hr />
        <div class="ml-5">
          <div>
            <span>Distributor Screen Management & Roles</span>
            <button
              @click="Distributor"
              v-b-toggle.collapse-35
              type="button"
           ...
           <div>
            <span>Distributor Approval Level</span>
            <button
              @click="distributorapproval"
              v-b-toggle.collapse-35
              type="button"
              class="float-right  btn-fill btn-md"
            >
          ...
          <div>
            <span>Consultant Screen Management</span>
            <button
              @click="Consultant"
              v-b-toggle.collapse-35
              type="button"
          ...
          <div>
            <span>3rd Party Screen Management & Roles</span>
            <button
              @click="Third"
              v-b-toggle.collapse-35
              type="button"
          ...
          <div>
            <span>Training Provider Screen Management & Roles</span>
            <button
              @click="Training"
              v-b-toggle.collapse-35
              type="button"
...
export default {
  ...
  methods: {
    Distributor() {
      this.$router.push("/fimm/d-mainlist");
    },
    Consultant() {
      this.$router.push("/fimm/c-mainlist");
    },
    Third() {
      this.$router.push("/fimm/third-mainlist");
    },
    Training() {
      this.$router.push("/fimm/tp-mainlist"); 
    },
