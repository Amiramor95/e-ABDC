  ...
  <div class="card-body">
    <div class="row justify-content-center">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        <h5>
          <i class="fa fa-bank"></i>&nbsp;&nbsp; <b>ANNUAL FEES MANAGEMENT</b>
        </h5>
        <hr />
        <div class="ml-5">
          <div>
            <span>Annual Fee Freeze Period </span>
            <button
              @click="FreezePeriod"
              type="button"
            ...
            <div>
            <span>Annual Fee Invoice Setting </span>
            <button
              @click="Invoice"
              type="button"
              class="float-right btn-fill btn-md"
...
export default {
  ...
  methods: {
        ...
        annual_sub1_declaration() {
        this.$router.push("/fimm/annual_fee_sub_declaration");
        },
        FreezePeriod() {
        this.$router.push("/fimm/annualFee-configuration");
        },
        Invoice() {
        this.$router.push("/fimm/annualFee-invoice-configuration");
        },
  }
};
</script>
