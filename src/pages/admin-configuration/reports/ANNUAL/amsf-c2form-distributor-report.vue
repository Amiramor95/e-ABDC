...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Form C2 *External Distributor (UTMC,PRP)
    </h4>
    <br />
    <div>
      <div>
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
       ...
       setTimeout(()=>{
         ...
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`amsfc2formdistributorreport?q=`+ encodedID +`" width="100%" ></iframe>`;
