...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Form B1 *External Distributor (IUTA,CPRA,CUTA,IPRA)
    </h4>
    <br />
    <div>
      <div>
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
       ...
       setTimeout(()=>{
         ...
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`amsfb1formdistributorreport?q=`+ encodedID +`" width="100%" ></iframe>`;
