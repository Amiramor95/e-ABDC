...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Form B2 *External Distributor (IUTA,CPRA,CUTA,IPRA)
    </h4>
    <br />
    <div>
      <div>
...
export default {
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
        ...
        const userDistID= 2;//this.userdata.USER_DIST_ID;
       setTimeout(()=>{
         this.isDataReady = true;
       }, 10000);
         var encodedID = btoa(userID+'/'+userTYPE+'/'+userDistID);
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`amsfb2formdistributorreport?q=`+ encodedID +`" width="100%" ></iframe>`;
