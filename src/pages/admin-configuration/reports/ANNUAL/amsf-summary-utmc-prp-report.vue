...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Summary Report Annual Membership Fees/Annual Fee Payment (UTMC-PRP) Year X
    </h4>
    <br />
    <div>
      <div>
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
       ...
       setTimeout(()=>{
         ...
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`amsfsummaryutmcprpreport?q=`+ encodedID +`" width="100%" ></iframe>`;
