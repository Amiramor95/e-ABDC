...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Summary Report UTF Subscription Fees for YX (UTMC)
    </h4>
    <br />
    <div>
      <div>
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
       ...
       setTimeout(()=>{
         ...
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`amsfsummaryutmcreport?q=`+ encodedID +`" width="100%" ></iframe>`;
