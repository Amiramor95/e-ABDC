...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Newspaper/Publication Contact Person
    </h4>
    <br />
    <div>
      <div>
...
export default {
  ...
  methods: {
    back() {
      this.$router.push("/fimm/fund-report-main-setting");
    },
    getCasUtcTaggingListReport: async function() {
       ...
       setTimeout(()=>{
         ...
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`fundnewspapercontactreport?q=`+ encodedID +`" width="100%" ></iframe>`;
