  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
         ...
         this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`fundhistoricalnavdetailreport?q=`+ encodedID +`" width="100%" ></iframe>`;
