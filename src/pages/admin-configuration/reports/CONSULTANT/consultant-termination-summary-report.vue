...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Consultants Termination Summary Report
    </h4>
    <br />
    <div>
      <div>
...
export default {
  ...
  methods: {
    back() {
      this.$router.push("/fimm/consultant-report-main-setting");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`consultantterminationsummaryreport?q=`+ encodedID +`" width="100%" ></iframe>`;
