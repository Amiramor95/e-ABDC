...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;PRC Variation/Exemption Summary List (PRS System)
    </h4>
    <br />
    <div>
      <div>
...
export default {
  ...
  methods: {
    back() {
      this.$router.push("/fimm/finance-report-main-setting");
    },
    ...
    //     this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`financeprcreport?q=`+ encodedID +`" width="100%" ></iframe>`;
