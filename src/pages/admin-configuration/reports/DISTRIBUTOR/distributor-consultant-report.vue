...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Consultants by Distribution Point
    </h4>
    <br />
    <div>
      <div>
...
export default {
  ...
  methods: {
    back() {
      this.$router.push("/fimm/distributor-report-main-setting");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`consultantbydistributorpointsreport?q=`+ encodedID +`" width="100%" ></iframe>`;
