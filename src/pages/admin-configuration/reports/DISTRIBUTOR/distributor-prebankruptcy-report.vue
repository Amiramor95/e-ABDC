...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;Pre-Registration Bankruptcy Check Report
    </h4>
    <br />
    <div>
      <div>
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`preregbankruptcyreport?q=`+ encodedID +`" width="100%" ></iframe>`;
