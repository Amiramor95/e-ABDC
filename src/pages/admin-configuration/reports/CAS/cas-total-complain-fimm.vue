...
export default {
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cas-report-main-setting");
    },
    getCasEnquiryReport: async function () {
      ...
      var encodedID = btoa(userID+'/'+userTYPE);
       this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cascomplainbyfimm?q=`+ encodedID +`" width="100%" ></iframe>`;
    },
  },
};
</script>
