...
export default {
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cpd-report-main-setting");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdacademicconsultant?q=`+ encodedID +`" width="100%" ></iframe>`;
