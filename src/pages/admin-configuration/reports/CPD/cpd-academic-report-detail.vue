...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      <i class="va-icon app-sidebar-link__item-icon fa fa-balance-scale"></i
      >&nbsp;&nbsp;List of Obtaining Academic or Professional Qualifications
    </h4>
    <br />
    <div>
      <!-- <div class="content"> -->
...
export default {
  mounted() {
    ...
    //console.log("CONSULTANT=",this.$route.params.consultantid);
  },
 props: ["id"],
  components: {
    Tabs,
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cpd-academic-report");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        var encodedID = btoa(userID+'/'+userTYPE+'/'+consultantID);
       this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdacademicconsultantreport?q=`+ encodedID +`" width="100%" ></iframe>`;
    },
  },
};
</script>
