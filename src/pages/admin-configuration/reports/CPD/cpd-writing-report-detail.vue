...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;List of Writing and Publishing Books & Articles
    </h4>
    <br />
    <div>
      <!-- <div class="content"> -->
...
export default {
 ...
 props: ["id"],
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cpd-writing-report");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdwritingconsultantreport?q=`+ encodedID +`" width="100%" ></iframe>`;
