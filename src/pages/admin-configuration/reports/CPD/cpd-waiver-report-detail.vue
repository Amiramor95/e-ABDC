...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;List of Waiver From CPD Requirements
    </h4>
    <br />
    <div>
      <!-- <div class="content"> -->
...
export default {
 ...
 props: ["id"],
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cpd-waiver-report");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdwaiverconsultantreport?q=`+ encodedID +`" width="100%" ></iframe>`;
