...
export default {
 ...
 props: ["id"],
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cpd-fpam-report");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdfpamconsultantreport?q=`+ encodedID +`" width="100%" ></iframe>`;
