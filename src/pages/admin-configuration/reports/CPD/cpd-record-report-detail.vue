...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;List of Participant Record (CPD Program)
    </h4>
    <br />
    <div>
      <!-- <div class="content"> -->
...
export default {
 ...
 props: ["id"],
  ...
  methods: {
    back() {
      this.$router.push("/fimm/cpd-record-report");
    },
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdrecordprogramreport?q=`+ encodedID +`" width="100%" ></iframe>`;
    },
  },
};
</script>
