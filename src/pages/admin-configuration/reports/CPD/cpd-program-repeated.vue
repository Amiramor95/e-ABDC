...
<template>
  <va-card>
    <h4 slot="header" class="card-title">
      ...
      >&nbsp;&nbsp;List of CPD Program (Secretariat) - Repeated
    </h4>
    <br />
    <div>
      <!-- <div class="content"> -->
  ...
  methods: {
    ...
    getCasUtcTaggingListReport: async function() {
      ...
      setTimeout(()=>{
        ...
        this.legacySystemHTML = `<iframe id="report1" src="`+Vue.config.KoolServerURL+`cpdprogramrepeated?q=`+ encodedID +`" width="100%" ></iframe>`;
    },
  },
};
</script>
