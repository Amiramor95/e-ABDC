<template>
  <va-card>
    ...
    <div v-else>
      ...
      <div class="row">
        <h4 slot="header" class="card-title">User List For Approval</h4>
        <br />
      ...
      <va-card class="mt-5 col-12">
        ...
        >
          ...
          <template slot="actions" slot-scope="props">
            <h5 class="mt-1">
              <span
                v-if="props.rowData.USER_STATUS == 1"
                v-b-tooltip.hover
                title="edit"
                v-on:click="viewRecord(props.rowData.USER_ID)"
              ...
              >
                ...
                v-b-tooltip.hover
                title="edit"
                v-on:click="viewDetails(props.rowData.USER_ID)"
                class="badge badge-primary mr-2"
              >
...
export default {
  ...
  methods: {
    // searh
    searchUserList: debounce(function (term) {
      this.term = term
    ...
    getUserInformation: async function () {
      ...
      const response = await servicesModule04.getUserInformation(dept);
        ...
        return this.term
          ...
          .every(
            (v) =>
              ...
              item.USER_EMAIL.toLowerCase().includes(v) ||
