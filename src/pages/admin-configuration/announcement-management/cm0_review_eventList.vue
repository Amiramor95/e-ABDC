<template>
  <va-card>
    ...
    <div v-else >
        ...
        <div class="row">
          <div class="col">
            <h4 class="card-title">  REVIEW: LIST OF {{DIPT_NAME}} DEPARTMENT ANNOUNCEMENT </h4>
          </div>
...
export default {
  ...
  methods: {
    ...
    async getAllEvent() {
      ...
      const response = await servicesModule0.getReviewAnnouncement(null,null,dept);
      this.items = response;
   ...
   search: debounce(function (term) {
    ...
    async searchAnnouce() {
      ...
      var dept = this.$route.params.MANAGE_DEPARTMENT_ID; //1:RD , 2:LRA, 3:SUPERVISION, 4:IDS, 5:PDS, 6:RA, 7:IT, 8:FIN 
