...
export default {
  ...
  methods: {
    ...
    async getAllEvent() {
      const response = await servicesModule0.getAllEvent('PROFESSIONAL DEVELOPMENT');
    ...
    async saveAsDraft() {
      ...
      data.append('EVENT_TYPE', 'PROFESSIONAL DEVELOPMENT');
   ...
   async submit() {
      ...
      // data.append('APPROVAL_LEVEL_ID', 29);
