  ...
  <va-card>
    ...
    >
      ...
      <template slot="ANNOUNCEMENT_STATUS" slot-scope="props">
        <div v-if="props.rowData.CIRCULAR_STATUS == 1">
          Draft
        </div>
        <div v-if="props.rowData.CIRCULAR_STATUS == 2">
          Publish
        </div>
      </template>
      <template slot="actions" slot-scope="props">
        <h4 class="mt-2">
          <span
            v-if="props.rowData.CIRCULAR_STATUS == 2"
            v-b-tooltip.hover
            title="detail"
          ...
          ></span>
          <span
            v-if="props.rowData.CIRCULAR_STATUS == 1"
            v-b-tooltip.hover
            title="edit"
...
export default {
  ...
  methods: {
    ...
    async getAllEvent() {
      ...
      const response = await servicesModule0.getAllCircular('SUPERVISION');
      this.items = response;
   ...
   search: debounce(function (term) {
    ...
    edit(data) {
      ...
      this.$router.push({
        name: "supervision-update-circular",
        params: { CIRCULAR_EVENT_ID: data.CIRCULAR_EVENT_ID }
      });
    },

    create() {
      this.$router.push("/fimm/supervision-new-event");
    },
