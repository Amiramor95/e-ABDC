  ...
  <va-card>
    ...
    <div v-else>
      <h4 slot="header" class="card-title">
        Circular Details For HOD Review
      </h4>
      <br />
  ...
  methods: {
    ...
    async updateData(type) {
      ...
      if(type == 'approve'){
        ...
        data.append("NOTI_LOCATION", "rd-gm-review-circular-List/"+ dept);
      	data.append("NOTI_REMARK","(CIRCULAR) New Entry for GM approval");
      ...
      try {
        if (confirm($sms)){
          ...
          const response = await servicesModule0.reviewCircularUpdate(data);
    ...
    getApprovalLevel(dept){
        if(dept == 1){
          return services06Module0.getApprovalLevel(67,2);
        }else if(dept == 2){
          return services06Module0.getApprovalLevel(69,2);
        }else if(dept == 3){
          return services06Module0.getApprovalLevel(68,2);
        }else if(dept == 4){
          return services06Module0.getApprovalLevel(70,2);
        }else if(dept == 5){
          return services06Module0.getApprovalLevel(71,2);
        }else if(dept == 6){
          return services06Module0.getApprovalLevel(72,2);
        }else if(dept == 7){
          return services06Module0.getApprovalLevel(73,2);
        }else if(dept == 8){
          return services06Module0.getApprovalLevel(74,2);
        }else{
          return [];
        }
    },
