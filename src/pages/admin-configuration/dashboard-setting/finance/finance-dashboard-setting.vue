    ...
    <div class="row justify-content-center">
     ...
     <div class="text-center text-danger my-2 align-center" v-if="!isDataReady">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        <h5>
          <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp; <b>FINANCE Dashboard Setting</b>
        </h5>
        <hr />
        <div class="ml-5">
...
export default {
  ...
  methods: {
    ...
    getFinanceSetting: async function() {
       ...
       {
        const response = await servicesModule0.getFinanceSettingList(userID,userTYPE,accessuserDivision,accessuserDepartment,accessuserGROUP);
   ...
   async submit() {
      ...
      if(allCheckedSetting <=6)
      {
        try {
              // eslint-disable-next-line no-unused-vars
            const response = await servicesModule0.createFinanceDashboardSetting(checklist,userID,userTYPE,userGROUP,accessuserDivision,accessuserDepartment,accessuserGROUP);
            this.getFinanceSetting();
