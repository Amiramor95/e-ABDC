...
<template>
  <va-card>
      ...
      <div class="header">EDIT FMS DASHBOARD SETTING<i class="close icon">&times;</i></div>
      <div class="content">
        <vue-form-generator
          :model="model"
    ...
    <h4 slot="header" class="card-title"> <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp;DISTRIBUTOR DASHBOARD STATISTICS</h4>
    <br />
    <div>
      <!-- <div class="content"> -->
      <div>
        <div class="ml-5">
          ...
          <br />
          <br />
          <h4>LIST OF DISTRIBUTOR DASHBOARD</h4>
...
export default {
  ...
  data () {
    return {
      ...
      subtypeList:[
        {'type_id' : 1,'usergroup': 'EXTERNAL USER'},
        {'type_id' : 2,'usergroup': 'RD USER'}
                  ],
      model: {
        // TAB 1
        DASHBOARD_MAIN_ID: '',
  ...
  methods: {
   ...
   back() {
    ...
    const response = await servicesModule0.getDistributorDashboardSetting("DISTRIBUTOR");
