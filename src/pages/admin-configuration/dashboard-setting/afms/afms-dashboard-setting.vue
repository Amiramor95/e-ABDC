    ...
    <div class="row justify-content-center">
     ...
     <div class="text-center text-danger my-2 align-center" v-if="!isDataReady">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        <h5>
          <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp; <b>ANNUAL FEE Dashboard Setting</b>
        </h5>
        <hr />
        <div class="ml-5">
  ...
  methods: {
    ...
    this.$router.push("/fimm/afms-dashboard-main-setting");
     ...
     onConfigUpdated: async function (newVal, schema) {
      ...
      else  if(schema == "DASHBOARD_SUB_TYPE"){
         this.getAnnualSetting();
         //this.subtypeList();
      ...
      if(event.target.checked) {
       ...
       // console.log("Checklist1=",this.distributorSettingList);
        ...
        if (totalcheck <= 5) {
         ...
         if(id != '')
         {
         const response = await servicesModule0.deleteAnnualDashboardSetting(id);
          this.getAnnualSetting();
         }
    ...
    getAnnualSetting: async function() {
       // console.log("UserTYPE=",this.userdata.user_type);
        ...
        const typeID = this.model.DASHBOARD_SUB_TYPE.type_id;
         if(typeof accessuserDivision != 'undefined' && typeof accessuserDepartment != 'undefined' && typeof accessuserGROUP != 'undefined' && typeof typeID != 'undefined')
          {
        const response = await servicesModule0.getAnnualSettingList(userID,userTYPE,userGROUP,accessuserDivision,accessuserDepartment,accessuserGROUP,typeID);
   ...
   async submit() {
      ...
      if(allCheckedSetting <=6)
      {
        try {
              // eslint-disable-next-line no-unused-vars
            const response = await servicesModule0.createAnnualDashboardSetting(checklist,userID,userTYPE,userGROUP,accessuserDivision,accessuserDepartment,accessuserGROUP,typeID);
            this.getAnnualSetting();
