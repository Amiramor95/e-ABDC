...
<template>
  <va-card>
      ...
      <div class="header">EDIT CONSULTANT ALERT DASHBOARD SETTING<i class="close icon">&times;</i></div>
      <div class="content">
        <vue-form-generator
          :model="model"
    ...
    <h4 slot="header" class="card-title"> <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp;CONSULTANT ALERT DASHBOARD STATISTICS</h4>
    <br />
    <div>
      <!-- <div class="content"> -->
      <div>
        <div class="ml-5">
          ...
          <br />
          <br />
          <h4>LIST OF CONSULTANT ALERT DASHBOARD</h4>
...
export default {
  ...
  methods: {
   ...
   back() {
    ...
    const response = await servicesModule0.getDistributorDashboardSetting("CAS");
    ...
    async addStatistic () {
        if (this.$refs.Tab1Form.validate()) {
            ...
            data.append('DASHBOARD_DESCRIPTION', this.model.DASHBOARD_DESCRIPTION)
             data.append('DASHBOARD_TYPE', 'CAS')
