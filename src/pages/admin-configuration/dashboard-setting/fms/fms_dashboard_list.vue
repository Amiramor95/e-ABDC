...
<template>
  <va-card>
    ...
    <h4 slot="header" class="card-title"> <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp;FMS DASHBOARD STATISTICS</h4>
    <br />
    <div>
      <!-- <div class="content"> -->
      <div>
...
export default {
  ...
  data () {
    return {
      ...
      subtypeList:[
        {'type_id' : 1,'usergroup': 'R&A and ID'},
        {'type_id' : 2,'usergroup': 'RD'}
                  ],
      model: {
        // TAB 1
        DASHBOARD_MAIN_ID: '',
  ...
  methods: {
   ...
   back() {
    ...
    const response = await servicesModule0.getDistributorDashboardSetting("FMS");
    ...
    async addStatistic () {
        if (this.$refs.Tab1Form.validate()) {
            ...
            data.append('DASHBOARD_TYPE', 'FMS')
