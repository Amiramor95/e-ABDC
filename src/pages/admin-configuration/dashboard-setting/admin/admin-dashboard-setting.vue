    ...
    <div class="row justify-content-center">
     ...
     <div class="text-center text-danger my-2 align-center" v-if="!isDataReady">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        <h5>
          <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp; <b>ADMIN Dashboard Setting</b>
        </h5>
        <hr />
        <div class="ml-5">
  ...
  methods: {
      ...
      if(event.target.checked) {
       ...
       // console.log("Checklist1=",this.distributorSettingList);
        ...
        if (totalcheck <= 5) {
         ...
         if(id != '')
         {
         const response = await servicesModule0.deleteAdminDashboardSetting(id);
          this.getADMINSetting();
         }
    ...
    getADMINSetting: async function() {
       // console.log("UserTYPE=",this.userdata.user_type);
        ...
        {
          const response = await servicesModule0.getADMINSettingList(userID,userTYPE,accessuserDivision,accessuserDepartment,accessuserGROUP);
   ...
   async submit() {
      ...
      if(allCheckedSetting <=6)
      {
        try {
              // eslint-disable-next-line no-unused-vars
            const response = await servicesModule0.createAdminDashboardSetting(checklist,userID,userTYPE,accessuserDivision,accessuserDepartment,accessuserGROUP);
            this.getADMINSetting();
