...
<template>
  <va-card>
      ...
      <div class="header">EDIT ADMIN DASHBOARD SETTING<i class="close icon">&times;</i></div>
      <div class="content">
        <vue-form-generator
          :model="model"
    ...
    <h4 slot="header" class="card-title"> <i class="va-icon app-sidebar-link__item-icon vuestic-iconset vuestic-iconset-dashboard"></i>&nbsp;&nbsp;ADMIN DASHBOARD STATISTICS</h4>
    <br />
    <div>
      <!-- <div class="content"> -->
      <div>
...
export default {
  ...
  methods: {
   ...
   back() {
    ...
    const response = await servicesModule0.getDistributorDashboardSetting("ADMIN");
    ...
    async addStatistic () {
        if (this.$refs.Tab1Form.validate()) {
            ...
            data.append('DASHBOARD_DESCRIPTION', this.model.DASHBOARD_DESCRIPTION)
             data.append('DASHBOARD_TYPE', 'ADMIN')
