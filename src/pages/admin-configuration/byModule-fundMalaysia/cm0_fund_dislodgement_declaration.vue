...
<template>
  <va-card>
      ...
      <div class="header">Edit Fund Dislodgement Declaration<i class="close icon">&times;</i></div>
      <div class="content">
        <vue-form-generator
          :model="model"
    ...
    <h5>
          <i class="fa fa-bank"></i>&nbsp;&nbsp; <b>Fund Dislodgement Declaration</b>
        </h5>
        <hr />
    <div>
      <tabs
...
export default {
  ...
  methods: {
    ...
    const response = await servicesModule0.getAllDistributorRegistrationDeclaration("FUND","dislodgement");
    ...
    async addRegDec () {
        if (this.$refs.Tab1Form.validate()) {
            ...
            data.append('DECLARATION_SET_TYPE', 'dislodgement')
