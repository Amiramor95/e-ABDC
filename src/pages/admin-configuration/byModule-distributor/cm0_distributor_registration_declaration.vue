...
export default {
  ...
  methods: {
    ...
    const response = await servicesModule0.getAllDistributorRegistrationDeclaration("DISTRIBUTOR","registration");
    ...
    async addRegDec () {
        if (this.$refs.Tab1Form.validate()) {
            ...
            data.append('DECLARATION_SET_PARAM', 'DISTRIBUTOR')
            try {
              // eslint-disable-next-line no-unused-vars
