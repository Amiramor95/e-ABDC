...
export default {
  ...
  methods: {
    ...
    async editModule(data) {
      ...
      this.model.selectedIcon2 = response.CONSULTANT_MOD_ICON;
      //console.log(response);
      this.isLoader = false; // Kill loder
    },
    async updateModuleAPI() {
      if (this.$refs.editTab1Form.validate()) {
        try {
          ...
          data.append("CONSULTANT_MOD_ICON", this.model.selectedIcon2);      
    ...
    async addScreen() {
      if (this.$refs.Tab3Form.validate()) {
        try {
          ...
          data.append("CONSULTANT_SCREEN_CODE", this.model.addScreen.CONSULTANT_SCREEN_CODE);
    ...
    async editScreen(data) {
      ...
      console.log(response);
        ...
        this.model.editScreen.CONSULTANT_SCREEN_CODE = response.CONSULTANT_SCREEN_CODE;
    ...
    async updateScreenAPI() {
      if (this.$refs.editTab3Form.validate()) {
        try {
          ...
          data.append("CONSULTANT_SCREEN_CODE", this.model.editScreen.CONSULTANT_SCREEN_CODE);
    ...
    onModuleData: async function (newVal, schema) { 
      ...
      if (schema == "addScreen.CONSULTANT_MODULE_ID" || schema == "editScreen.CONSULTANT_SC_MODULE_ID" && newVal) {
    ...
    resetFormData(){
      this.model.CONSULTANT_MOD_CODE = '';
      this.model.CONSULTANT_MOD_NAME = '';
      this.model.CONSULTANT_MOD_SNAME = '';
      this.model.CONSULTANT_MOD_INDEX = '';
      this.model.selectedIcon1 = '';

      this.model.CONSULTANT_MODULE_ID = '';
      this.model.CONSULTANT_SUBMODULE_NAME = '';
      this.model.CONSULTANT_SUBMODULE_CODE = '';

      this.model.addScreen.CONSULTANT_MODULE_ID = '';
      this.model.addScreen.CONSULTANT_MANAGE_SUBMODULE_ID = '';
      this.model.addScreen.CONSULTANT_SCREEN_PROCESS_ID = '';
      this.model.addScreen.CONSULTANT_SCREEN_NAME = '';
      this.model.addScreen.CONSULTANT_SCREEN_ROUTE = '';
      this.model.addScreen.CONSULTANT_SCREEN_DESC = '';
      this.model.addScreen.CONSULTANT_SCREEN_CODE = '';
      this.model.CONSULTANT_GROUP_NAME = '';
    },
    ...
    GroupNameFilteredData() {
      ...
      return this.groupList.filter((item) => {
        return this.term
          ...
          .every(
            (v) =>
              item.CONSULTANT_GROUP_NAME.toLowerCase().includes(v),
          );
      });
    },
    ...
    moduleFilteredData() {
      ...
      return this.moduleList.filter((item) => {
        return this.term
          ...
          .every(
            (v) =>
              item.CONSULTANT_MOD_CODE.toLowerCase().includes(v) ||
              item.CONSULTANT_MOD_NAME.toLowerCase().includes(v) ||
              item.CONSULTANT_MOD_SNAME.toLowerCase().includes(v) 
          );
      });
    },
    ...
    submoduleFilteredData() {
      ...
      return this.submoduleList.filter((item) => {
        return this.term
          ...
          .every(
            (v) =>
              item.CONSULTANT_SUBMODULE_NAME.toLowerCase().includes(v) ||
              item.CONSULTANT_SUBMODULE_CODE.toLowerCase().includes(v) ||
              item.CONSULTANT_MOD_NAME.toLowerCase().includes(v) 
          );
      });
    },
      ...
      return this.screenList.filter((item) => {
        return this.term
          ...
          .every(
            (v) =>
              item.CONSULTANT_MOD_NAME.toLowerCase().includes(v) ||
              item.CONSULTANT_SCREEN_NAME.toLowerCase().includes(v) ||
              item.CONSULTANT_SCREEN_DESC.toLowerCase().includes(v) ||
              item.CONSULTANT_SUBMODULE_NAME.toLowerCase().includes(v) ||
              item.CONSULTANT_SCREEN_ROUTE.toLowerCase().includes(v) ||
              item.CONSULTANT_SCREEN_DESC.toLowerCase().includes(v) 
          );
      });
    },
            ...
            fields: [
              ...
              },
              {
                ...
                disabled: (model, schema) => {
                  if (this.model.addScreen.CONSULTANT_MODULE_ID.CONSULTANT_MANAGE_MODULE_ID) {
                    return false;
                  } else {
                    return true;
                  }
              ...
              },
              {
                ...
                inputType: "text",
                label: "Code",
                model: "addScreen.CONSULTANT_SCREEN_CODE",
                placeholder: "Enter Code",
                required: false,
                validator: "string",
                styleClasses: "col-md-6"
        ...
        groups: [
          {
            ...
            fields: [
              ...
              },
              {
                ...
                inputType: "text",
                label: "Code",
                model: "editScreen.CONSULTANT_SCREEN_CODE",
                placeholder: "Enter Code",
                required: true,
                validator: "string",
                styleClasses: "col-md-6"
