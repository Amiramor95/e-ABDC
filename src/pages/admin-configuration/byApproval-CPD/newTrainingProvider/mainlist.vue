  ...
  <div class="card-body">
    <div class="row justify-content-center">
      ...
      <va-card class="ml-4 col-lg-10 my-1 px-1">
        <div class="col-lg-10">
          <h4 slot="header">
            <i class="fa fa-sitemap"></i>&nbsp;&nbsp; New Training Provider - D(1)(g)
          </h4>
        </div>
        <br />
        <div class="ml-5">
...
export default {
  ...
  pds() {
      this.$router.push("/fimm/newTrainingProvider-PdsReview");
    },
    gm() {
      this.$router.push("/fimm/newTrainingProvider-GmReview");
    },
  },
};
</script>
