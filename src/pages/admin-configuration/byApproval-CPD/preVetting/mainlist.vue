  ...
  <div class="card-body">
    <div class="row justify-content-center">
      ...
      <va-card class="ml-4 col-lg-10 my-1 px-1">
        <div class="col-lg-10">
          <h4 slot="header">
            <i class="fa fa-sitemap"></i>&nbsp;&nbsp; Pre‐Vetting Submission - D(1)(b)
          </h4>
        </div>
        <br />
        <div class="ml-5">
...
export default {
  ...
  pds() {
      this.$router.push("/fimm/preVettingSubmission-PdsReview");
    },
    gm() {
      this.$router.push("/fimm/preVettingSubmission-GmReview");
    },
