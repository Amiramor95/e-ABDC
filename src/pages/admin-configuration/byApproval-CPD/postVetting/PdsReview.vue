      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">Professional Development Services Review</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(12, "PROFESSIONAL DEVELOPMENT SERVICES DEPARTMENT REVIEW");
    ...
    async submit() {
      if (this.$refs.Form.validate()) {
       const data = new FormData();
        ...
        data.append("APPR_LEVEL_NAME", "PROFESSIONAL DEVELOPMENT SERVICES DEPARTMENT REVIEW");
        data.append("APPR_PROCESSFLOW_ID", 12);
        try {
