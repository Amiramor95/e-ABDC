  ...
  <div class="card-body">
    <div class="row justify-content-center">
      ...
      <va-card class=" ml-4 col-lg-10 my-1 px-1">
        <h5>
          <i class="fa fa-bank"></i>&nbsp;&nbsp; <b>DECLARATION</b>
        </h5>
        <hr />
        <div class="ml-5">
          <div>
            <span>CONSULTANT REGISTRATION DECLARATION</span>
            <button
              @click="registration_declaration_consult"
              type="button"
           ...
           <div>
            <span>EXAM DECLARATION</span>
            <button
              @click="exam_declaration"
              type="button"
              class="float-right btn-fill btn-md"
            >
              <i class="fa fa-edit"></i>
