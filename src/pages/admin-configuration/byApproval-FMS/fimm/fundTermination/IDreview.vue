      ...
      <div class="container">
        <div class="card-body">
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <va-card>
                <h4 slot="header" class="card-title">Industry Development Review</h4>
                <div class="ml-3">
                    <vue-form-generator
                      tag="div"
                      :schema="schema"
...
export default {
  ...
  methods: {
    ...
    getAllApproval: async function() {
      const response = await servicesModule0.getAllApprovalList(24, "INDUSTRY DEVELOPMENT REVIEW");
  ...
  this.APPROVAL_LEVEL_ID = response.APPROVAL_LEVEL_ID;
    ...
    // data.append("APPROVAL_LEVEL_ID", this.APPROVAL_LEVEL_ID);
        ...
        data.append("APPR_LEVEL_NAME", "INDUSTRY DEVELOPMENT REVIEW");
        data.append("APPR_PROCESSFLOW_ID", 24);
        try {
