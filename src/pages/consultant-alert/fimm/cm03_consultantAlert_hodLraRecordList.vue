<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Consultant Alert : List of Cases Pending for Verification</h4>
      <br />
      <div class="col float-right">
        <div class="float-right">
          <h5>
            <span
              v-b-tooltip.hover
              title="List of Consultant Alert Record by Cases"
              v-on:click="viewList"
  ...
  methods: {
    ...
    async verifyCase(data) {
      localStorage.setItem(
        "consultantAlert-hodLraCaseVerification",
        JSON.stringify(data)
      );
      this.$router.push({
