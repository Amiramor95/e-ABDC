        ...
        <div class="col-12">
          ...
          <template v-else>
            ...
            <va-card>
              ...
              <div v-if="currentConsultant.APPEAL_STATUS_ID==14">
                <vue-form-generator
                  :model="model2"
                  :schema="tabSchema4"
                  :options="formOptions"
              ...
              <div class="float-right" v-if="currentConsultant.APPEAL_STATUS_ID==14">
                <button
                  @click="approveAppeal(7, 'Are you sure to return?')"
                  type="button"
                ...
                <button
                  @click="approveAppeal(42, 'Are you sure to reject?')"
                  type="button"
            ...
            <va-card class="mt-4">
              <div class="ml-2">
                ...
                <button
                  v-if="visibleLog"
                  v-b-toggle.appeal-approval-log-manager
                  type="button"
                ...
                <hr />
                <b-collapse id="appeal-approval-log-manager" class="mt-2" v-model="visibleLog">
                  <div class="row">
...
export default {
  ...
  methods: {
    ...
    async getConsultantRecord () {
      const response = await services04module2.getAppealForManagerApproval(this.distributorData.DISTRIBUTOR_ID)
    ...
    approveAppeal: async function (status, confirm_text) {
      if (confirm(confirm_text)) {
        try {
          ...
          data.append('DIST_MANAGER_REMARK', this.model2.DIST_MANAGER_REMARK == null ? '' : this.model2.DIST_MANAGER_REMARK)
          data.append('NOTI_APPROVE_REMARK', '(CONSULTANT APPEAL) Approved by Manager')
          data.append('NOTI_RETURN_REMARK', '(CONSULTANT APPEAL) Returned by Manager')
          data.append('NOTI_REJECT_REMARK', '(CONSULTANT APPEAL) Rejected by Manager')
          ...
          if (status != 14 && this.model2.DIST_MANAGER_REMARK == '') {
            Vue.$toast.open({
            ...
            this.show_overlay = true
            const response = await services04module2.appealdistributorManagerReview(data)
            if (response) {
              this.show_overlay = false
              Vue.$toast.open({
