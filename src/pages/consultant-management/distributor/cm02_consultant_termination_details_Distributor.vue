            ...
            <va-card v-else>
              <template>
                  ...
                  <div class="row" v-else>
                    ...
                    <div class="col-6 mb-2" v-if="this.model.TERMINATION_TYPE_OTHER_SPECIFY !=''">
...
export default {
  ...
  async mounted() {
    ...
    //
    // this.getStatus(DIST_INFO.DISTRIBUTOR_ID);
    ...
    this.model.TERMINATION_REMARK=this.currentConsultant.APPR_REMARK;
  ...
  data() {
    return {
      ...
      //     { key: 'DIST_NAME', label: 'DISTRIBUTOR NAME' },
      //     { key: 'DIST_PHONE_NO', label: 'PHONE NO' },
      //     { key: 'TOTAL_CONSULTANT', label: 'TOTAL APPLICATION' },
      ...
      //     { key: 'CONSULTANT_NRIC_PASSPORT_NO', label: 'NRIC NO/PASSPORT NO' },
      ...
      // distributorsAPI: [
      //   {
      //     DIST_NAME: 'A.D Financial Sdn Bhd',
      //     DIST_PHONE_NO: '03-2233114',
      //     TOTAL_CONSULTANT: 3,
      //   },
      //   { DIST_NAME: 'Affin Bank Berhad', DIST_PHONE_NO: '03-898856', TOTAL_CONSULTANT: 11 },
      //   {
      //     DIST_NAME: 'Affin Hwang Asset Management Berhad',
      //     DIST_PHONE_NO: '1-800-77-9080',
      //     TOTAL_CONSULTANT: 1,
      //   },
      // ],
  ...
  methods: {
    ...
    setCurrentConsultant(props) {
      ...
      // const existed = this.mappedSelectedConsultantArray.some(
      //   el => el === data.item.CONSULTANT_ID,
      // );
    ...
    async getStatus(DIST_ID){
      const response=await services02module2.getAllDraftedTermination(DIST_ID);
      response.forEach(element => {
        ...
        if(element.TERMINATION_TYPE_OTHER_SPECIFY !=null){
          this.visible.TERMINATION_TYPE_OTHER_SPECIFY = true;
        }
    ...
    saveAsDraft: async function() {
      ...
      if (confirm("Are you sure to submit the selected NAV?")) {
        ...
        data.append("TERMINATION_SUBMISSION_ID", this.model.TERMINATION_SUBMISSION_ID);
        data.append("TERMINATION_DATE",moment(this.model.TERMINATION_DATE).format('DD-MMM-YYYY'));
