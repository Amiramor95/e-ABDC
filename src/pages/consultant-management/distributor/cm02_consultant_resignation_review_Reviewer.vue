          ...
          <b-overlay :show="show_overlay" rounded="sm">
            <template v-if="!currentConsultant">
              <va-card>
                ...
                <div class="  col-ml-2">
                  ...
                  >
                    <template slot="checkbox" slot-scope="props">
                      <b-form-checkbox v-if="props.rowData.APPR_STATUS==15 || props.rowData.APPR_STATUS==42 || props.rowData.APPR_STATUS==7"
                ...
                <div class="float-right">
                  ...
                  <button
                    @click="submitResignationApproval(8, 'Are you sure to return?')"
                    type="button"
                  ...
                  <button
                    @click="submitResignationApproval(5, 'Are you sure to reject?')"
                    type="button"
                  ...
                  <button
                    @click="submitResignationApproval(14, 'Are you sure to approve?')"
                    type="button"
            ...
            <template v-else>
              ...
              <va-card>
                ...
                <!-- Pending(15) / Rejected by Manager(42) / Returned by Manager(7)-->
                <div v-if="currentConsultant.APPR_STATUS==15 || currentConsultant.APPR_STATUS==42 || currentConsultant.APPR_STATUS==7">
                  <vue-form-generator
                    :model="model"
                    :schema="tabSchema2"
                    :options="formOptions"
                ...
                <!-- Pending(15) / Rejected by Manager(42) / Returned by Manager(7)-->
                <div class="float-right" v-if="currentConsultant.APPR_STATUS==15 || currentConsultant.APPR_STATUS==42 || currentConsultant.APPR_STATUS==7">
                  <!-- <button @click="saveAsDraft" type="button" class="btn btn-info btn-fill btn-md">
                    <i class="fa fa-edit" /> &nbsp;Save as Draft
                  </button> -->
                  <button
              ...
              <va-card class="mt-4">
                <div class="ml-2">
                  ...
                  <button
                    v-if="visibleLog"
                    v-b-toggle.resignation-approval-log-admin
                    type="button"
                  ...
                  <b-collapse id="resignation-approval-log-admin" class="mt-2" v-model="visibleLog">
                    <div class="row">
...
export default {
    ...
    return {
      ...
      fields: {
        consultant: [
          ...
          { name: 'CONSULTANT_NAME', title: 'CONSULTANT_NAME' },
  ...
  methods: {
    exchange () {
      this.$router.push('/fimm/consultant-resignation-review-Reviewer-overviewList')
    },
    ...
    async getConsultantRecord() {
      const response = await services02module2.getConsultantsResignationForAdminApproval(this.distributorData.DISTRIBUTOR_ID);
    ...
    viewCurrentConsultant(props) {
      ...
      //localStorage.setItem('RESIGNATION_ID',props.rowData.RESIGNATION_ID);
    ...
    async getConsultantResignationApprovalData() {
      try {
        await services02module2.consultantResignationApprovalData(this.currentConsultant.CONSULTANT_ID, this.currentConsultant.RESIGNATION_ID, 3) // 3 = APPR_GROUP_ID_ADMIN
        .then((response)=>{
    ...
    setCurrentConsultant(props) {
      ...
      //console.log('consultant',this.model.CONSULTANT_ID);
    },
    ...
    submitResignationApproval: async function(status, confirm_text) {
      if(this.model.CONSULTANT_ID.length>0){
        if(confirm(confirm_text)){
          ...
          data.append("NOTI_APPROVE_REMARK", '(CONSULTANT-RESIGNATION) Reviewed by Admin');
          data.append("NOTI_REJECT_REMARK", '(CONSULTANT-RESIGNATION) Rejected by Admin');
          ...
          if (status!=14 && this.model.REMARKS_COMMENTS == "") {
            Vue.$toast.open({
            ...
            const response = await Resignation.postResignationAdminApproval(data);
