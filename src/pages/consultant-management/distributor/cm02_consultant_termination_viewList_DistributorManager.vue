...
<script>
    ...
    export default {
        ...
        async created () {
            ...
            var APPROVAL_STATUS=localStorage.getItem('APPROVAL_STATUS');
            var SUBMISSION_ID = localStorage.getItem('SUBMISSION_ID');
            this.consultantsAPI=await services02module2.getAllTerminationManagerBySubmissionId(user.USER_DIST_ID, JSON.stringify([APPROVAL_STATUS]), SUBMISSION_ID);
            this.isReady=true;
        },
    }
</script>
