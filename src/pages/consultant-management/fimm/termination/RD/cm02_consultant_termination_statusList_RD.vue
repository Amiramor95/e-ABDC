              ...
              <div style="display:flex; justify-content:flex-end; align-items:center">
                <div class="flex md3 offset--md3">
                  <div style="display:flex; justify-content:flex-end">
                    ...
                    >
                      <span v-b-tooltip.hover title="Bulk" class="badge badge-success mr-2" @click="bulkList">
...
export default {
  ...
  async created () {
    ...
    this.consultantsAPI=await services02module2.getAllTermination(DIST_INFO.DISTRIBUTOR_ID);
    //console.log('hello',this.consultantsAPI);
    this.isReady=true;
  },
  ...
  methods: {
    back() {
      this.$router.push('/fimm/consultant-termination-RD')
    }, // back button

    bulkList(){
      localStorage.setItem('SUBMISSION_ID','');
      localStorage.setItem('isDraft',false);
