              ...
              />
                ...
                <template slot="ACTION" slot-scope="props">
                  <h4 style="margin:0; font-size:20px">
                    <span v-b-tooltip.hover title="Edit" v-if="props.rowData.APPROVAL_STATUS==7" class="badge badge-primary mr-2" @click="editCurrentConsultant(props)">
                        <i class="fa fa-edit"></i>
                      </span>
                    <span v-b-tooltip.hover title="View"  v-else class="badge badge-primary mr-2" @click="viewCurrentConsultant(props)">
                        <i class="fa fa-eye"></i>
                      </span>
...
<script>
  ...
  export default {
    ...
    async created () {
      ...
      this.consultantsAPI=await services02module2.getAllTerminationBySubmission_id(SUBMISSION_ID);
      this.isReady=true;
    },
    async mounted() {
    ...
    methods: {
      ...
      viewListPage(props){
        ...
        this.$router.push('/fimm/consultant-termination-viewList-RD');
      },
      ...
      async getAllTerminationByTS_ID() {
      ...
      async editCurrentConsultant(props) {
        try {
