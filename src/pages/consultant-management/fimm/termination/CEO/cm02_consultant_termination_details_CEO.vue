...
<script>
  ...
  export default {
    ...
    async mounted() {
      ...
      this.model.FIMM_REMARK=this.currentConsultant.FIMM_REMARK_CEO;
          ...
          groups: [
            {
              ...
              fields: [
                ...
                },
                {
                  ...
                  multiple: true,
                  text: 'Choose a File',
                  model: 'TERMINATION_UPLOADED_DOCUMENT',
    ...
    methods: {
      ...
      getTerminationDocument: async function(termination_id) {
        ...
        response.forEach(element => {
          ...
          this.model.TERMINATION_UPLOADED_DOCUMENT = [];
          this.model.TERMINATION_UPLOADED_DOCUMENT.push(data);
        });
      },
