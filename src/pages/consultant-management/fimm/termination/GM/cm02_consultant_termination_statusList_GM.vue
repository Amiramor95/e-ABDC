...
export default {
  async created () {
    ...
    this.consultantsAPI=await services02module2.getAllApprovalTermination(DIST_INFO.DISTRIBUTOR_ID);
    this.isReady=true;
  },
  async mounted() {
  ...
  methods: {
    back() {
      this.$router.push('/fimm/consultant-termination-GM')
    }, // back button
    //
    // bulkList(){
    ...
    viewListPage(props){
      ...
      this.$router.push('/fimm/consultant-termination-bulk-GM');
    },
