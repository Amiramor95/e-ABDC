              ...
              <div>
                ...
                <va-card  class="strpied-tabled-with-hover"
                    body-classes="table-full-width table-responsive">
                        ...
                        <h4 slot="header" class="card-title">Applicant Details : {{ $route.params.id }}</h4>
                          ...
                          <div class="ml-4">
                              ...
                              <table class="table table-striped">
                                <tbody>
                                  ...
                                  <tr>
                                    <td>Address</td>
                                    <td>{{consultant.CONSULTANT_ADDRESS}}</td>
                                  </tr>
                                  <tr>
                                    <td>Postcode</td>
                                    <td>{{consultant.CONSULTANT_POSTCODE}}</td>
                                  </tr>
                                  <tr>
                                    <td>City</td>
                                    <td>{{consultant.CONSULTANT_CITY}},</td>
                                  </tr>
                                  <tr>
                                    <td>State</td>
                                    <td>{{consultant.CONSULTANT_STATE}}</td>
                                  </tr>
                                  <tr>
                                  ...
                                  <tr>
                                   ...
                                   <tr>
                                    ...
                                    <td>{{consultant.CONSULTANT_HIGHEST_QUALIFICATION}}</td>
                                  </tr>
                              ...
                              <table class="table table-striped">
                                <tbody>
                                  ...
                                  <tr>
                                    ...
                                    <td> <a @click="getPDF" class="viewPDF">View</a></td>
                                  </tr>
                                  <tr>
                                  <td>
                                    Appeal
...
export default {
  created() {
    ...
    // console.log("Success get PDF", response);
  ...
  async mounted () {
    // this.showModal();
    // this.getExamResult();
     await this.getConsultantRecordByID(this.$route.params.id);
  ...
  methods: {
    getConsultantRecordByID: async function (id) {
      console.log('inside get consultant record', id);
      const response = await services02module2.getConsultantByID(id);
