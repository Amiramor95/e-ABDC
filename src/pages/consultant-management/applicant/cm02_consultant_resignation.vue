              ...
              <div>
                ...
                <va-card  class="strpied-tabled-with-hover"
                    body-classes="table-full-width table-responsive">
                        <h4 slot="header" class="card-title">Consultant Details</h4>
                    <br>
                    <div>
                      <tabs
                        :tabs="tabs"
          ...
          <div class="row justify-content-center">
            <div class="col-lg-12">
              <div>
                ...
                <va-card  class="strpied-tabled-with-hover"
                    body-classes="table-full-width table-responsive">
                        <h4 slot="header" class="card-title">Resignation Request And Justification</h4>
                    <br>
                    <div>
        ...
        tabSchema2: {
            groups: [
            {
                ...
                },
                {
                    ...
                    model: "DOCUMENT",
                    placeholder: "Resignation Document",
                    required: true,
                    validator: "string",
                    styleClasses: "col-md-6",
                },
