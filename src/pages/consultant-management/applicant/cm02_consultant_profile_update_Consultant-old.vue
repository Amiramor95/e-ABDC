      ...
      <div class="row">
        <div class="col-12">
          <va-card>
            ...
            <!-- <form-wizard @on-complete="onComplete" finish-button-text="Submit" ref="wizardForm">
              <h3 slot="title"></h3>
              section 1
              <tab-content
            ...
            <!-- section 2 -->
            <!-- <tab-content title="2. Type of Consultant" :before-change="beforeTab2Switch">
                <br />
                <br />
                <vue-form-generator
                  :model="model"
            ...
            <!-- section 3 -->
            <!-- <tab-content title="3. Examination" :before-change="beforeTab3Switch">
                <br />
                <br />
                <div>
                ...
                ></vue-form-generator>
                <br />
                <div v-if="!visibleExemptionQualified">
                  <div>
                    <va-card>
                      ...
                      <div class="col-ml-2">
                        ...
                        <small>* Choose 3 exam sessions (Click on rows to select sessions)</small>
                        <b-table
                          v-if="viewType == 1"
                          hover
                          selectable
                          ...
                          :filter="filter"
                          responsive="md"
                          @row-selected="setSelectedExamSession"
                          @row-clicked="setCurrentRowClicked"
                          ref="selectableTable"
                        >
                ...
                <div v-if="!visibleExemptionQualified && this.selectedExamList.length">
                  <div>
                    <va-card>
            ...
            <!-- section 4 -->
            <!-- <tab-content title="4. Other Document">
                <br />
                <br />
                <vue-form-generator
                  :model="model"
