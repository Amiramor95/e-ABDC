...
export default {
  ...
  methods: {
    ...
    getOtherDocumentDocs: async function () {
      const response = await services02module2.getConsultantDocumentsForConsultantProfile(this.savedConsultantData.CONSULTANT_ID, 'CONSULTANT_OTHER_DOCUMENTS',
