  ...
  <div class="">
    <div class="">
      <div class="row">
        <div class="col-12">
          <va-card>
            <h1>List of Consultant Termination Request</h1>
            <br />
            <div class="col-3">
            ...
            <br />
            <vue-form-generator
              v-if="this.model.SELECTED_CONSULTANT"
              :model="model"
              :schema="tabSchema2"
              :options="formOptions"
              ref="tabForm2"
  ...
  data() {
    return {
      ...
      fields: [
        ...
        { key: 'CONSULTANT_NAME', label: 'Distributor Name' },
        { key: 'CONSULTANT_NRIC', label: 'Phone No' },
        { key: 'CONSULTANT_PASSPORT_NO', label: 'Total Consultant' },
