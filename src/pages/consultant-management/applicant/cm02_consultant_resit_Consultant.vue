        ...
        <div class="col-12">
          <va-card>
            <form-wizard
              ...
              ref="wizardForm"
              :start-index.sync="currentstepIndex"
            >
              <h3 slot="title"></h3>
              <!-- section 1 -->
              <tab-content
              ...
              >
                ...
                <va-card v-if="!visibleExemptionQualified">
                  ...
                  <div class="col-ml-2">
                    ...
                    <va-data-table
                      ...
                      :datacount="examTimetableList.length"
                ...
                <va-card v-if="!visibleExemptionQualified && this.SELECTED_EXAM_SESSION.length">
                  ...
                  <va-data-table
                    ...
                    no-data-label="No data found"
                    :per-page="parseInt(perPage)"
                    :datacount="SELECTED_EXAM_SESSION.length"
                    :dataperpage="parseInt(perPage)"
                    clickable
                  >
                    <template slot="index" slot-scope="row">
...
const RequiredDocument = RepositoryFactory.get('requireddocument');
...
export default {
  ...
  created() {
    this.getExamType(this.$route.params.examType);
    this.getAllPostcodes();
    this.getAllCountries();
    this.getDistributorRecords();
    this.getDistributorType();
    this.getAllStates();
    this.getAllConsultantExamSessions();
        ...
        groups: [
          {
            ...
            fields: [
...

              {
                ...
                visible: (model, field, form) => {
                  return this.registration_type.length;
                },
              },
            ],
          },
  ...
  methods: {
    ...
    removeSelectedExamSession(props) {
      ...
      const index = this.SELECTED_EXAM_SESSION.findIndex(
        el => el.sessionid === props.rowData.sessionid,
      );
      console.log(index);
      this.SELECTED_EXAM_SESSION.splice(index, 1);
    },
    setSelectedExamSession(props) {
      ...
      this.SELECTED_EXAM_SESSION.push(props.rowData);
      console.log(this.SELECTED_EXAM_SESSION);
    },
