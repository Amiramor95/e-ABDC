          ...
          <va-card>
            ...
            <va-card>
              ...
              <div class="col-ml-2">
                ...
                <small>Reschedule exam sessions</small>
                <va-data-table
                  v-if="viewType == 1"
                ...
                >
                  ...
                  <template slot="ACTION" slot-scope="props">
                    <div v-if="props.rowData.status=='CANCEL'">
                      <button class="btn btn-primary btn-fill btn-md" @click="rescheduleExamSession(props.rowData)">RESCHEDULE</button>
                    </div>
                  </template>
                  <!-- <template slot="ACTION" slot-scope="props">
...
export default {
  ...
  async created() {
    ...
    await this.getDocumentByID('243'); // Pass in consultant ID as params
    await this.getSite();
