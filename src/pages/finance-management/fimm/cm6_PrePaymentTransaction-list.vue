<template>
  <va-card>
    <template slot="header">
      ...
      <div class="row">
        <div class="col">
          <h4 class="card-title"> List of Pre-Payment Transaction </h4>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getAllList () {
        const response = await servicesModule6.getPrepaymentLedger()
        this.items = response
      ...
      async filterRecord () {
        ...
        try {
          const response = await servicesModule6.filter_prepayment_transaction(
    ...
    data () {
      return {
        ...
        excelname: 'download-PrepaymentTransactionList',
        sheetname: 'PrepaymentTransaction',
        dateFormat: '',
        term: null,
        perPage: '10',
