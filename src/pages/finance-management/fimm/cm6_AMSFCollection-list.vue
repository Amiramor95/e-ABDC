<template>
  <va-card>
    <template slot="header">
      ...
      <div class="row">
        <div class="col">
          <h4 class="card-title">List of AMSF Collections</h4>
        </div>
        <div class="col float-right">
          <div class="float-right">
            <h5>
              ...
              <vue-json-to-csv
                :json-data="csv"
                :csv-title="'AMSF Collections List'"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getAllList () {
        this.items = await servicesModule6.getAllAMSFCollection()
        this.ListCount = this.items.length
      },

      async getcsv () {
        this.csv = await servicesModule6.getCSV6()
      },
      ...
      async filterRecord () {
        ...
        try {
          const response = await servicesModule6.getAllAMSFCollection(
