<template>
  <va-card>
    <template slot="header">
      ...
      <div class="row">
        <div class="col">
          <h4 class="card-title">List of Pre-Payment Top Up</h4>
        </div>
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getAllList () {
        const response = await servicesModule6.getAllPrepaymentTopup(
      ...
      async getcsv () {
        const response = await servicesModule6.getCSV3()
        this.csv = response
      },
