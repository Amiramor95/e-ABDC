<template>
  <va-card>
    <template slot="header">
      ...
      <div class="row">
        <div class="col">
          <h4 class="card-title">List of Consultant Registration Payment</h4>
        </div>
        <div class="col float-right">
          <div class="float-right">
            <h5>
              ...
              <vue-json-to-csv
                :json-data="csv"
                :csv-title="'Consultant Registration Payment'"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      async getAllList () {
        const response = await servicesModule6.getAllConsultantRegistration()
        this.items = response
      ...
      async getcsv () {
        const response = await servicesModule6.getCSV2()
        this.csv = response
      },
      ...
      async viewRecord (data) {
        localStorage.setItem('ConsultantRegistration-Payment-Details', JSON.stringify(data))
        this.$router.push({
          ...
          return this.term
            ...
            .every(
              (v) =>
                ...
                item.INVOICE_NUMBER.includes(v) ||
    ...
    data () {
      return {
        ...
        ListCountExcell: '',
        excelname: 'Consultant Registration Payment',
        sheetname: 'Consultant Registration Payment',
        dateFormat: '',
        term: null,
        perPage: '10',
