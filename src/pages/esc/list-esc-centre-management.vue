...
export default {
  ...
  methods: {
    // create
    create () {
      localStorage.setItem('CREATE-ESC-EXAM-CENTRE_COMPANY_ID', this.profileData.COMPANY_PROFILE_ID)
      this.$router.push({ name: 'create-esc-exam-centre' })
    },
    async getProfileDetailByEscUserId () {
      ...
      this.companyProfileId = this.profileData.COMPANY_PROFILE_ID
