          ...
          <template slot="actions" slot-scope="props">
            <h5 class="mt-1">
              ...
              <span
                ...
                v-b-tooltip.hover
                title="Approve Exam Type Details"
...
export default {
  ...
  methods: {
    ...
    async editRecord (data) {
      if (localStorage.getItem('edit-exam-type-details-approver') !== null) {
        localStorage.removeItem('edit-exam-type-details-approver')
      }
      localStorage.setItem('edit-exam-type-details-approver', JSON.stringify(data))
      this.$router.push({
