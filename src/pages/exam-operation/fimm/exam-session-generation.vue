...
export default {
  ...
  methods: {
    back () {
      this.$router.push({ name: 'list-centre-based-exam-session-generation' })
    },
    // getAllRecord
    getAllRecord: async function () {
      this.RecordList = await examSessionManagementServices.listAllExamSessionGeneratedByCentreId(
        {
    ...
    async viewRecord (data) {
      ...
      await this.$router.push({ name: 'list-exam-session-generation' })
    },
  },
