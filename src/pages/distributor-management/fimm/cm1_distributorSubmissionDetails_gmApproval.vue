...
export default {
  ...
  mounted() {
    var data = localStorage.getItem("distributor-SubmissionList-gmApproval");
  ...
  methods: {
    async back() {
      this.$router.push("/fimm/distributor-SubmissionList-gmApproval");
    },
    async readMore(data) {
    ...
    async submit(status) {
      ...
      if (status == 18) {
        ...
        data.append("NOTI_LOCATION", "distributor-SubmissionList-ceoApproval");
        data.append(
          "NOTI_MESSAGE",
          "(DIST) New registration for CEO approval."
        );
        ...
        if (confirm("Confirm to recommend for approval on this application? ")) {
          ...
          alert("Application has been recommend for approval.")
          this.$router.go(-1);
        } else {
          console.log("");
        }
        ...
        alert("This application has been returned.");
      this.$router.go(-1);
        } else {
          console.log("");
        }
