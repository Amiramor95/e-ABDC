  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Suspension : Review Appeal Submission Form
      </h4>
    </div>
    <br />
    <br />
...
export default {
  mounted() {
    var data = localStorage.getItem("view-appealSuspension-gm");
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure you want to save this as draft?")) {
        ...
        try {
          ...
          this.$router.push("/fimm/appealSuspension-gmApproval-list");
        } catch (error) {
          console.log(error);
        }
      }
    ...
    returnSubmission: async function () {
      if (confirm("Are you sure you want to return this submission?")) {
       ...
       data.append("NOTIDASH2", 1);
        ...
        data.append("NOTI_LOCATION2", "appeal-suspension-revocation-list");
    ...
    reviewSubmission: async function () {
      //ts_id = 18 (recommend)
      if (confirm("Are you sure you want to recommend for approval this submission?")) {
        const data = new FormData();
       ...
       data.append("NOTI_EMAIL", "This Appeal Submission pending for your approval :");
