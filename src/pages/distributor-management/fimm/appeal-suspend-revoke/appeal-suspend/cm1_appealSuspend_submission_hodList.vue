<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Suspension : List of Appeal Submissions for Recommendation </h4>
       <br />
      <div class="col float-right">
        <div class="float-right">
          <h5>
            <span
              v-b-tooltip.hover
              title="List of Suspension/Revocation Appeal Submission"
              v-on:click="viewList"
...
export default {
  ...
  methods: {
    ...
    getAllList: async function () {
      ...
      const response = await servicesModule1.getAppealApprRecordById(APPR_GROUP_ID,1);
