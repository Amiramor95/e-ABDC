              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td v-if="this.distributorDetail.DIST_FAX_NUMBER != '-'">
                      0{{
              ...
              <b-collapse id="collapse-financial" class="mt-2">
                ...
                <table class="table table-striped">
                  ...
                  >
                    <div
                      v-if="
                        this.approvalDetail.DIST_TYPE_NAME == '4' ||
                          this.approvalDetail.DIST_TYPE_NAME == '5'
                      "
                    >
                      <tr>
...
export default {
  ...
  mounted() {
    ...
    var data = localStorage.getItem(
      "distributor-RegisterType-SubmissionDetails-supervisionApproval"
    );
  ...
  methods: {
    async back() {
      this.$router.push("/fimm/distributor-RegisterType-SubmissionList-supervisionApproval");
    },
    async details(data) {
    ...
    async submit(status) {
      ...
      const disttypeid = localStorage.getItem(
        "distributor-RegisterType-SubmissionDetails-supervisionApproval"
      );
      ...
      if (status == 17) {
        ...
        data.append(
          "NOTI_MESSAGE",
          "(DIST-RECOMMENDED) New Type Registration for RD approval."
        );
