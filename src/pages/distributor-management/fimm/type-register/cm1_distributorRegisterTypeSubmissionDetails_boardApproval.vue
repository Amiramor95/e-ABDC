...
export default {
  ...
  mounted() {
    var data = localStorage.getItem("distributor-RegisterType-SubmissionDetails-boardApproval");
  ...
  methods: {
    async back(){
      this.$router.push('/fimm/distributor-SubmissionList-boardApproval')
    },
    async details(data) {
    ...
    async submit(status) {
      ...
      const disttypeid = localStorage.getItem("distributor-RegisterType-SubmissionDetails-boardApproval");
      ...
      this.$router.push('fimm/distributor-RegisterType-SubmissionList-boardApproval');
