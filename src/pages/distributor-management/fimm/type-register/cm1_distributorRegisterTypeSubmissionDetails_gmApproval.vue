...
export default {
  ...
  mounted() {
    ...
    var data = localStorage.getItem("distributor-RegisterType-SubmissionDetails-gmApproval");
  ...
  methods: {
    ...
    async submit(status) {
      ...
      const disttypeid = localStorage.getItem("distributor-RegisterType-SubmissionDetails-gmApproval");
      ...
      if (status == 18) {
        ...
        data.append("NOTI_LOCATION", "distributor-RegisterType-SubmissionList-ceoApproval");
        data.append(
          "NOTI_MESSAGE",
          "(DIST) New Type Registration for CEO approval."
