...
export default {
  props: {},
  mounted() {
    this.getRegisterTypeApplicationList();
  },
  methods: {

    async getRegisterTypeApplicationList() {
      const user = localStorage.getItem("user");
      const response = await services06Module1.getRegisterTypeApplicationList(
    ...
    details(data) {
      ...
      localStorage.setItem(
        "distributor-RegisterType-SubmissionDetails-rdApproval",
        JSON.stringify(data)
      );
      this.$router.push({
