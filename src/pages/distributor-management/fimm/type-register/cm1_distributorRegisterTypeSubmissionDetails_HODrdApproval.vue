            ...
            <div>
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr><td colspan="3" style="font-weight:bold;">Registered Address</td></tr>
                  ...
                  <tr><td colspan="3" style="font-weight:bold;">Business Address</td></tr>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td v-if="this.distributorDetail.DIST_PHONE_NUMBER == null || this.distributorDetail.DIST_PHONE_NUMBER == '-' ">
                    -
                  </td>
                    <td v-if="this.distributorDetail.DIST_PHONE_NUMBER != '-'">
                      0{{ this.distributorDetail.DIST_PHONE_NUMBER.substring(0,1) }}-{{this.distributorDetail.DIST_PHONE_NUMBER.substring(1,10)}}
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td>Fax Number</td>
                    <td>:</td>
                    <td v-if="this.distributorDetail.DIST_FAX_NUMBER == null || this.distributorDetail.DIST_FAX_NUMBER == '-' ">
                    -
                  </td>
                    <td v-if="this.distributorDetail.DIST_FAX_NUMBER != '-'" >0{{ this.distributorDetail.DIST_FAX_NUMBER.substring(0,1) }}-{{ this.distributorDetail.DIST_FAX_NUMBER.substring(1,10) }}</td>
                  </tr>
                  <tr>
                  <td>Mobile Phone Number</td>
                  <td>:</td>
                  <td v-if="this.distributorDetail.DIST_MOBILE_NUMBER == null || this.distributorDetail.DIST_MOBILE_NUMBER == '-' ">
                    -
                  </td>
                  <td v-if="this.distributorDetail.DIST_MOBILE_NUMBER != '-' ">
                      0{{ distributorDetail.DIST_MOBILE_NUMBER.substring(0,2) }}-{{ distributorDetail.DIST_MOBILE_NUMBER.substring(2,10) }}
                  </td>
                  </tr>
                  <tr>
                    <td>Email Address</td>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td v-if=" this.distributorDetail.DIST_COMPANY_WEBSITE != NULL ">{{ this.distributorDetail.DIST_COMPANY_WEBSITE }}</td>
                    <td v-if=" this.distributorDetail.DIST_COMPANY_WEBSITE == NULL "> - </td>
                  </tr>
                  <tr>
                    <td>Application Type</td>
                    <td>:</td>
                    <td>{{ this.approvalDetail.DIST_TYPE_NAME }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_INSURANCE }}</td>
                  </tr>
                  <tr>
                  ...
                  >
                    <div v-if="item.REPR_TYPE == 'CEO'">
                      ...
                      <tr v-if="item.REPR_CITIZEN == 1">
                        <td>NRIC No</td>
                        <td>:</td>
                        <td>{{ item.REPR_NRIC.substring(0,6) +
                       "-" + item.REPR_NRIC.substring(6,8) +
                        "-" + item.REPR_NRIC.substring(8,13) }}</td>
                      </tr>
                      ...
                      <tr>
                        ...
                        <td v-if="item.REPR_TELEPHONE == null || item.REPR_TELEPHONE == '-'"> - </td>
                      ...
                      <tr>
                        <td>Extension Number</td>
                        <td>:</td>
                        <td v-if="item.REPR_PHONE_EXTENSION == null || item.REPR_PHONE_EXTENSION == '-'"> - </td>
                      ...
                      <tr>
                        ...
                        <td v-if="item.REPR_MOBILE_NUMBER == null || item.REPR_MOBILE_NUMBER == '-'"> - </td>
                  ...
                  >
                    <div v-if="item.REPR_TYPE == 'AR'">
                      ...
                      <tr>
                        ...
                        <td v-if="item.REPR_TELEPHONE == null || item.REPR_TELEPHONE == '' ">
                          -
                        </td>
                      </tr>
                      <tr>
                      ...
                      <tr>
                        <td>Mobile Phone Number</td>
                        <td>:</td>
                        <td v-if="item.REPR_MOBILE_NUMBER != null">
                          01{{ item.REPR_MOBILE_NUMBER.substring(0,1) }}-{{ item.REPR_MOBILE_NUMBER.substring(1,10) }}
                        </td>
                        <td v-if="item.REPR_MOBILE_NUMBER == null"> - </td>
                      </tr>
                      <tr>
                        <td>Email</td>
                        <td>:</td>
                  ...
                  >
                    <div v-if="item.REPR_TYPE == 'AAR'">
                      ...
                      <tr>
                        ...
                        <td v-if="item.REPR_TELEPHONE == null"> - </td>
                      </tr>
                      <tr>
                        <td>Extension Number</td>
                        <td>:</td>
              ...
              <b-collapse id="collapse-financial" class="mt-2">
                ...
                <table class="table table-striped">
                  <tbody
                    ...
                    :key="index"
                  >
                    <div v-if="this.approvalDetail.DIST_TYPE_NAME == '4' || this.approvalDetail.DIST_TYPE_NAME == '5'">
                      <tr>
                  ...
                  >
                    <div v-if="this.approvalDetail.DIST_TYPE_NAME == '4' || this.approvalDetail.DIST_TYPE_NAME == '5'">
                      ...
                      <tr v-if="item.DIST_FP_CITIZEN == 1">
                        <td>NRIC No</td>
                        <td>:</td>
                        <td>{{ item.DIST_FP_NRIC.substring(0,6) +
                       "-" + item.DIST_FP_NRIC.substring(6,8) +
                        "-" + item.DIST_FP_NRIC.substring(8,13) }}</td>
                      </tr>
              ...
              <b-collapse id="collapse-compl" class="mt-2">
                ...
                <table class="table table-striped">
                  <tbody
                    ...
                    :key="index"
                  >
                    <div v-if="item.ADD_TYPE == 'HOD_COMPL' || item.ADD_TYPE == '7'">
                      <tr>
                        <td style="width: 20%">Name</td>
                        <td style="width: 1%">:</td>
                        <td>
                      ...
                      <tr>
                        <td>Office Phone Number</td>
                        <td>:</td>
                        <td v-if="item.ADD_TELEPHONE != null">
                          0{{ item.ADD_TELEPHONE.substring(0,1) }}-{{ item.ADD_TELEPHONE.substring(1,10) }}
                        </td>
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                          {{ item.ADD_PHONE_EXTENSION }}</td>
                      </tr>
                      <tr>
                        <td>Mobile Phone Number</td>
                        <td>:</td>
                        <td v-if="item.ADD_MOBILE_NUMBER != null">
                          0{{ item.ADD_MOBILE_NUMBER.substring(0,2) }}-{{ item.ADD_MOBILE_NUMBER.substring(2,10) }}
                        </td>
                        <td v-if="item.ADD_MOBILE_NUMBER == null"> - </td>
                      </tr>
                      <tr>
                        <td>Email</td>
                        <td>:</td>
              ...
              <b-collapse id="collapse-uts" class="mt-2">
                ...
                <table class="table table-striped">
                  <tbody
                    ...
                    :key="index"
                  >
                    <div v-if="item.ADD_TYPE == 'HOD_UTS' || item.ADD_TYPE == '21'">
                      <tr>
                        <td style="width: 20%">Name</td>
                        <td style="width: 1%">:</td>
                        <td>
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td v-if="item.ADD_MOBILE_NUMBER != null">
                          0{{ item.ADD_MOBILE_NUMBER.substring(0,1) }}-{{ item.ADD_MOBILE_NUMBER.substring(2,10) }}
                        </td>
                        <td v-if="item.ADD_MOBILE_NUMBER == null"> - </td>
                      </tr>
                      <tr>
              ...
              <b-collapse id="collapse-prs" class="mt-2">
                ...
                <table class="table table-striped">
                  <tbody
                    ...
                    :key="index"
                  >
                    <div v-if="item.ADD_TYPE == 'HOD_PRS' || item.ADD_TYPE == '17'">
                      <tr>
                        <td style="width: 20%">Name</td>
                        <td style="width: 1%">:</td>
                        <td>
...
export default {
  ...
  mounted() {
    var data = localStorage.getItem("distributor-RegisterType-SubmissionDetails-HODrdApproval");
  ...
  methods: {
    async back() {
          this.$router.push('/fimm/distributor-RegisterType-SubmissionList-HODrdApproval');
      },
    async details(data) {
    ...
    async submit(status) {
      ...
      const disttypeid = localStorage.getItem("distributor-RegisterType-SubmissionDetails-HODrdApproval");
      const data = new FormData();
      data.append("DIST_ID", this.approvalDetail.DISTRIBUTOR_ID);
      data.append("APPR_GROUP_ID", JSON.parse(user).USER_GROUP_ID);
      data.append("DIST_TYPE_ID", JSON.parse(disttypeid).DIST_TYPE_ID);
      ...
      for (let i = 0; i < this.fileRemark.length; i++) {
        data.append("APPR_REMARK_DOCU_PROFILE[]", this.fileRemark[i]);
      }
      data.append("APPROVAL_REMARK_DETAILINFO", this.model.remark1);
      for (let i = 0; i < this.fileRemark2.length; i++) {
        data.append("APPR_REMARK_DOCU_DETAILINFO[]", this.fileRemark2[i]);
      }
      data.append("APPROVAL_REMARK_CEOnDIR", this.model.remark2);
      for (let i = 0; i < this.fileRemark3.length; i++) {
        data.append("APPR_REMARK_DOCU_CEOnDIR[]", this.fileRemark3[i]);
      }
      data.append("APPROVAL_REMARK_ARnAAR", this.model.remark3);
      for (let i = 0; i < this.fileRemark4.length; i++) {
        data.append("APPR_REMARK_DOCU_ARnAAR[]", this.fileRemark4[i]);
      }
      data.append("APPROVAL_REMARK_ADDTIONALINFO", this.model.remark4);
      for (let i = 0; i < this.fileRemark5.length; i++) {
        data.append("APPR_REMARK_DOCU_ADDITIONALINFO[]", this.fileRemark5[i]);
      }
      data.append("APPROVAL_REMARK_PAYMENT", this.model.remark5);
      for (let i = 0; i < this.fileRemark6.length; i++) {
        data.append("APPR_REMARK_DOCU_PAYMENT[]", this.fileRemark6[i]);
      }
      this.proposalList.forEach(item => {
        item.list.forEach(element => {
          if (element.DOCU_REMARK != null) {
            data.append("DOCU_REMARK_LIST[]", JSON.stringify(element));
          }
        });
      });
      this.additionalList.forEach(item => {
        if (item.DOCU_REMARK != null) {
          data.append("DOCU_REMARK_LIST2[]", JSON.stringify(item));
        }
      });
      ...
      if (status == 14) {
        ...
        if (this.approvalDetail.APPR_INDEX == 2) {
          data.append(
            "NOTI_LOCATION",
            "distributor-RegisterType-SubmissionList-lraApproval"
          );

          data.append(
            "NOTI_MESSAGE",
          "(DIST) New Type Registration for LRA approval."

        );
        } else if (this.approvalDetail.APPR_INDEX == 5) {
          data.append("NOTI_LOCATION", "distributor-RegisterType-SubmissionList-gmApproval");
          data.append(
            "NOTI_MESSAGE",
            "(DIST) New Type Registration for GM approval."
        ...
        data.append('USER_GROUP_ID',userData.USER_GROUP_ID);
        ...
        const response = await services06Module1.createDistributorRegisterTypeReview(data);
        this.$router.go(-1);
      }
      else if (status == 18) {
        ...
        if (this.approvalDetail.APPR_INDEX == 2) {
          ...
          data.append(
            "NOTI_LOCATION2",
            "distributor-RegisterType-SubmissionList-supervisionApproval"
          );
        } else if (this.approvalDetail.APPR_INDEX == 5) {
          data.append("NOTI_LOCATION", "distributor-RegisterType-SubmissionList-gmApproval");
          data.append(
        ...
        if (confirm("Confirm to recommend for approval on this application? ")) {
          const response = await services06Module1.createDistributorRegisterTypeReview(
            data
          );
          this.$router.go(-1);
          alert(
        ...
        data.append("NOTI_REMARK", '(DIST) DISTRIBUTOR TYPE HAS BEEN RETURNED BY HOD');
        data.append("NOTI_LOCATION", 'distributor-RegisterType-SubmissionList-rdApproval');
        ...
        if (confirm("Save as draft this application? ")) {
          data.append("APPROVAL_STATUS", 1); //save as draft
          const response = await services06Module1.createDistributorRegisterTypeReview(data);
    ...
    async getDistributorById(dist_id, groupId) {
      const response = await services06Module1.getTypeRegByDistId(
        dist_id,
        groupId
      );
      this.distributorDetail = response;
      // Create our number formatter.
      const formatter = currencyFormat.currencyFormat("ms", "MYR");
