...
export default {
  ...
  mounted() {
    ...
    var data = localStorage.getItem("distributor-SubmissionList-supervisionApproval");
  ...
  methods: {
    ...
    async back() {
      this.$router.push("/fimm/distributor-SubmissionList-supervisionApproval");
    },
    ...
    async submit(status) {
      ...
      if (status == 17) {
        ...
        data.append(
          "NOTI_MESSAGE",
                "(DIST-RECOMMENDED) Distributor Recommended for RD Approval."
