<template>
  ...
  <div class="flex xs12 md12 xl12">
    <vudal name="readModal" class="widthModal">
      <div class="header">
        View Details<i class="close icon">&times;</i>
      </div>
      <div class="content text-center" >
        <img :src="this.model.logoUrl" >
      </div>
      <div class="actions">
        <button
          type="button"
    ...
    <vudal name="showStaticModalOK" class="widthModal">
      <div class="content">
        <p>This submission has been reviewed.</p>
        <div class="actions">
          <button
            type="button"
    ...
    <vudal name="showInstructionModal" class="widthModal">
      <div class="content">
        <p>Please insert your remark for this distributor registration.</p>
      </div>
      <div class="actions">
        <button
          type="button"
    ...
    <vudal name="remarkModal" class="widthModal">
      ...
      <div class="content">
        <table class="table">
          <tbody>
            <tr>
              <td style="width: 20%">Remark Distributor Profile</td>
              <td style="width: 1%">:</td>
              <td v-if="this.APPROVAL_REMARK_PROFILE != null">
                <div>
                  {{ this.APPROVAL_REMARK_PROFILE }}
                </div>
                <br />
                <div>
                  <VueFileAgent
            ...
            <tr>
              <td style="width: 20%">Remark Details Information</td>
              <td style="width: 1%">:</td>
              <td v-if="this.APPROVAL_REMARK_DETAILINFO != null">
                <div>
                  {{ this.APPROVAL_REMARK_DETAILINFO }}
                </div>
                <br />
                <div>
                  <VueFileAgent
            ...
            <tr>
              <td style="width: 20%">Remark CEO and Director</td>
              <td style="width: 1%">:</td>
              <td v-if="this.APPROVAL_REMARK_CEOnDIR != null">
                <div>
                  {{ this.APPROVAL_REMARK_CEOnDIR }}
                </div>
                <br />
                <div>
                  <VueFileAgent
            ...
            <tr>
              <td style="width: 20%">Remark AR and AAR</td>
              <td style="width: 1%">:</td>
              <td v-if="this.APPROVAL_REMARK_ARnAAR != null">
                <div>
                  {{ this.APPROVAL_REMARK_ARnAAR }}
                </div>
                <br />
                <div>
                  <VueFileAgent
            ...
            <tr>
              <td style="width: 20%">Remark Additional Information</td>
              <td style="width: 1%">:</td>
              <td v-if="this.APPROVAL_REMARK_ADDTIONALINFO != null">
                <div>
                  {{ this.APPROVAL_REMARK_ADDTIONALINFO }}
                </div>
                <br />
                <div>
                  <VueFileAgent
            ...
            <tr>
              <td style="width: 20%">Remark Payment Information</td>
              <td style="width: 1%">:</td>
              <td v-if="this.APPROVAL_REMARK_PAYMENT != null">
                <div>
                  {{ this.APPROVAL_REMARK_PAYMENT }}
                </div>
                <br />
                <div>
                  <VueFileAgent
        ...
        <h5>Proposal Document Remark</h5>
        <table class="table">
          <tbody>
            ...
            <tr v-for="(item, index) in docRemark" :key="index">
              <div v-if="item.REQ_DOCU_TYPE == 1">
                <td style="width: 40%">{{ item.REQ_DOCU_NAME }}</td>
                <td style="width: 1%">:</td>
                <td>
                  {{ item.DOCU_REMARK }}
                </td>
        ...
        <h5>Additional Required Document Remark</h5>
        <table class="table">
          <tbody>
            <tr style="background-color: lightgrey">
              <div>
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.DIST_NAME }}</td>
                  </tr>
                  <tr>
                    <td>Registration Number</td>
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_REGI_NUM1 ? this.distributorDetail.DIST_REGI_NUM1 : '-' }}</td>
                  </tr>
                  <tr>
                    <td style="width: 20%">Company Logo</td>
                    <td style="width: 2%">:</td>
                    <td>
                      <div v-for="(logo,index) in companyLogo" :key="index">
                         <span
                           v-b-tooltip.hover
                           v-on:click="readMore(logo.url)"
                           title="view"
                           class="badge mr-2"
                         >
...
<!--                      ></VueFileAgent>-->
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_REGI_NUM2 ? this.distributorDetail.DIST_REGI_NUM2 : '-' }}</td>
                  </tr>
                  <tr>
                    <td>Date of Incorporation</td>
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_DATE_INCORP }}</td>
                  </tr>
                  <tr>
                    <td>Type of Setup</td>
                    <td>:</td>
                    <td v-if="this.distributorDetail.DIST_TYPE_SETUP == 1">
                      PUBLIC LIMITED COMPANY / BERHAD
                    </td>
                    <td v-if="this.distributorDetail.DIST_TYPE_SETUP == 2">
                  ...
                  <tr>
                    <td style="width: 20%">SSM Form 13</td>
                    <td style="width: 2%">:</td>
                    <td>
                      <VueFileAgent
                        :uploadUrl="'https://example.com'"
                  ...
                  <tr>
                    <td>Country</td>
                    <td>:</td>
                    <td>{{ this.distributorDetail.SET_PARAM_COUNTRY }}</td>
                  </tr>
                  <tr>
                    <td>State</td>
                    <td>:</td>
                    <td v-if="this.distributorDetail.SET_CODE_COUNTRY == 'MY'">
                  ...
                  <tr>
                    ...
                    <td v-if="this.distributorDetail.DIST_PHONE_NUMBER && this.distributorDetail.DIST_PHONE_NUMBER != '-'">
                      0{{
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_PHONE_EXTENSION ? this.distributorDetail.DIST_PHONE_EXTENSION : '-' }}</td>
                  </tr>
                  <tr>
                    <td>Fax Number</td>
                    <td>:</td>
                  ...
                  <tr>
                    ...
                    >
                      0{{
                        distributorDetail.DIST_MOBILE_NUMBER.substring(0, 2)
                      }}-{{
                        distributorDetail.DIST_MOBILE_NUMBER.substring(2, 10)
                      }}
                    </td>
                  </tr>
                  <tr>
                    <td>Email Address</td>
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_EMAIL }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_TYPE_NAME }}</td>
                  </tr>
                </tbody>
              </table>
            </div>
            ...
            <div class="content">
              <h4 slot="header" class="card-title">Section Review</h4>
              <br />
              <vue-form-generator
                v-if="
                this.approvalDetail.TS_PARAM_R === 'NEW ENTRY' ||
                this.approvalDetail.TS_PARAM_R === 'DRAFT' ||
                this.approvalDetail.TS_PARAM_R === 'RETURNED' "
                :model="model"
              ...
              <vue-form-generator
                v-else
                :model="model"
                :schema="disabledRemarkProfileschema"
                :options="formOptions"
                @model-updated="onModelUpdated"
                ref="statusForm"
              >
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.DIST_PAID_UP_CAPITAL }}</td>
                  </tr>
                  <tr>
                    <td>Type of Structure</td>
                    <td>:</td>
                    <td v-if="this.distributorDetail.DIST_TYPE_STRUCTURE == 1">
                      SINGLE-TIER
                    </td>
                    <td v-if="this.distributorDetail.DIST_TYPE_STRUCTURE == 2">
                      MULTI-TIER
                    </td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_NUM_DIST_POINT }}</td>
                  </tr>
                  <tr>
                    <td>Proposed Number of Consultant</td>
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_NUM_CONSULTANT }}</td>
                  </tr>
                  <tr>
                    ...
                    <td
                      v-if="
                        this.distributorDetail.DIST_INSURANCE != null ||
                        this.distributorDetail.DIST_INSURANCE != '' ||
                        this.distributorDetail.DIST_INSURANCE != '-'
                      "
                    >
                      {{ this.distributorDetail.DIST_INSURANCE ? this.distributorDetail.DIST_INSURANCE : '-' }}
                    </td>
                    <td v-if="this.distributorDetail.DIST_INSURANCE == '-'">
                      -
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td v-if="this.distributorDetail.DIST_EXPIRED_DATE == null || this.distributorDetail.DIST_EXPIRED_DATE == '0000-00-00'">
                      -
                    </td>
                    <td v-else>
                      {{ this.distributorDetail.DIST_EXPIRED_DATE  }}
                    </td>
                  </tr>
                </tbody>
              </table>
          ...
          <div v-if="currentTab === 'tab3'">
            ...
            <br />
            <b-collapse id="collapse-ceo1" class="mt-2">
              <br />
              <h4>CEO Profile</h4>
              <table class="table table-striped">
                <tbody
                ...
                <div v-if="item.REPR_TYPE == 'CEO'">
                  ...
                  <tr>
                    ...
                    <td>
                      {{
                      (item.REPR_TELEPHONE && item.REPR_TELEPHONE.length > 1) ?
                      (
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>
                      {{ item.REPR_PHONE_EXTENSION ? item.REPR_PHONE_EXTENSION : '-' }}
                    </td>
                  </tr>
                  <tr>
                    <td>Mobile Phone Number</td>
                    ...
                    <td>
                      {{
                      (item.REPR_MOBILE_NUMBER && item.REPR_MOBILE_NUMBER.length > 1) ?
                      (
                      '01' + item.REPR_MOBILE_NUMBER.substring(0, 1) +
                      "-" +
                      item.REPR_MOBILE_NUMBER.substring(1, 11)
                      ) : '-'
                      }}
                    </td>
                  </tr>
                  <tr>
                    <td>Email</td>
                    <td>:</td>
                    <td>{{ item.REPR_EMAIL ? item.REPR_EMAIL : '-' }}</td>
                  </tr>
                </div>
                </tbody>
              </table>
            </b-collapse>
            <b-collapse id="collapse-ceo2" class="mt-2">
              <br />
              ...
              <table class="table">
                ...
                >
                  ...
                  <td style="width: 20%">{{ item.DIR_PASS_NUM ? item.DIR_PASS_NUM : '-' }}</td>
                  <td style="width: 20%">{{ (item.DIR_PASS_EXPIRY != '0000-00-00') ? item.DIR_PASS_EXPIRY : '-' }}</td>
                  <td style="width: 20%">
                    {{ item.DIR_DATE_EFFECTIVE_DISPLAY ? item.DIR_DATE_EFFECTIVE_DISPLAY : '-' }}
                  </td>
                  <td style="width: 20%">
                    {{ (item.DIR_DATE_END != '0000-00-00') ? item.DIR_DATE_END_DISPLAY : '-'}}
                  </td>
                </tr>
                </tbody>
              </table>
            ...
            <div>
              ...
              <vue-form-generator
                v-else
                :model="model"
                :schema="disabledRemarkCEOnDIRschema"
                :options="formOptions"
                @model-updated="onModelUpdated"
                ref="statusForm"
              >
                  ...
                  >
                    <div v-if="item.REPR_TYPE == 'AR'">
                      ...
                      <tr v-if="item.REPR_CITIZEN == 1">
                        ...
                        <td>:</td>
                        <td
                          v-if="item.REPR_NRIC && (item.REPR_NRIC != '-' || item.REPR_NRIC != '')"
                        >
                          {{
                            item.REPR_NRIC.substring(0, 6) +
                            "-" +
                        ...
                        <td
                          v-if="item.REPR_NRIC == '-' || item.REPR_NRIC == ''"
                        >
                          -
                        </td>
                      </tr>
                      ...
                      <tr>
                        <td>Extension Number</td>
                        <td>:</td>
                        <td>{{ item.REPR_PHONE_EXTENSION ? item.REPR_PHONE_EXTENSION : '-' }}</td>
                      </tr>
                      <tr>
                        <td>Mobile Phone Number</td>
                        <td>:</td>
                        <td v-if="item.REPR_MOBILE_NUMBER && item.REPR_MOBILE_NUMBER != '-'">
                          01{{ item.REPR_MOBILE_NUMBER.substring(0, 1) }}-{{
                  ...
                  >
                    <div v-if="item.REPR_TYPE == 'AAR'">
                      <tr>
                        ...
                        <td>
                          {{ item.USER_SAL_NAME }}
                          {{ item.REPR_NAME ? item.REPR_NAME : '-' }}
                        </td>
                      </tr>
                      <tr>
                        <td>Position</td>
                        <td>:</td>
                        <td>{{ item.REPR_POSITION ? item.REPR_POSITION : '-' }}</td>
                      </tr>
                      <tr v-if="item.REPR_CITIZEN == 1">
                        <td>NRIC No</td>
                        <td>:</td>
                      ...
                      <tr v-if="item.REPR_CITIZEN == 2">
                        <td><b>Passport No</b></td>
                        <td>:</td>
                        <td>{{ item.REPR_PASS_NUM ?  item.REPR_PASS_NUM : '-' }}</td>
                      </tr>
                      <tr v-if="item.REPR_CITIZEN == 2">
                        <td><b>Passport Expiry Date</b></td>
                        <td>:</td>
                        <td>{{ item.REPR_PASS_EXP ? item.REPR_PASS_EXP : '-' }}</td>
                      </tr>
                      <tr>
                        <td>Office Phone Number</td>
                        <td>:</td>
            ...
            <div>
              ...
              <div>
                ...
                <vue-form-generator
                  v-else
                  :model="model"
                  :schema="disabledRemarkARnAARschema"
                  :options="formOptions"
                  @model-updated="onModelUpdated"
                  ref="statusForm"
                >
          ...
          <div v-if="currentTab === 'tab5'">
                  ...
                  >
                    ...
                    >
                      <tr>
                        ...
                        <td style="width: 1%">:</td>
                        <td v-if="item.DIST_FINANCIAL_INSTITUTION == 1">Yes</td>
                        <td v-if="item.DIST_FINANCIAL_INSTITUTION == 2">No</td>
              ...
              <b-collapse id="collapse-planner" class="mt-2">
                ...
                <table class="table table-striped">
                  <tbody>
                    ...
                    <div
                      v-if="
                        this.distributorDetail.DIST_TYPE == '4' ||
                        this.distributorDetail.DIST_TYPE == '5'
                      "
                    >
                      <tr>
                        <td style="width: 20%">Name</td>
                        <td style="width: 1%">:</td>
                        <td>
                          {{ this.distributorDetail.DATAFP.DIST_FP_SALUTATION }}
                          {{ this.distributorDetail.DATAFP.DIST_FP_NAME }}
                        </td>

                        <td
                          v-if="
                            (this.distributorDetail.DATAFP.DIST_FP_SALUTATION == null &&
                              this.distributorDetail.DATAFP.DIST_FP_NAME == null) ||
                            (this.distributorDetail.DATAFP.DIST_FP_SALUTATION == '' &&
                              this.distributorDetail.DATAFP.DIST_FP_NAME == '')
                          "
                        >
                      ...
                      <tr>
                        <td>CMSRL Number</td>
                        <td>:</td>
                        <td v-if="this.distributorDetail.DATAFP.DIST_FP_CSMRL != null">
                          {{ this.distributorDetail.DATAFP.DIST_FP_CSMRL }}
                        </td>
                        <td v-if="this.distributorDetail.DATAFP.DIST_FP_CSMRL == null">-</td>
                      </tr>
                      <tr v-if="this.distributorDetail.DATAFP.DIST_FP_CITIZEN == 1">
                        <td>NRIC No</td>
                        <td>:</td>
                        <td>
                          {{
                            this.distributorDetail.DATAFP.DIST_FP_NRIC.substring(0, 6) +
                            "-" +
                            this.distributorDetail.DATAFP.DIST_FP_NRIC.substring(6, 8) +
                            "-" +
                            this.distributorDetail.DATAFP.DIST_FP_NRIC.substring(8, 13)
                          }}
                        </td>
                      </tr>
                      <tr v-if="this.distributorDetail.DATAFP.DIST_FP_CITIZEN == 2">
                        <td><b>Passport No</b></td>
                        <td>:</td>
                        <td>{{ this.distributorDetail.DATAFP.DIST_FP_PASS_NUM }}</td>
                      </tr>
                      <tr v-if="this.distributorDetail.DATAFP.DIST_FP_CITIZEN == 2">
                        <td><b>Passport Expiry Date</b></td>
                        <td>:</td>
                        <td>{{ this.distributorDetail.DATAFP.DIST_FP_PASS_EXPIRY }}</td>
                      </tr>
                    </div>
                  </tbody>
                </table>
                  ...
                  >
                    ...
                    >
                      ...
                      <tr>
                        <td>Office Phone Number</td>
                        <td>:</td>
                        <td v-if="item.ADD_TELEPHONE && item.ADD_TELEPHONE != '-'">
                      ...
                      <tr>
                        ...
                        <td>:</td>
                        <td>
                          {{ item.ADD_PHONE_EXTENSION ? item.ADD_PHONE_EXTENSION  : '-'}}
                        </td>
                      </tr>
                      <tr>
                        <td>Mobile Phone Number</td>
                        <td>:</td>
                        <td v-if="item.ADD_MOBILE_NUMBER && item.ADD_MOBILE_NUMBER != '-'">
                      ...
                      <tr>
                        <td>Email</td>
                        <td>:</td>
                        <td>{{ item.ADD_EMAIL ? item.ADD_EMAIL : '-' }}</td>
                      </tr>
                    </div>
                  </tbody>
                </table>
                  ...
                  >
                    ...
                    >
                      ...
                      <tr>
                        <td>Extension Number</td>
                        <td>:</td>
                        <td>{{ item.ADD_PHONE_EXTENSION ? item.ADD_PHONE_EXTENSION : '-' }}</td>
                      </tr>
                      <tr>
                        <td>Mobile Phone Number</td>
                        <td>:</td>
                  ...
                  >
                    <div v-if="item.ADD_TYPE == 'HOD_TRAIN'">
                      ...
                      <tr>
                        <td>Office Phone Number</td>
                        <td>:</td>
                        <td v-if="item.ADD_TELEPHONE && item.ADD_TELEPHONE != null">
                          0{{ item.ADD_TELEPHONE.substring(0, 1) }}-{{
                            item.ADD_TELEPHONE.substring(1, 10)
                          }}
                        </td>
            ...
            <div>
              ...
              <vue-form-generator
                v-else
                :model="model"
                :schema="disabledRemarkADDINFOschema"
                :options="formOptions"
                @model-updated="onModelUpdated"
                ref="statusForm"
              >
          ...
          <div v-if="currentTab === 'tab6'">
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    ...
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.BANK_NAME }}</td>
                  </tr>
                  <tr>
                    <td style="width: 20%">Reference Number</td>
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.DIST_TRANS_REF }}</td>
                  </tr>
                  <tr>
                    <td style="width: 20%">Transaction Date</td>
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.DIST_TRANS_DATE }}</td>
                  </tr>
                  <tr>
                    <td style="width: 20%">Transaction Type</td>
                    <td style="width: 1%">:</td>
                    <td v-if="this.distributorDetail.DIST_TRANS_TYPE == 1">
                      ONLINE TRANSACTION
                    </td>
                    <td v-if="this.distributorDetail.DIST_TRANS_TYPE == 2">
                      CASH DEPOSIT
                    </td>
                    <td v-if="this.distributorDetail.DIST_TRANS_TYPE == 3">
                      CHEQUE DEPOSIT
                    </td>
                  </tr>
                  <tr>
                    ...
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.DIST_ACC_AMOUNT }}</td>
                  </tr>
                  <tr>
                    <td style="width: 20%">Payment Status</td>
                    <td style="width: 1%">:</td>
                    <td>{{ this.distributorDetail.PAYMENT_STATUS }}</td>
                  </tr>
                  <tr>
                    <td style="width: 20%">Payment Advice</td>
                    <td style="width: 1%">:</td>
                    <td>
                      <VueFileAgent
                        :uploadUrl="'https://example.com'"
            ...
            <div>
              ...
              <vue-form-generator
                v-else
                :model="model"
                :schema="disabledRemarkPaymentschema"
                :options="formOptions"
                @model-updated="onModelUpdated"
                ref="statusForm"
              >
                ...
                >
                  ...
                  <template slot="remark" slot-scope="row">
                    <textarea
                      ...
                      v-model="row.rowData.PROPOSAL_REMARK"
                    ></textarea>
                  </template>
                </va-data-table>
              </div>
      ...
      <div>
        ...
        <div
          ...
          v-if="
            ...
            this.approvalDetail.TS_PARAM_R === 'DRAFT' ||
            this.approvalDetail.TS_PARAM_R === 'RETURNED' ||
            this.approvalDetail.TS_PARAM === 'ACCEPTED'
          "
        >
          <button
            @click="submit(1)"
          ...
          <button
            v-if="this.approvalDetail.TS_PARAM !== 'ACCEPTED'"
            @click="submit(14)"
            type="button"
          ...
          <button
            ...
            class="mr-2 btn btn-success btn-fill btn-md"
          >
            <i class="fa fa-paper-plane" /> &nbsp; Recommended for Approval
          </button>
        </div>
      </div>
    </va-card>
          ...
          <div>
            <div class="float-left">
              <h5>
                ...
                <downloadExcel
                  :json_data="distributorDetail.APPRLOG"
                  :excelname="excelname"
                  :sheetname="sheetname"
                ></downloadExcel>
              </h5>
            ...
            <va-data-table
              ...
              :datacount="distributorDetail.APPRLOG.length"
            >
              <!-- A virtual column -->
              <template slot="no" slot-scope="row">
                {{ row.rowIndex + 1 }}
...
export default {
  ...
  mounted() {
    var data = localStorage.getItem("distributor-SubmissionList-rdApproval");
        ...
        groups: [
          {
            ...
            fields: [
              ...
              // },
              {
                ...
                required: false,
                hint:"Maximum uploaded file size is 10MB. Accepted format : (.PDF)",
              },
  ...
  methods: {
    async back() {
      this.$router.push("/fimm/distributor-SubmissionList-rdApproval");
    },

    async readMore(data) {
      this.$modals.readModal.$show();
      this.model.logoUrl = data;
    },

    async getReview(){
      //alert('ddddd');
      const user = localStorage.getItem("user");
      var dist_id = this.approvalDetail.DISTRIBUTOR_ID;
      var group_id = JSON.parse(user).USER_GROUP_ID;
      var level_id =  this.approvalDetail.APPROVAL_LEVEL_ID;
      const response = await services06Module1.getDistributorReviewData(dist_id,group_id,level_id);
      this.model.remark = response.approval.APPROVAL_REMARK_PROFILE ?? "";
      this.model.remark1 = response.approval.APPROVAL_REMARK_DETAILINFO ?? "";
      this.model.remark3 = response.approval.APPROVAL_REMARK_CEOnDIR ?? "";
      this.model.remark4 = response.approval.APPROVAL_REMARK_ARnAAR ?? "";
      this.model.remark5 = response.approval.APPROVAL_REMARK_ADDTIONALINFO ?? "";
      this.model.remark6 = response.approval.APPROVAL_REMARK_PAYMENT ?? "";
      this.DIST_APPROVAL_ID = response.approval.DIST_APPROVAL_ID;

      // Call Proposal Data
      this.getDocumentProposal();
      // Set Documents
      response.doc.forEach((element) => {
    ...
    filesSelected: function (fileRecordsNewlySelected, status) {
      console.log("selected",fileRecordsNewlySelected);
    ...
    async submit(status) {
      ...
      data.append("DIST_ID", this.approvalDetail.DISTRIBUTOR_ID);
      data.append("DIST_TYPE_ID", this.distributorDetail.DIST_TYPE_ID);
      data.append("APPR_GROUP_ID", JSON.parse(user).USER_GROUP_ID);
      data.append("APPROVAL_LEVEL_ID", this.approvalDetail.APPROVAL_LEVEL_ID);
      data.append("APPROVAL_STATUS", status);
      data.append("APPROVAL_FIMM_USER", JSON.parse(user).user_id);
      ...
      data.append("APPR_REMARK_DOCU_DETAILINFO", this.model.fileRemark2);
      data.append("APPR_REMARK_DOCU_CEOnDIR", this.model.fileRemark3);
      data.append("APPR_REMARK_DOCU_ARnAAR", this.model.fileRemark4);
      data.append("APPR_REMARK_DOCU_ADDITIONALINFO", this.model.fileRemark5);
      data.append("APPR_REMARK_DOCU_PAYMENT", this.model.fileRemark6);

      // if (this.model.fileRemark2.length != 0) {
      ...
      data.append("APPROVAL_REMARK_CEOnDIR", this.model.remark3);
      // if (this.model.fileRemark3.length != 0) {
      ...
      data.append("APPROVAL_REMARK_ARnAAR", this.model.remark4);
      // if (this.model.fileRemark4.length != 0) {
      ...
      data.append("APPROVAL_REMARK_ADDTIONALINFO", this.model.remark5);
      // if (this.model.fileRemark5.length != 0) {
      ...
      data.append("APPROVAL_REMARK_PAYMENT", this.model.remark6);
      // if (this.model.fileRemark6.length != 0) {
      ...
      data.append("APPR_INDEX", this.approvalDetail.APPR_INDEX);

      data.append("USER_TYPE",'RD');

      if (status == 14) {
        console.log(this.approvalDetail.APPR_INDEX);
        data.append(
          "NOTI_LOCATION",
          "distributor-SubmissionList-HODrdApproval"
        );

        data.append(
          "NOTI_MESSAGE",
          "(DIST) New registration for HOD RD approval."
        );

        const approvalLevel = await services06Module0.getApprovalLevel(
          1,
          this.approvalDetail.APPR_INDEX + 1
        );
        const user=JSON.parse(localStorage.getItem("user"));
        data.append('USER_GROUP_ID',user.USER_GROUP_ID);
        ...
        data.append("APPROVAL_STATUS_NEXT", 15); //pending
        if (confirm("Finish reviewing this application? ")) {
          const response = await services06Module1.createDistributorReview(
            data
          );
          alert(
            "This submission has been reviewed, please wait for review by HOD."
          );
          this.$router.go(-1);
        } else {
          console.log("");
        ...
        data.append(
          "NOTI_MESSAGE",
          "(DISTRIBUTOR) RECOMMENDED DISTRIBUTOR FOR HOD RD APPROVAL."
        );
        ...
        data.append("APPR_INDEX_CURRENT", this.approvalDetail.APPR_INDEX);
        data.append("APPROVAL_STATUS_NEXT", 15); //pending
        if (confirm("Confirm to recommend for approval on this application?")) {
          const response = await services06Module1.createDistributorReview(
            data
          );
          alert(
        ...
        console.log(this.approvalDetail.APPR_INDEX);
        if (confirm("Return this application? ")) {
          data.append("APPROVAL_STATUS_NEXT", 7); //return
          const response = await services06Module1.createDistributorReview(data);
          dataEmail.append("EMAIL", this.distributorDetail.DIST_EMAIL);
          dataEmail.append("DIST_NAME", this.distributorDetail.DIST_NAME);
          dataEmail.append("DIST_REMARK", "has been returned.");
          const sendEmailNotification =
            await services06Module1.sendEmailNotification(dataEmail);
        ...
        console.log(this.approvalDetail.APPR_INDEX);
        if (confirm("Save as draft this application? ")) {
          data.append("APPROVAL_STATUS_NEXT", 2); //save as draft
          const response = await services06Module1.createDistributorReview(data);
          // dataEmail.append("EMAIL", this.distributorDetail.DIST_EMAIL);
          // dataEmail.append("DIST_NAME", this.distributorDetail.DIST_NAME);
          // dataEmail.append("DIST_REMARK", "has been returned.");
    ...
    async getDocumentProposal() {
      const data = {
        DIST_APPROVAL_ID:this.DIST_APPROVAL_ID,
        REQ_DOCU_TYPE: 1,
    ...
    saveAsDraft() {
      if (confirm("Are you sure you want to save as draft?")) {
        alert("This application review has been save as draft.");
      }
    },
    validatestatusForm() {
