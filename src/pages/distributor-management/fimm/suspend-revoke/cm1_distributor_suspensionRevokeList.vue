  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Suspension/Revocation : List of Submissions
      </h4>
      <br />
    ...
    <va-card class="mt-5 col-12">
      ...
      >
        ...
        <template slot="actions" slot-scope="props">
          <h5 class="mt-1">
            <span
              v-if="props.rowData.TS_ID == 1 || props.rowData.TS_ID == 9"
              v-b-tooltip.hover
...
export default {
  ...
  methods: {
    ...
    async viewRecord(data) {
      localStorage.setItem("view-submission-form", JSON.stringify(data));
      this.$router.push({
    ...
    async editRecord(data) {
      localStorage.setItem("edit-submission-form", JSON.stringify(data));
      this.$router.push({
