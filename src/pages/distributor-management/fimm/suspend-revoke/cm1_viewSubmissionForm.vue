  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Suspension/Revocation : View Submission Form
      </h4>
    </div>
    <br />
    <va-card>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td>
                  ...
                  {{ DISTDATA.SET_CITY_NAME }}{{ DISTDATA.DIST_CITY2 }}<br />
    ...
    <va-card>
      <div class="ml-2 col-md-12">
        ...
        <table class="table table-striped">
            ...
            <tr>
              <td>Status</td>
              <td colspan="3">{{ DISTDATA.STATUS }}</td>
            </tr>
                </tbody>
              </table>
      </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("view-submission-form");
