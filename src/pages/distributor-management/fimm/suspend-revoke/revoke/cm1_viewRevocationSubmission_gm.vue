...
export default {
  mounted() {
    var data = localStorage.getItem("view-revocationSubmission-gm");
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure you want to save this as draft?")) {
        ...
        try {
          ...
          this.$router.push("/fimm/revocation-gmApproval-list");
        } catch (error) {
          console.log(error);
        }
      }
    ...
    reject: async function () {
      if (confirm("Are you sure you want to reject this submission?")) {
        ...
        data.append(
          "NOTI_REMARK",
          "(REVOCATION) This Entry has been rejected by GM"
        );
    ...
    reviewSubmission: async function () {
      if (confirm("Are you sure you want to proceed this submission?")) {
        ...
        data.append("NOTI_LOCATION", "revocation-ceoApproval-list");
         var NotificationNote ="(REVOCATION) " +this.DISTDATA.DIST_NAME +" pending for Approval";
        data.append("NOTI_REMARK", NotificationNote);

        data.append("NOTI_EMAIL", "This Entry pending for your approval :");
