  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Revocation : Review Submission Form
      </h4>
    </div>
    <br />
    <br />
...
export default {
  mounted() {
    var data = localStorage.getItem("view-revocationSubmission-ceo");
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure you want to save this as draft?")) {
        ...
        try {
          ...
          this.$router.push("/fimm/revocation-ceoApproval-list");
        } catch (error) {
          console.log(error);
        }
      }
    ...
    returnSubmission: async function () {
      if (confirm("Are you sure you want to return this submission?")) {
        ...
        var NotificationNote ="(REVOCATION) " +this.DISTDATA.DIST_NAME +".This Entry has been returned by CEO";
        ...
        var NotificationNote2 ="(REVOCATION) " +this.DISTDATA.DIST_NAME +".This Entry has been returned to submitter by CEO";
    ...
    reject: async function () {
      if (confirm("Are you sure you want to reject this submission?")) {
        ...
        data.append("NOTI_LOCATION", "suspension-revocation-list");
        var NotificationNote ="(REVOCATION) " +this.DISTDATA.DIST_NAME +".This Entry has been rejected by CEO";
        data.append("NOTI_REMARK", NotificationNote);
        ...
        data.append("NOTI_LOCATION2", "view-suspension-revocation-list");
        var NotificationNote2 ="(REVOCATION) " +this.DISTDATA.DIST_NAME +".This Entry has been rejected by CEO";
        data.append("NOTI_REMARK2", NotificationNote2);
    ...
    reviewSubmission: async function () {
      if (confirm("Are you sure you want to approve this submission?")) {
        ...
        data.append("NOTI_LOCATION", "suspension-revocation-list");
        var NotificationNote ="(REVOCATION) " +this.DISTDATA.DIST_NAME +".This Entry has been approved by CEO";
        data.append("NOTI_REMARK", NotificationNote);
        ...
        data.append(
          "DIST_NOTI_REMARK",
          "Your Company has been revoked by FIMM"
        );
        ...
        if (moment(this.DISTDATA.DATE_START).isSameOrBefore(moment())){
          data.append("NOTI_EMAIL", "Your Company Has been Revoked by FIMM :");
        }else{
          data.append("NOTI_EMAIL", "Your Company will be Revoked by FIMM :");
        }

          //get x days for appeal
        const getAppealDays = await servicesModule1.getAppealDays("APPEAL_DURATION_REVOCATION");
