<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Suspension : List of Submissions for Recommendation </h4>
       <br />
...
export default {
  ...
  methods: {
    ...
    getAllList: async function () {
      ...
      const response = await servicesModule1.getApprRecordById(APPR_GROUP_ID,1);
