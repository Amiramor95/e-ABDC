...
export default {
  mounted() {
    var data = localStorage.getItem("view-suspensionSubmission-hod");
  ...
  methods: {
      ...
      if (confirm("Are you sure you want to return this submission?")) {
        ...
        data.append("NOTI_LOCATION", "suspension-revocation-list");
         var NotificationNote =
          ...
          ".This Entry Has Been Returned by HOD";
    ...
    reviewSubmission: async function () {
      if (confirm("Are you sure you want to proceed this submission?")) {
        ...
        data.append("NOTI_LOCATION", "suspension-gmApproval-list");
          var NotificationNote =
          "(SUSPENSION) New Entry Pending Recommendation for " +
          this.DISTDATA.DIST_NAME;
        data.append("NOTI_REMARK", NotificationNote);
