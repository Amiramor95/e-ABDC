...
export default {
  mounted() {
    var data = localStorage.getItem("view-suspensionSubmission-gm");
    this.DISTDATA = JSON.parse(data);
    //alert(JSON.stringify(this.DISTDATA.APPR_REMARK));
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure you want to save this as draft?")) {
        ...
        try {
          ...
          this.$router.push("/fimm/suspension-gmApproval-list");
        } catch (error) {
          console.log(error);
        }
      }
    ...
    returnSubmission: async function () {
      if (confirm("Are you sure you want to return this submission?")) {
        ...
        var NotificationNote =
          ...
          ".This Entry has been returned by GM";
        ...
        data.append("NOTI_LOCATION2", "view-suspension-revocation-list");
         var NotificationNote2 =
          "(SUSPENSION) " +
          this.DISTDATA.DIST_NAME +
          ".This Entry Has Been Returned to Submitter by GM";
    ...
    reject: async function () {
      if (confirm("Are you sure you want to reject this submission?")) {
        ...
        var NotificationNote3 =
          "(SUSPENSION) Entry for " +
          this.DISTDATA.DIST_NAME +
          " has been rejected by GM";
        data.append("NOTI_REMARK",NotificationNote3);
        ...
        data.append("NOTI_LOCATION2", "view-suspension-revocation-list");
        data.append("NOTI_REMARK2",NotificationNote3);
    ...
    reviewSubmission: async function () {
      if (confirm("Are you sure you want to proceed this submission?")) {
        ...
        data.append("NOTI_LOCATION", "suspension-ceoApproval-list");
        var NotificationNote ="(SUSPENSION) New Entry Pending Approval for " + this.DISTDATA.DIST_NAME;
        data.append("NOTI_REMARK", NotificationNote);

        data.append("NOTI_EMAIL", "This submission pending for your approval :");
