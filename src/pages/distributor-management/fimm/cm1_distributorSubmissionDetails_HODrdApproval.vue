    ...
    >
              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_REGI_NUM1 }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_REGI_NUM2 }}</td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_PHONE_EXTENSION }}</td>
                  </tr>
                  <tr>
                    <td>Fax Number</td>
                    <td>:</td>
                    ...
                    >
                      <tr>
                        ...
                        <td>
                          ...
                          {{ this.distributorDetail.DATAFP.DIST_FP_NAME ? this.distributorDetail.DATAFP.DIST_FP_NAME : '-' }}
                        </td>
      ...
      <div>
        ...
        <div
          class="float-right"
          v-if="
            this.approvalDetail.TS_PARAM === 'PENDING' ||
            this.approvalDetail.TS_PARAM === 'DRAFT' ||
            // this.approvalDetail.TS_PARAM === 'REVIEWED' ||
            this.approvalDetail.TS_PARAM_MAIN === 'RECOMMENDED'
          "
        >
          <button
            @click="submit(1)"
          ...
          <button
            @click="submit(14)"
            v-if="this.approvalDetail.TS_PARAM_MAIN !== 'RECOMMENDED'"
            type="button"
...
export default {
  ...
  mounted() {
    var data = localStorage.getItem("distributor-SubmissionList-HODrdApproval");
    this.approvalDetail = JSON.parse(data);
    this.getDistributorById(
      this.approvalDetail.DISTRIBUTOR_ID,
      this.approvalDetail.APPR_GROUP_ID
    );
  },
  ...
  methods: {
    async back() {
      this.$router.push("/fimm/distributor-SubmissionList-HODrdApproval");
    },
    async readMore(data) {
    ...
    async submit(status) {
      ...
      if (status == 14) {
        ...
        if (this.approvalDetail.APPR_INDEX == 2) {
          data.append(
            "NOTI_LOCATION",
          ...
          data.append(
            "NOTI_LOCATION2",
            "distributor-SubmissionList-supervisionApproval"
          );

          data.append(
            "NOTI_MESSAGE",
            "(DISTRIBUTOR) NEW DISTRIBUTOR APPROVAL FOR LRA."
          );
        } else if (this.approvalDetail.APPR_INDEX == 5) {
          data.append("NOTI_LOCATION", "distributor-SubmissionList-gmApproval");
          data.append(
            "NOTI_MESSAGE",
            "(DISTRIBUTOR) NEW DISTRIBUTOR APPROVAL FOR GM."
          );
        }
        ...
        data.append("APPROVAL_STATUS_NEXT", 15);
        ...
        if (confirm("Finish reviewing this application ?")) {
          ...
          this.$router.go(-1);
          alert(
            "This submission has been reviewed, please wait for approval by legal and supervision approval."
          );
        } else {
          console.log("");
        }
        ...
        if (this.approvalDetail.APPR_INDEX == 5) {
           approvalLevel = await services06Module0.getApprovalLevel(1, 4);
        } else if (this.approvalDetail.APPR_INDEX == 2) {
          approvalLevel = await services06Module0.getApprovalLevel(1, 1);
        }
        data.append("APPR_LIST", JSON.stringify(approvalLevel));
        data.append("APPR_INDEX_CURRENT", this.approvalDetail.APPR_INDEX);
        data.append("APPROVAL_STATUS_NEXT", 12);
        data.append("NOTI_REMARK", '(DIST) DISTRIBUTOR HAS BEEN RETURNED BY HOD');
        data.append("NOTI_LOCATION", 'distributor-SubmissionList-rdApproval');
        ...
        if (confirm("Save as draft this application? ")) {
          data.append("APPROVAL_STATUS_NEXT", 15); //save as draft
          const response = await services06Module1.createDistributorReview(data);
