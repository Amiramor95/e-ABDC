  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Cessation Submission for Approval : {{DISTDATA.DISTRIBUTOR_NAME}}
      </h4>
    </div>
    <br />
     <vue-html2pdf
...
export default {
  mounted() {
    var data = localStorage.getItem("cessation-submission-rdApproval");
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure you want to save this as draft?")) {
        ...
        try {
          ...
          this.$router.push("/fimm/cessation-submission-list");
        } catch (error) {
          console.log(error);
        }
      }
    ...
    returnSubmission: async function () {
      if (confirm("Are you sure you want to return this submission?")) {
        ...
        data.append("DIST_APPR_LIST", JSON.stringify(approvalLevel));
        ...
        data.append(
          "DIST_NOTI_REMARK",
          "(CESSATION) This entry has been returned by FIMM"
        );
        ...
        data.append("CESSATION_DATE", this.DISTDATA.CESSATION_DATE);
         data.append(
              "NOTI_EMAIL",
              "Your following cessation submission has been Returned by FIMM :"
            );
    ...
    reviewSubmission: async function () {
      ...
      if (confirm("Are you sure you want to approve this submission?")) {
        ...
        const approvalLevel = await services06Module0.getApprovalLevel(3, 2);
        ...
        data.append("NOTI_LOCATION", "cessation-submission-hod-list");
