  ...
  <div class="text-center text-danger my-2" v-if="!isDataReady">
    ...
    <div v-else>
      <div class="">
        ...
        <vudal name="showStaticModalSubmitted" class="widthModal">
          <div class="content">
              ...
              <div>
                <va-card>
                  ...
                  <div v-if="tabValue === 1" class="tabcontent">
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          <td style="width: 20%"><b>Company Logo</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            <vue-form-generator
                              :model="model"
                              :schema="previewCompanyLogo"
                              :options="formOptions"
                              ref="previewCompanyLogo"
                              @model-updated="onModelUpdated"
                            >
                            </vue-form-generator>
                          </td>
                        ...
                        <tr v-if="model.DIST_TYPE_SETUP == 1">
                          ...
                          <td>
                            <vue-form-generator
                              :model="model"
                              :schema="previewfirstTabSchemaForm8"
                              :options="formOptions"
                              ref="previewfirstTabSchemaForm8"
                              @model-updated="onModelUpdated"
                            >
                            </vue-form-generator>
                          </td>
                        ...
                        <tr v-if="model.DIST_TYPE_SETUP == 2">
                          ...
                          <td>
                            <vue-form-generator
                              :model="model"
                              :schema="previewfirstTabSchemaForm9"
                              :options="formOptions"
                              ref="previewfirstTabSchemaForm9"
                              @model-updated="onModelUpdated"
                            >
                            </vue-form-generator>
                          </td>
                        </tr>
                        <tr v-if="model.ssmForm13 && model.ssmForm13.length > 0">
                          <td style="width: 20%"><b>SSM Form 13</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            <vue-form-generator
                              :model="model"
                              :schema="previewfirstTabSchemaForm13"
                              :options="formOptions"
                              ref="previewfirstTabSchemaForm13"
                              @model-updated="onModelUpdated"
                            >
                            </vue-form-generator>
                          </td>
                        ...
                        <tr>
                          <td style="font-size: 20px;" colspan="3"><b>Registered Address</b></td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          <td style="font-size: 20px;" colspan="3"><b>Business Address</b></td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Address</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{ model.DIST_BIZ_ADDR_1 }} {{ model.DIST_BIZ_ADDR_2 }}
                        ...
                        <tr>
                          <td style="width: 20%"><b>Country</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.DIST_BIZ_COUNTRY.SET_PARAM }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>State</b></td>
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_BIZ_COUNTRY.SET_CODE == 'MY'">
                            {{ model.DIST_BIZ_STATE.SET_PARAM }}
                          </td>
                          <td v-if="model.DIST_BIZ_COUNTRY.SET_CODE != 'MY'">
                        ...
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_BIZ_COUNTRY.SET_CODE == 'MY'">
                            {{ model.DIST_BIZ_CITY.SET_CITY_NAME }}
                          </td>
                          <td v-if="model.DIST_BIZ_COUNTRY.SET_CODE != 'MY'">
                            {{ model.DIST_BIZ_CITY }}
                          </td>
                        ...
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_BIZ_COUNTRY.SET_CODE == 'MY'">
                            {{ model.DIST_BIZ_POSTAL.POSTCODE_NO }}
                          </td>
                          <td v-if="model.DIST_BIZ_COUNTRY.SET_CODE != 'MY'">
                        ...
                        <tr>
                          ...
                          <td v-if="model.DIST_PHONE_NUMBER != null && model.DIST_PHONE_NUMBER.length < 1">-</td>
                          <td v-if="model.DIST_PHONE_NUMBER && model.DIST_PHONE_NUMBER.length > 1">
                            0{{
                        ...
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td>{{ model.DIST_PHONE_EXTENSION ? model.DIST_PHONE_EXTENSION  : '-'}}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Fax Number</b></td>
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_FAX_NUMBER != null">
                            0{{
                          ...
                          <td v-if="model.DIST_FAX_NUMBER == null">-</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Mobile Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_MOBILE_NUMBER != null">
                            0{{
                          ...
                          <td v-if="model.DIST_MOBILE_NUMBER == null">-</td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td>{{ model.DIST_COMPANY_WEBSITE ? model.DIST_COMPANY_WEBSITE : '-' }}</td>
                        </tr>
                        <tr>
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_TYPE_STRUCTURE == 1">Single-Tier</td>
                          <td v-if="model.DIST_TYPE_STRUCTURE == 2">Multi-Tier</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Marketing Approach</b></td>
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_MARKETING_APPROACH == 1">Direct</td>
                          <td v-if="model.DIST_MARKETING_APPROACH == 2">Nominee</td>
                        </tr>
                        <tr>
                          <td style="width: 20%">
                        ...
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td>{{ model.DIST_INSURANCE ? model.DIST_INSURANCE : '-' }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%">
                          ...
                          <td style="width: 2%">:</td>
                          <td>{{ (model.DIST_EXPIRED_DATE) ? model.DIST_EXPIRED_DATE : '' }}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                  <div v-if="tabValue === 3" class="tabcontent">
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{
                              (model.CEO_REPR_TELEPHONE && model.CEO_REPR_TELEPHONE.length > 1) ?
                              (
                                '0' + model.CEO_REPR_TELEPHONE.substring(0, 1) +
                                "-" +
                                model.CEO_REPR_TELEPHONE.substring(1, 10)
                              ) : '-'
                            }}
                          </td>
                          <td v-if=" model.CEO_REPR_TELEPHONE != null && model.CEO_REPR_TELEPHONE.length < 1"></td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Extension Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.CEO_REPR_PHONE_EXTENSION ? model.CEO_REPR_PHONE_EXTENSION : '-' }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Mobile Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{
                              (model.CEO_REPR_MOBILE_NUMBER && model.CEO_REPR_MOBILE_NUMBER.length > 1) ?
                              (
                                '01' + model.CEO_REPR_MOBILE_NUMBER.substring(0, 1) +
                                "-" +
                        ...
                        <tr>
                          <td style="width: 20%"><b>CEO is an Authorized Representative (AR)</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{ (model.CEO_isRepresentative) ? 'Yes' : 'No' }}
                          </td>
                        </tr>
                      </tbody>
                    </table>
                    ...
                    <va-card>
                      <va-data-table :fields="fieldsView" :data="filteredData">
                        <!-- A virtual column -->
                        <template slot="no" slot-scope="row">
                          {{ row.rowIndex + 1 }}
                        </template>
                        <template slot="nric" slot-scope="row">
                          {{(row.rowData.DIR_NRIC) ? (
                          row.rowData.DIR_NRIC.substring(0, 6) +
                          "-" +
                          row.rowData.DIR_NRIC.substring(6, 8) +
                          "-" +
                          row.rowData.DIR_NRIC.substring(8, 13)
                          ) : '-'}}
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{
                              (model.AR_REPR_TELEPHONE && model.AR_REPR_TELEPHONE.length > 1) ?
                              (
                                '0' + model.AR_REPR_TELEPHONE.substring(0, 1) +
                                "-" +
                                model.AR_REPR_TELEPHONE.substring(1, 10)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.AR_REPR_TELEPHONE != null && model.AR_REPR_TELEPHONE.length < 1"></td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Extension Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.AR_REPR_PHONE_EXTENSION ? model.AR_REPR_PHONE_EXTENSION : '-' }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Mobile Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{
                              (model.AR_REPR_MOBILE_NUMBER && model.AR_REPR_MOBILE_NUMBER.length > 1) ?
                              (
                                '01' + model.AR_REPR_MOBILE_NUMBER.substring(0, 1) +
                                "-" +
                                model.AR_REPR_MOBILE_NUMBER.substring(1, 11)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.AR_REPR_MOBILE_NUMBER != null && model.AR_REPR_MOBILE_NUMBER.length < 1">-</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Email</b></td>
                          <td style="width: 2%">:</td>
                        ...
                        <tr>
                          ...
                          <td>
                            <vue-form-generator
                              :model="model"
                              :schema="previewSchemaBodApproval"
                              :options="formOptions"
                              ref="previewSchemaBodApproval"
                              @model-updated="onModelUpdated"
                            >
                            </vue-form-generator>
                          </td>
                      ...
                      <tbody>
                        <tr>
                          ...
                          <td>
                            ...
                            {{ model.AAR_REPR_NAME ? model.AAR_REPR_NAME : '-' }}
                          </td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Position</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.AAR_REPR_POSITION ? model.AAR_REPR_POSITION : '-' }}</td>
                        </tr>
                        <tr v-if="model.AAR_REPR_CITIZEN == 1">
                          <td style="width: 20%"><b>NRIC No</b></td>
                          <td style="width: 2%">:</td>
                          <td v-if="model.AAR_REPR_NRIC == null">-</td>
                          <td
                            v-if="
                              (model.AAR_REPR_NRIC != null) |
                                (model.AAR_REPR_NRIC != '')
                            "
                          >
                            {{ model.AAR_REPR_NRIC }}
                        ...
                        <tr v-if="model.AAR_REPR_CITIZEN == 2">
                          <td style="width: 20%"><b>Passport No</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.AAR_REPR_PASS_NUM ? model.AAR_REPR_PASS_NUM : '-'}}</td>
                        </tr>
                        <tr v-if="model.AAR_REPR_CITIZEN == 2">
                          <td style="width: 20%"><b>Passport Expiry Date</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.AAR_REPR_PASS_EXP ? model.AAR_REPR_PASS_EXP : '-' }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Office Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{
                              (model.AAR_REPR_TELEPHONE && model.AAR_REPR_TELEPHONE.length > 1) ?
                              (
                                '0' + model.AAR_REPR_TELEPHONE.substring(0, 1) +
                                "-" +
                                model.AAR_REPR_TELEPHONE.substring(1, 10)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.AAR_REPR_TELEPHONE != null && model.AAR_REPR_TELEPHONE.length < 1">-</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Extension Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.AAR_REPR_PHONE_EXTENSION ? model.AAR_REPR_PHONE_EXTENSION : '-' }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Mobile Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{
                              (model.AAR_REPR_MOBILE_NUMBER && model.AAR_REPR_MOBILE_NUMBER.length > 1) ?
                              (
                                '01' + model.AAR_REPR_MOBILE_NUMBER.substring(0, 1) +
                                "-" +
                                model.AAR_REPR_MOBILE_NUMBER.substring(1, 11)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.AAR_REPR_MOBILE_NUMBER != null && model.AAR_REPR_MOBILE_NUMBER.length < 1">-</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Email</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.AAR_REPR_EMAIL ? model.AAR_REPR_EMAIL : '-' }}</td>
                        </tr>
                      </tbody>
                    </table>
                  </div>
                    ...
                    >
                      ...
                      <table class="table">
                        <tr>
                          ...
                          <td style="width: 2%">:</td>
                          <td v-if="model.DIST_FINANCIAL_INSTITUTION == 1">YES</td>
                          <td v-if="model.DIST_FINANCIAL_INSTITUTION == 2">NO</td>
                        </tr>
                      </table>
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{
                              (model.COMPL_TELEPHONE && model.COMPL_TELEPHONE.length > 1) ?
                              (
                                '0' + model.COMPL_TELEPHONE.substring(0, 1) +
                                "-" +
                          ...
                          <td v-if="model.COMPL_TELEPHONE !=null && model.COMPL_TELEPHONE.length < 1"></td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Extension Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.COMPL_PHONE_EXTENSION ? model.COMPL_PHONE_EXTENSION : '-'}}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Mobile Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{
                              (model.COMPL_MOBILE_NUMBER && model.COMPL_MOBILE_NUMBER.length > 1) ?
                              (
                                '01' + model.COMPL_MOBILE_NUMBER.substring(0, 1) +
                                "-" +
                                model.COMPL_MOBILE_NUMBER.substring(1, 11)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.COMPL_MOBILE_NUMBER != null && model.COMPL_MOBILE_NUMBER.length < 1">-</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Email</b></td>
                          <td style="width: 2%">:</td>
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              {{
                                (model.UTS_TELEPHONE && model.UTS_TELEPHONE.length > 1) ?
                                  (
                                    '0' + model.UTS_TELEPHONE.substring(0, 1) +
                                    "-" +
                                    model.UTS_TELEPHONE.substring(1, 10)
                                  ) : '-'
                              }}
                            </td>
                            <td v-if="model.UTS_TELEPHONE != null && model.UTS_TELEPHONE.length < 1">-</td>
                          </tr>
                          <tr>
                            <td style="width: 20%"><b>Extension Number</b></td>
                            <td style="width: 2%">:</td>
                            <td>{{ model.UTS_PHONE_EXTENSION ? model.UTS_PHONE_EXTENSION : '-' }}</td>
                          </tr>
                          <tr>
                            <td style="width: 20%"><b>Mobile Phone Number</b></td>
                            <td style="width: 2%">:</td>
                            <td>
                              {{
                                (model.UTS_MOBILE_NUMBER && model.UTS_MOBILE_NUMBER.length > 1) ?
                                (
                                  '01' + model.UTS_MOBILE_NUMBER.substring(0, 1) +
                                  "-" +
                                  model.UTS_MOBILE_NUMBER.substring(1, 11)
                                ) : '-'
                              }}
                            </td>
                            <td v-if="model.UTS_MOBILE_NUMBER != null && model.UTS_MOBILE_NUMBER.length < 1">-</td>
                          </tr>
                          <tr>
                            <td style="width: 20%"><b>Email</b></td>
                            <td style="width: 2%">:</td>
                      ...
                      <table class="table">
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                              {{
                                (model.PRS_TELEPHONE && model.PRS_TELEPHONE.length > 1) ?
                                (
                                  '0' + model.PRS_TELEPHONE.substring(0, 1) +
                                  "-" +
                                  model.PRS_TELEPHONE.substring(1, 10)
                                )  : '-'
                              }}
                            </td>
                            <td v-if="model.PRS_TELEPHONE != null && model.PRS_TELEPHONE.length < 1">-</td>
                          </tr>
                          <tr>
                            <td style="width: 20%"><b>Extension Number</b></td>
                            <td style="width: 2%">:</td>
                            <td>{{ model.PRS_PHONE_EXTENSION ? model.PRS_PHONE_EXTENSION : '-'}}</td>
                          </tr>
                          <tr>
                            <td style="width: 20%"><b>Mobile Phone Number</b></td>
                            <td style="width: 2%">:</td>
                            <td>
                              {{
                                (model.PRS_MOBILE_NUMBER && model.PRS_MOBILE_NUMBER.length > 1) ?
                                (
                                  '01' + model.PRS_MOBILE_NUMBER.substring(0, 1) +
                                  "-" +
                                  model.PRS_MOBILE_NUMBER.substring(1, 11)
                                ) : '-'
                              }}
                            </td>
                            <td v-if="model.PRS_MOBILE_NUMBER != null && model.PRS_MOBILE_NUMBER.length < 1">-</td>
                          </tr>
                          <tr>
                            <td style="width: 20%"><b>Email</b></td>
                            <td style="width: 2%">:</td>
                    ...
                    <table class="table">
                      <tbody>
                        ...
                        <tr>
                          ...
                          <td>
                            {{
                              (model.TRAIN_TELEPHONE && model.TRAIN_TELEPHONE.length > 1) ?
                              (
                                '0' + model.TRAIN_TELEPHONE.substring(0, 1) +
                                "-" +
                                model.TRAIN_TELEPHONE.substring(1, 10)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.TRAIN_TELEPHONE != null && model.TRAIN_TELEPHONE.length < 1"></td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Extension Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>{{ model.TRAIN_PHONE_EXTENSION ? model.TRAIN_PHONE_EXTENSION : '-' }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Mobile Phone Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{
                              (model.TRAIN_MOBILE_NUMBER && model.TRAIN_MOBILE_NUMBER.length > 1) ?
                              (
                                '01' + model.TRAIN_MOBILE_NUMBER.substring(0, 1) +
                                "-" +
                                model.TRAIN_MOBILE_NUMBER.substring(1, 11)
                              ) : '-'
                            }}
                          </td>
                          <td v-if="model.TRAIN_MOBILE_NUMBER != null && model.TRAIN_MOBILE_NUMBER.length < 1"></td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Email</b></td>
                          <td style="width: 2%">:</td>
                  ...
                  <div v-if="tabValue === 6" class="tabcontent">
                    <table class="table">
                      <tbody>
                        <tr>
                          <td style="width: 20%"><b>Issuing Bank</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{ model.IssueBank.SET_PARAM }}
                          </td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Reference Number</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                        ...
                        <tr>
                          <td style="width: 20%"><b>Transaction Date</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                        ...
                        <tr>
                          <td style="width: 20%"><b>Transaction Type</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            {{ model.DIST_TRANS_TYPE.name }}
                          </td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Amount</b></td>
                          <td style="width: 2%">:</td>
                          <td>RM {{ parseInt(model.DIST_ACC_AMOUNT).toLocaleString()  }}</td>
                        </tr>
                        <tr>
                          <td style="width: 20%"><b>Payment Advice</b></td>
                          <td style="width: 2%">:</td>
                          <td>
                            <vue-form-generator
                              :model="model"
                              :schema="previewSchemaReceipt"
                              :options="formOptions"
                              ref="previewSchemaReceipt"
                              @model-updated="onModelUpdated"
                            >
                            </vue-form-generator>
                          </td>
                  ...
                  <div v-if="tabValue === 7" class="tabcontent">
                        ...
                        <template slot="actions" slot-scope="row">
                          <div id="app">
                            ...
                            <VueFileAgent
                              ...
                              :uploadHeaders="{}"
                              :downloadable="false"
                              @get-blob-data="getBlobFile(row.rowData.DOCU_BLOB)"
                              :multiple="false"
                              :deletable="true"
                              :editable="false"
                              :linkable="true"
                  ...
                  <div v-if="tabValue === 8" class="tabcontent">
                    <va-data-table
                      :showPagination="false"
                      :fields="fieldsFile1"
                      :data="additionalList"
                ...
                <va-card>
                  ...
                  >
                    ...
                    <tab-content
                      ...
                      title="1. Create Distributor Profile"
                      :before-change="saveFirstTab"
                    >
                      <br />
                      <vue-form-generator
                        :model="model"
                      ...
                      <div><h4>Registered Address</h4></div>
                      <vue-form-generator
                        :model="model"
                      ...
                      <div><h4>Business Address</h4></div>
                      <vue-form-generator
                        :model="model"
                    ...
                    <tab-content
                      icon="fa fa-navicon"
                      title="2. Details information"
                      :before-change="saveSecondTab"
                    >
                      <br />
                      <vue-form-generator
                        :model="model"
                    ...
                    <tab-content
                      icon="fa fa-user"
                      title="3. CEO and Director"
                      :before-change="saveThirdTab"
                    >
                      <br />
                      <vue-form-generator
                        :model="model"
                    ...
                    <tab-content
                      icon="fa fa-usd"
                      title="6. Payment Detail"
                      :before-change="saveSixthTab"
                    >
                      <br />
                        ...
                        <div class="ml-3 col-md-12">
                          ...
                          <table class="table table-striped">
                            <tbody>
                              ...
                              <tr>
                                <td style="width: 12%">
                                  Total Amount For Application
                                </td>
                                <td>RM {{ parseInt(this.distAmount).toLocaleString()  }}</td>
                                <!-- <td
                                v-if="
                              ...
                              >
                                ...
                                <!-- <td>{{  this.model.TOTAL_AMOUNT_APPLICATION }}</td> -->
                                <!-- <td>
                              <vue-form-generator
                                :model="model"
                                :schema="distTypeFeeTabSchema"
                                :options="formOptions"
                                ref="distTypeFeeTabForm"
                                @model-updated="onModelUpdated"
                              >
                              </vue-form-generator>
                              </td> -->
                    ...
                    <tab-content icon="fa fa-file-pdf-o" title="7. Proposal">
                      <br />
                    ...
                    <tab-content
                      ...
                      title="8. Additional Document Upload"
                    >
                      <va-data-table
                        :showPagination="false"
                        :fields="fieldsFile1"
                    ...
                    >
                      ...
                      <div class="float-right">
                        <button
                          @click="submit(1,activeTabIndex)"
                          v-show="isShowDraft && isSubmitButton"
                          type="button"
                        ...
                        <!-- v-show="isShow" -->
                        <button
                          v-if="isLastStep && isSubmitButton"
                          v-show="isShow"
                          @click="beginSubmit()"
                          type="button"
                          class="ml-2 btn btn-primary btn-fill btn-md"
...
export default {
  ...
  computed: {
    ...
    fields() {
      return [
        ...
        {
          name: "DIR_PASSPORT_EXPIRY_DISPLAY",
  ...
  data() {
    return {
      ...
      options: [
        ...
        { label: "Payment Detail", value: 6 },
        { label: "Proposal", value: 7 },
        { label: "Uploaded Document", value: 8 },
      ],
      tabValue: 1,
      activePage: 4,
      activetab: 1,
  ...
  methods: {
    ...
    getBlobFile: function (fileRecords) {
      ...
      // alert(fileRecords);
      const blob = new Blob([response.data], { type: "xls,xlsx,pdf" });
    ...
    validateFeeAmount(value) {
      ...
      const pendingamount = this.model.TOTAL_AMOUNT_APPLICATION;
    ...
    // get distributor fee
    async getDistFee() {
      const response = await services06Module0.getDistFee(
        this.model.applicationType.DISTRIBUTOR_TYPE_ID,
        this.model.DIST_FINANCIAL_INSTITUTION
      );
      // console.log(JSON.stringify(response));
      var feeAmount = JSON.stringify(response);
      this.distAmount = feeAmount + ".00";
      this.model.TOTAL_AMOUNT_APPLICATION = feeAmount;
    ...
    async getDocumentAdditional() {
      ...
      const response = await services06Module0.getDocumentAdditional(data);
    },
    ...
    async getDocumentProposalUpdate() {
      ...
      //console.log("This is response :", JSON.stringify(response));
          this.proposalList = response.dataProposal;
          console.log('here',JSON.stringify(this.proposalList));
    ...
    async beginSubmit() {
      ...
      console.log("Begin");
      console.log(this.validateFirstTab());
      if (this.validateFirstTab() == true) {
        if (this.validateSecondTab() == true) {
          if (this.validateThirdTab() == true) {
            if (this.validateFourthTab() == true) {
              if (this.validateSixthTab() == true) {
                if (this.validateFifthTab() == true) {
                  this.$modals.showStaticModal.$show();
                  console.log("after show vudal");
                } else {
                  alert("Please recheck your payment detail form.");
                }
              } else {
                alert("Please recheck your additional information form.");
              }
            } else {
              alert("Please recheck your AR and AAR form.");
            }
          } else {
            alert("Please recheck your ceo and directors form.");
          }
        } else {
          alert("Please recheck your details information form.");
        }
      } else {
        alert("Please recheck your distributor profile form.");
      }
    },
    async submitDistributor() {
      ...
      // );
      //console.log(this.validateDeclarationSchema());
      if (this.validateDeclarationSchema() == true) {
        this.submit(2,null);
      } else {
        console.log("Validation Occurred");
      }
    },
    ...
    editDirector(data) {
      ...
      console.log('here1',data.DIR_NRIC);
      if(data.DIR_NRIC){

        this.model.EDIT_DIR_NRIC = data.DIR_NRIC;
        this.model.EDIT_DIR_CITIZEN = 1; //data.DIR_CITIZEN;
        this.visiblePassportEditDIR = false;
        this.visibleIcEditDIR = true;


      }else{
        this.model.EDIT_DIR_CITIZEN = 2; //data.DIR_CITIZENSHIP;
        this.visiblePassportEditDIR = true;
        this.visibleIcEditDIR = false;
        this.model.EDIT_DIR_PASSPORT = data.DIR_PASSPORT;
        this.model.EDIT_DIR_PASSPORT_EXPIRY = data.DIR_PASSPORT_EXPIRY;
      }

      //this.model.EDIT_DIR_NRIC = data.DIR_NRIC;
      this.model.EDIT_DIR_DATE_EFFECTIVE = data.DIR_DATE_EFFECTIVE;
    ...
    updateDirector() {
      ...
      const arrayData =  this.directorList;
      const objIndex = arrayData.findIndex((obj => obj.DIST_DIR_ID == this.model.DIST_DIR_ID));
      //Log object to Console.
      //console.log("Before update: ", arrayData)
      //Update object's name property

      arrayData[objIndex].DIR_SALUTATION = this.model.EDIT_DIR_SALUTATION.USER_SAL_ID;
      arrayData[objIndex].DIR_NAME = this.model.EDIT_DIR_NAME;
      arrayData[objIndex].DIR_NAME_DISPLAY = this.model.EDIT_DIR_SALUTATION.USER_SAL_NAME + ' '  + this.model.EDIT_DIR_NAME
      if(this.model.EDIT_DIR_CITIZEN == 1){
        arrayData[objIndex].DIR_NRIC = this.model.EDIT_DIR_NRIC;
        arrayData[objIndex].DIR_PASSPORT = '';
        arrayData[objIndex].DIR_PASSPORT_EXPIRY = '';
        arrayData[objIndex].DIR_PASSPORT_EXPIRY_DISPLAY = '';
        arrayData[objIndex].DIR_PASS_NUM = '';
      }else{
        arrayData[objIndex].DIR_PASSPORT = this.model.EDIT_DIR_PASSPORT;
        arrayData[objIndex].DIR_PASSPORT_EXPIRY = this.model.EDIT_DIR_PASSPORT_EXPIRY;
        arrayData[objIndex].DIR_PASSPORT_EXPIRY_DISPLAY = (this.model.EDIT_DIR_PASSPORT_EXPIRY) ?
          moment(this.model.EDIT_DIR_PASSPORT_EXPIRY).format("DD-MMM-YYYY") : '';
        arrayData[objIndex].DIR_NRIC = '';
        arrayData[objIndex].DIR_PASS_NUM = this.model.EDIT_DIR_PASSPORT;
      }
      arrayData[objIndex].DIR_DATE_EFFECTIVE = this.model.EDIT_DIR_DATE_EFFECTIVE;
      arrayData[objIndex].DIR_DATE_EFFECTIVE_DISPLAY = (this.model.EDIT_DIR_DATE_EFFECTIVE) ?
          moment(this.model.EDIT_DIR_DATE_EFFECTIVE).format("DD-MMM-YYYY") : '';
      arrayData[objIndex].DIR_DATE_END = this.model.EDIT_DIR_DATE_END;
      arrayData[objIndex].DIR_DATE_END_DISPLAY = (this.model.EDIT_DIR_DATE_END) ?
          moment(this.model.EDIT_DIR_DATE_END).format("DD-MMM-YYYY") : '';
      this.directorList = arrayData;

      //console.log("After update: ",this.directorList)
    },
    ...
    async getDistributorById() {
      ...
      if (response == null) {
        ...
        if (response.DIST_PUBLISH_STATUS > 0) {
        ...
        (response.DIST_ADDR_SAME == 1) ? this.model.ADDRESS_isBIZADDRESS = true : this.model.ADDRESS_isBIZADDRESS = false;
        ...
        if (this.model.DIST_COUNTRY.SET_CODE == "MY") {
          if (response.SET_PARAM_STATE != null) {
            ...
            this.getCity(response.DIST_STATE);
          }
          if (response.SET_CITY_NAME != null) {
            ...
            this.getPostcode(response.DIST_CITY);
          }
          if (response.POSTCODE_NO != null) {
            this.model.DIST_POSTAL = {
              POSTCODE: response.POSTCODE_NO,
              POSTCODE_ID: response.SETTING_POSTCODE_ID,
              SETTING_POSTCODE_ID: response.SETTING_POSTCODE_ID,
              POSTCODE_ID: response.DIST_POSTAL,
            };
          }
        } else {
        ...
        this.model.DIST_BIZ_COUNTRY = {
          SETTING_GENERAL_ID: response.BIZ_COUNTRY_ID,
          SET_CODE: response.BIZ_SET_CODE_COUNTRY,
          SET_PARAM: response.BIZ_SET_PARAM_COUNTRY,
        };
        if (this.model.DIST_BIZ_COUNTRY.SET_CODE == "MY") {

          // Get State for BIZ
          const data = {SETTING_GENERAL_ID: response.DIST_BIZ_STATE, SET_TYPE: "STATE"};
          const response_state = await services06Module0.getStateById(data);
          if (response.SET_PARAM_STATE != null) {
            this.model.DIST_BIZ_STATE = {
              SETTING_GENERAL_ID: response_state.SETTING_GENERAL_ID,
              SET_PARAM: response_state.SET_PARAM,
            };
            this.getCity(response.DIST_BIZ_STATE);
          }

            const response_city = await services06Module0.getCity(response.DIST_BIZ_STATE);
            response_city.forEach((element) => {
              if(element.SETTING_CITY_ID == response.DIST_BIZ_CITY){
                this.model.DIST_BIZ_CITY = {
                  SETTING_CITY_ID: element.SETTING_CITY_ID,
                  SET_CITY_NAME: element.SET_CITY_NAME,
                  SET_PARAM: element.SET_PARAM,
                };
              }
            });


            this.getPostcode(response.DIST_BIZ_CITY);

          //if (response.POSTCODE_NO != null) {
            const response_postal = await services06Module0.getPostcodeByID(response.DIST_BIZ_CITY);
            //console.log('tesssseeeeseeee',response_postal);
            response_postal.forEach((element) => {
              if(element.SETTING_POSTCODE_ID == response.DIST_BIZ_POSTAL){
                this.model.DIST_BIZ_POSTAL = {
                  POSTCODE: element.POSTCODE,
                  POSTCODE_ID: element.POSTCODE_ID,
                  SETTING_POSTCODE_ID: element.SETTING_POSTCODE_ID,
                  POSTCODE_NO: element.POSTCODE,
                };
              }
            });
        ...
        //this.model.FINANCIAL_PLANNER_SALUTATION.USER_SAL_NAME = response.DIST_FP_SALUTATION ?? '';
        if(response.DATAFP){
          this.model.FINANCIAL_PLANNER_SALUTATION = {
              USER_SAL_ID: response.DATAFP.USER_SAL_ID ?? '',
              USER_SAL_NAME: response.DATAFP.USER_SAL_NAME ?? '',
            };
        }

        this.model.FINANCIAL_PLANNER_NAME = response.DIST_FP_NAME ?? '';
        this.model.CSMRL_NUMBER = response.DIST_FP_CSMRL ?? '';
        this.model.FINANCIAL_PLANNER_CITIZEN = response.DIST_FP_CITIZEN ?? '';
        this.model.FINANCIAL_PLANNER_NRIC = response.DIST_FP_NRIC ?? '';
        this.model.FINANCIAL_PLANNER_PASS_NUM = response.DIST_FP_PASS_NUM ?? '';
        this.model.FINANCIAL_PLANNER_PASS_EXP =  (response.DIST_FP_PASS_EXPIRY)
         ? moment(response.DIST_FP_PASS_EXPIRY).format("DD-MM-YYYY") : '' ;
        ...
        this.model.DIST_EXPIRED_DATE =  (response.DIST_EXPIRED_DATE != "0000-00-00")
         ? moment(response.DIST_EXPIRED_DATE).format("DD-MM-YYYY") : '-' ;
        ...
        this.directorList.forEach((el) => {
          el.DIR_PASSPORT = el.DIR_PASS_NUM,
          el.DIR_PASSPORT_EXPIRY = el.DIR_PASS_EXPIRY,
          el.DIR_PASSPORT_EXPIRY_DISPLAY = (el.DIR_PASS_EXPIRY != '0000-00-00') ?
          moment(el.DIR_PASS_EXPIRY).format("DD-MMM-YYYY") : '';

          el.DIR_DATE_EFFECTIVE_DISPLAY = (el.DIR_DATE_EFFECTIVE != '0000-00-00') ?
            moment(el.DIR_DATE_EFFECTIVE).format("DD-MMM-YYYY") : '';

          el.DIR_DATE_END_DISPLAY = (el.DIR_DATE_END != '0000-00-00') ?
            moment(el.DIR_DATE_END).format("DD-MMM-YYYY") : '';
        });
        ...
        response.DATADOC.forEach((element) => {
          ...
          } else if (element.DOCU_GROUP == 15) {
            this.model.DIST_INSURANCE_POLICY = [];
            this.ssmForm24 = element.DOCU_BLOB;
            this.model.DIST_INSURANCE_POLICY.push(data);
          }
          this.changeByDistType(this.model.applicationType.DISTRIBUTOR_TYPE_ID);
        });
      }
      //this.isDataReady = true; // Kill Page Loader
      this.isLoad = false;  // Kill Page Loader
    },

    // Data Change By Distributor Type=======
    changeByDistType(type){
          if (type === 1) {
            //UTMC
    ...
    async getDefaultCountry() {
      try {
        ...
        this.model.DIST_BIZ_COUNTRY = response;
      } catch (error) {
        //console.log(error);
      }
    },
    // Data Submit ==============================
    async submit(status,tab){
      const vm = this;
      const user = localStorage.getItem("user");
      ...
      data.append("tab_index", tab);
      doc_data.append("tab_index", tab);
      ...
      this.model.DIST_DATE_INCORP != null
        ? data.append(
            "DIST_DATE_INCORP",
            moment(this.model.DIST_DATE_INCORP).format("YYYY-MM-DD")
          )
        : null;
      data.append("DIST_TYPE_SETUP", this.model.DIST_TYPE_SETUP ?? "");
      data.append(
        "DIST_PHONE_NUMBER",
        this.model.DIST_PHONE_NUMBER != null
          ? this.model.DIST_PHONE_NUMBER
          : ""
      );
      data.append(
      ...
      data.append("DIST_ADDR_SAME", this.model.ADDRESS_isBIZADDRESS);
      ...
      if (this.model.uploadCSMRL != null) {
        data.append("uploadCMSLOnly", this.model.uploadCSMRL);
      } else if (this.model.uploadCSMRLorMOFLicense != null) {
        data.append(
          "uploadCMSLorMOFLicense",
          this.model.uploadCSMRLorMOFLicense
        );
      }
      ...
      this.model.DIST_EXPIRED_DATE != null
        ? data.append(
            "DIST_EXPIRED_DATE",
            moment(this.model.DIST_EXPIRED_DATE).format("YYYY-MM-DD")
          )
        : null;
      ...
      this.model.CEO_REPR_PASS_EXP != null
        ? data.append(
            "CEO_REPR_PASS_EXP",
            moment(this.model.CEO_REPR_PASS_EXP).format("YYYY-MM-DD")
          )
        : null;
      data.append("CEO_REPR_CITIZEN", this.model.CEO_REPR_CITIZEN ?? "");
      data.append(
        "CEO_REPR_TELEPHONE",
        this.model.CEO_REPR_TELEPHONE ?? ""
      );
      data.append(
        "CEO_REPR_PHONE_EXTENSION",
      ...
      data.append("CEO_isRepresentative", this.model.CEO_isRepresentative);
      ...
      this.model.AR_REPR_SALUTATION != ""
        ? data.append(
            "AR_REPR_SALUTATION",
            this.model.AR_REPR_SALUTATION.USER_SAL_ID
          )
        : null;
      ...
      this.model.AR_REPR_PASS_EXP != null
        ? data.append(
            "AR_REPR_PASS_EXP",
            moment(this.model.AR_REPR_PASS_EXP).format("YYYY-MM-DD")
          )
        : null;
      ...
      this.model.AAR_REPR_SALUTATION != ""
        ? data.append(
            "AAR_REPR_SALUTATION",
            this.model.AAR_REPR_SALUTATION.USER_SAL_ID
          )
        : null;
      ...
      this.model.AAR_REPR_PASS_EXP != null
        ? data.append(
            "AAR_REPR_PASS_EXP",
            moment(this.model.AAR_REPR_PASS_EXP).format("YYYY-MM-DD")
          )
        : null;
      ...
      //===== Financial Planner==== */
      if (this.model.applicationType.DISTRIBUTOR_TYPE_ID == 4 ||
      this.model.applicationType.DISTRIBUTOR_TYPE_ID == 5) {
        data.append(
          "DIST_FINANCIAL_INSTITUTION",
          this.model.DIST_FINANCIAL_INSTITUTION ?? ""
      ...
      this.model.COMPL_SALUTATION != ""
        ? data.append(
            "COMPL_SALUTATION",
            this.model.COMPL_SALUTATION.USER_SAL_ID
          )
        : null;
      ...
      this.model.UTS_SALUTATION != ""
        ? data.append("UTS_SALUTATION", this.model.UTS_SALUTATION.USER_SAL_ID)
        : null;
      ...
      this.model.PRS_SALUTATION != ""
        ? data.append("PRS_SALUTATION", this.model.PRS_SALUTATION.USER_SAL_ID)
        : null;
      ...
      this.model.TRAIN_SALUTATION != ""
        ? data.append(
            "TRAIN_SALUTATION",
            this.model.TRAIN_SALUTATION.USER_SAL_ID
          )
        : null;
      ...
      data.append(
        "DIST_ISSUE_BANK",
        this.model.IssueBank.SETTING_GENERAL_ID ?? ""
      );
      data.append("DIST_TRANS_REF", this.model.DIST_TRANS_REF ?? "");
      this.model.DIST_TRANS_DATE != null
        ? data.append(
            "DIST_TRANS_DATE",
            moment(this.model.DIST_TRANS_DATE).format("YYYY-MM-DD")
          )
        : null;
      data.append("DIST_TRANS_TYPE", this.model.DIST_TRANS_TYPE.value ?? "");
      // this.model.DIST_ACC_AMOUNT = this.model.DIST_ACC_AMOUNT.replace(
      //   /RM/gi,
      //   ""
      // );
      // this.model.DIST_ACC_AMOUNT = this.model.DIST_ACC_AMOUNT.replace(
      ...
      //   ""
      // );
      if(this.model.DIST_ACC_AMOUNT){
        this.model.DIST_ACC_AMOUNT = this.model.DIST_ACC_AMOUNT.replace(
          /\s/gi,
          ""
        );
      }
      data.append("DIST_ACC_AMOUNT", this.model.DIST_ACC_AMOUNT ?? "");
      //data.append("DIST_PUBLISH_STATUS", status);
      //data.append("DIST_PUBLISH_STATUS", 0);
      // "NEW DISTIBUTOR - A(1)(a)"

      // If Final Submit Data
      if (status == 2) {
        const approvalLevel = await services06Module0.getApprovalLevel(1, 1);
      ...
      //Section3 upload doc */==========================
          doc_data.append("ssmForm49", this.model.ssmForm49);
          doc_data.append(
            "complianceDeclaration",
            this.model.complianceDeclaration
          );
          doc_data.append("ssmForm24", this.model.ssmForm24);
          if (this.model.uploadCSMRL != null) {
            doc_data.append("uploadCMSLOnly", this.model.uploadCSMRL);
          } else if (this.model.uploadCSMRLorMOFLicense != null) {
            doc_data.append(
              "uploadCMSLorMOFLicense",
              this.model.uploadCSMRLorMOFLicense
          ...
          doc_data.append("companyLogo", this.model.companyLogo);
          doc_data.append("ssmForm8", this.model.ssmForm8);
          doc_data.append("ssmForm9", this.model.ssmForm9);
          doc_data.append("ssmForm13", this.model.ssmForm13);
          doc_data.append("BODApprove", this.model.BODApprove);
          doc_data.append("receipt", this.model.receipt);
      //End ==================================================

      try {
        if (status == 1 || status == 2) {
          vm.showOverlay(true);
          const response = await services06Module1.updateDistributorRegProfile(data);

          doc_data.append("DISTRIBUTOR_ID", JSON.parse(user).USER_DIST_ID);
          //const uploadDocs = await services06Module1.distributor_docs(doc_data);

          // Show massage----
          if(tab != 'next'){
            (status == 1) ?
            this.$modals.showStaticModalSaveAsDraft.$show() :
            this.$modals.showStaticModalSubmitted.$show();

          }
          this.getDistributorById();
          this.isShow = true;
          this.isLoad = false; // Kill Loader
        } else {
          console.log(this.updateDistributor);
          if (this.updateDistributor == false) {
            // experian bankruptcy check

            vm.showOverlay(true);
            try {
              // Ceo
              // if (this.model.CEO_REPR_NAME == null) {
              //   const ceo_search = await servicesModule0.bankruptcyCheck(
              //     "I",
              //     this.model.CEO_REPR_NAME,
              //     this.model.CEO_REPR_NRIC,
              //     this.model.CEO_REPR_MOBILE_NUMBER,
              //     this.model.CEO_REPR_EMAIL,
              //     "",
              //     ""
              //   );
              // }
              // Director
              // if (this.model.CEO_REPR_NAME == null) {
              //   const director_search = await servicesModule0.bankruptcyCheck(
              //     'I',
              //     this.model.CEO_REPR_NAME,
              //     this.model.CEO_REPR_NRIC,
              //     this.model.CEO_REPR_MOBILE_NUMBER,
              ...
              //  AR
              // if (this.model.CEO_REPR_NAME == null) {
              //   const ar_search = await servicesModule0.bankruptcyCheck(
              //     "I",
              ...
              // AAR
              // if (this.model.CEO_REPR_NAME == null) {
              //   const aar_search = await servicesModule0.bankruptcyCheck(
              //     "I",
              //     this.model.AAR_REPR_NAME,
              //     this.model.AAR_REPR_NRIC,
              //     this.model.AAR_REPR_MOBILE_NUMBER,
              //     this.model.AAR_REPR_EMAIL,
              //     "",
              //     ""
              //   );
              // }
              //const response = await services06Module1.createDistributorProfile(data);
              doc_data.append("DISTRIBUTOR_ID", JSON.stringify(response.data));
              const uploadDocs = await services06Module1.distributor_docs(
                doc_data
              );
            ...
            // const response =
            //   await services06Module1.updateDistributorRegProfile(data);
    ...
    addDirector() {
      if (this.$refs.thirdTabFormDIR.validate()) {
        ...
        //console.log('date_Check', this.model.DIR_DATE_END);
        var directorInfo = {
          DIST_DIR_ID: "",
          ...
          DIR_NRIC: (this.model.DIR_NRIC) ?
           ( this.model.DIR_NRIC) : '', // this.model.DIR_icNo,
          ...
          DIR_PASSPORT_EXPIRY: moment(this.model.DIR_PASSPORT_EXPIRY).format("YYYY-MM-DD"),

         DIR_PASSPORT_EXPIRY_DISPLAY: (this.model.DIR_PASSPORT_EXPIRY) ?
          moment(
            this.model.DIR_PASSPORT_EXPIRY
          ).format("DD-MMM-YYYY") : '',

          DIR_DATE_END: dirdateend,
          DIR_DATE_EFFECTIVE_DISPLAY: (this.model.DIR_DATE_EFFECTIVE) ?
          moment(
            this.model.DIR_DATE_EFFECTIVE
          ).format("DD-MMM-YYYY") : '',
          DIR_DATE_END_DISPLAY:  (this.model.DIR_DATE_END) ?
          moment(
    ...
    onModelUpdated(newVal, schema) {
      if(schema == 'AI_term1' || schema == 'AI_term2' || schema == 'AI_term3'){
        if(this.model.AI_term1 == true && this.model.AI_term2 == true && this.model.AI_term3 == true){
          this.model.agree_btn = false;
        }else{
          this.model.agree_btn = true;
        }
        //alert(this.model.agree_btn);
      }
      //console.log("modell : ");
      if(schema === "DIST_FINANCIAL_INSTITUTION"){
        //alert(newVal);
        this.getDistFee();
      }
      //console.log(newVal);
      if (schema === "AR_citizenship") {
        ...
        // Data Chage By Distributor Type
        this.changeByDistType(this.model.applicationType.DISTRIBUTOR_TYPE_ID);
      ...
      } else if (schema == "AR_REPR_NAME") {
        this.model.AR_REPR_NAME = String(newVal).toUpperCase();
      ...
      } else if (schema == "DIST_BIZ_ADDR_1") {
        this.model.DIST_BIZ_ADDR_1 = String(newVal).toUpperCase();
      } else if (schema == "DIST_BIZ_ADDR_2") {
        this.model.DIST_BIZ_ADDR_2 = String(newVal).toUpperCase();
      } else if (schema == "DIST_BIZ_ADDR_3") {
        this.model.DIST_BIZ_ADDR_3 = String(newVal).toUpperCase();
    ...
    validateFirstTab() {
      if (this.$refs.firstTabForm.validate() == true) {
        if (this.$refs.firstTabForm1.validate() == true) {
          if (this.$refs.firstTabForm2.validate() == true) {
            if (this.$refs.firstTabForm3.validate() == true) {
              return true;
            } else {
              return false;
            }
    ...
    saveFirstTab: function () {
      //alert('check');
      this.isLoad = true;
      const user = localStorage.getItem("user");
      const data1 = new FormData();
      data1.append("Form", 1);
      data1.append("companyLogo", this.model.companyLogo);
      data1.append("ssmForm8", this.model.ssmForm8);
      data1.append("ssmForm9", this.model.ssmForm9);
      data1.append("ssmForm13", this.model.ssmForm13);
      data1.append("USER_ID", JSON.parse(user).user_id);
      data1.append("DIST_NAME", this.model.DIST_NAME ?? "");
      data1.append("DIST_REGI_NUM1", this.model.DIST_REGI_NUM1 ?? "");
      data1.append("DIST_REGI_NUM2", this.model.DIST_REGI_NUM2 ?? "");
      this.model.DIST_DATE_INCORP != null
        ? data1.append(
            "DIST_DATE_INCORP",
            moment(this.model.DIST_DATE_INCORP).format("YYYY-MM-DD")
        ...
        : null;
      data1.append("DIST_TYPE_SETUP", this.model.DIST_TYPE_SETUP ?? "");
      data1.append(
        "DIST_PHONE_NUMBER",
      ...
      data1.append("DIST_FAX_NUMBER", this.model.DIST_FAX_NUMBER ?? "");
      data1.append("DIST_MOBILE_NUMBER", this.model.DIST_MOBILE_NUMBER ?? "");
      data1.append("DIST_EMAIL", this.model.DIST_EMAIL ?? "");
      data1.append(
        "DIST_COMPANY_WEBSITE",
        this.model.DIST_COMPANY_WEBSITE ?? ""
      );
    ...
    //   ? this.model.DIST_STATE.SET_PARAM != undefined
    //     ? data1.append("DIST_STATE", this.model.DIST_STATE.SETTING_GENERAL_ID)
    //     : null
    //   : data1.append("DIST_STATE", this.model.DIST_STATE ?? "");
    // this.model.DIST_COUNTRY.SET_CODE == "MY"
    //   ? this.model.DIST_CITY.SET_CITY_NAME != undefined
    //     ? data1.append("DIST_CITY", this.model.DIST_CITY.SETTING_CITY_ID)
    //     : null
    //   : data1.append("DIST_CITY", this.model.DIST_CITY ?? "");
    // this.model.DIST_COUNTRY.SET_CODE == "MY"
    //   ? this.model.DIST_POSTAL.POSTCODE != undefined
    //     ? data1.append("DIST_POSTAL", this.model.DIST_POSTAL.POSTCODE_ID)
    //     : null
    //   : data1.append("DIST_POSTAL", this.model.DIST_POSTAL ?? "");
      data1.append("DIST_COUNTRY", this.model.DIST_COUNTRY ? this.model.DIST_COUNTRY.SETTING_GENERAL_ID : "");
      data1.append("COUNTRY_CODE", this.model.DIST_COUNTRY ? this.model.DIST_COUNTRY.SET_CODE : "");
      data1.append("COUNTRY_CODE", this.model.DIST_COUNTRY.SET_CODE);
      if(this.model.DIST_COUNTRY && this.model.DIST_COUNTRY.SET_CODE){
        if(this.model.DIST_COUNTRY.SET_CODE == "MY"){
          data1.append("DIST_STATE", this.model.DIST_STATE ? this.model.DIST_STATE.SETTING_GENERAL_ID : "")
          data1.append("DIST_CITY", this.model.DIST_CITY ? this.model.DIST_CITY.SETTING_CITY_ID : "")
          data1.append("DIST_POSTAL", this.model.DIST_POSTAL ? this.model.DIST_POSTAL.POSTCODE_ID : "")
        }else{
          data1.append("DIST_STATE", this.model.DIST_STATE ? this.model.DIST_STATE.SETTING_GENERAL_ID : "")
          data1.append("DIST_CITY", this.model.DIST_CITY ? this.model.DIST_CITY.SETTING_CITY_ID : "")
          data1.append("DIST_POSTAL", this.model.DIST_POSTAL ? this.model.DIST_POSTAL.POSTCODE_ID : "")
      ...
      data1.append("DIST_ADDR_1", this.model.DIST_ADDR_1 ?? "");
      data1.append("DIST_ADDR_2", this.model.DIST_ADDR_2 ?? "");
      data1.append("DIST_ADDR_3", this.model.DIST_ADDR_3 ?? "");
     ...
     data1.append(
      ...
      data1.append("BIZ_COUNTRY_CODE", this.model.DIST_BIZ_COUNTRY ? this.model.DIST_BIZ_COUNTRY.SET_CODE : "");
      if(this.model.DIST_BIZ_COUNTRY && this.model.DIST_BIZ_COUNTRY.SET_CODE){
        if(this.model.DIST_BIZ_COUNTRY.SET_CODE == "MY"){
          data1.append("DIST_BIZ_STATE", this.model.DIST_BIZ_STATE ? this.model.DIST_BIZ_STATE.SETTING_GENERAL_ID : "")
          data1.append("DIST_BIZ_CITY", this.model.DIST_BIZ_CITY ? this.model.DIST_BIZ_CITY.SETTING_CITY_ID : "")
          data1.append("DIST_BIZ_POSTAL", this.model.DIST_BIZ_POSTAL? this.model.DIST_BIZ_POSTAL.POSTCODE_ID : "")
        }else{
          data1.append("DIST_BIZ_STATE", this.model.DIST_BIZ_STATE ? this.model.DIST_BIZ_STATE.SETTING_GENERAL_ID : "")
          data1.append("DIST_BIZ_CITY", this.model.DIST_BIZ_CITY ? this.model.DIST_BIZ_CITY.SETTING_CITY_ID : "")
          data1.append("DIST_BIZ_POSTAL", this.model.DIST_BIZ_POSTAL? this.model.DIST_BIZ_POSTAL.POSTCODE_ID : "")
      ...
      data1.append("DIST_BIZ_ADDR_1", this.model.DIST_BIZ_ADDR_1 ?? "");
      data1.append("DIST_BIZ_ADDR_2", this.model.DIST_BIZ_ADDR_2 ?? "");
      data1.append("DIST_BIZ_ADDR_3", this.model.DIST_BIZ_ADDR_3 ?? "");
      ...
      if (this.model.uploadCSMRL != null) {
        data1.append("uploadCMSLOnly", this.model.uploadCSMRL);
      } else if (this.model.uploadCSMRLorMOFLicense != null) {
        data1.append(
          "uploadCMSLorMOFLicense",
          this.model.uploadCSMRLorMOFLicense
      ...
      data1.append("DIST_PUBLISH_STATUS", 1);
      try {
        // const response = services06Module1.saveDraftReg(data);
        //console.log("save", data1);
      } catch (error) {
        console.log(error);
      }

      setTimeout(() => (this.isLoad = false), 3000);

      return true;
      // alert ("this save demo is functional");
    },
    saveSecondTab: function () {
      this.isLoad = true;
      const user = localStorage.getItem("user");
    ...
    validateSecondTab: function () {
      return this.$refs.detailInfoForm.validate();
    },
    validateThirdTab: function () {
      this.$refs.thirdTabFormCEO.validate();
      // if (this.$refs.thirdTabFormDIR.validate()) {
      ...
      //   }
      // }
      // this.$refs.thirdTabFormUpload.validate();
    ...
    validateFourthTab() {
      return this.$refs.ARForm.validate();
    },
    validateFifthTab() {
      return this.$refs.fifthTabForm.validate();
    },
    validateSixthTab() {
      if (this.$refs.AIForm1.validate() == true) {
        if (this.$refs.AIForm2.validate() == true) {
          if (this.$refs.AIForm2.validate() == true) {
            if (this.$refs.AIForm4.validate() == true) {
              return true;
            } else {
              return false;
            }
