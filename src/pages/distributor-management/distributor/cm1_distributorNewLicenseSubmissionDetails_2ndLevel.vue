              ...
              <table class="table table-striped">
                <tbody>
                  ...
                  <tr>
                    ...
                    <td
                      v-if="
                        this.distributorDetail.DIST_MOBILE_NUMBER.length > 1
                      "
                    >
                      0{{
                        this.distributorDetail.DIST_MOBILE_NUMBER.substring(
                          0,
                          2
                        )
                      }}-{{
                    ...
                    <!-- <td v-if="this.distributorDetail.DIST_MOBILE_NUMBER.length < 1"> -->
                    <td></td>
                  </tr>
                  <tr>
                    <td>Email Address</td>
                  ...
                  <tr>
                    ...
                    <td>:</td>
                    <td>{{ this.distributorDetail.DIST_COMPANY_WEBSITE }}</td>
                  </tr>
                  <tr>
                    ...
                    <div v-if="item.REPR_TYPE == 'CEO'">
                      ...
                      <tr>
                        ...
                        <td v-if="item.REPR_MOBILE_NUMBER != null">
                          0{{ item.REPR_MOBILE_NUMBER.substring(0, 2) }}-{{
                            item.REPR_MOBILE_NUMBER.substring(2, 10)
                          }}
                        </td>
              ...
              <table class="table table-striped">
                <tbody>
                  <tr>
                    ...
                    <td style="width:1%">:</td>
                    <td>{{ this.distributorDetail.DIST_ISSUEBANK }}</td>
                  </tr>
                  <tr>
