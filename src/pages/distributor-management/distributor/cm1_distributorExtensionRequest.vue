            ...
            <form @submit.prevent="onsubmit" enctype="multipart/form-data">
              ...
              <div class="mt-5">
                ...
                <div class="float-right">
                  ...
                  <b-button type="submit" class="btn btn-success btn-fill btn-md" @click="model.submissionStatus = 'Pending'">
...
import * as servicesModule0 from "../../../app/module0/services06";
  ...
  methods: {
    ...
    onsubmit: async function() {
      ...
      let data = {
        ...
        OTHER_EXTENSION_TYPE: this.model.otherExtensionType !== null ? this.model.otherExtensionType.toUpperCase() : null,
        JUSTIFICATION: this.model.justification.toUpperCase(),
        ...
        EXTENSION_STATUS_ID: this.model.submissionStatus,
        CREATED_BY: JSON.parse(localStorage.getItem('user')).user_id
      };
      let toastMessage = 'Sucessfully';

      if(data.EXTENSION_STATUS_ID === 'Pending') {
        if(!confirm('Are you sure you want to submit this form?')) {
          pass = false;
        }
          toastMessage = `${toastMessage} submit extension request`;
      }else if(data.EXTENSION_STATUS_ID === 'Draft') {
