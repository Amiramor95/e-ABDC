    ...
    <va-card class="mt-3">
      <div class="row">
        ...
        <template v-if="returned">
          <hr />
          Comment from General Manager of Department
          <vue-form-generator
          ...
          ></vue-form-generator>
          <div class="col-md-12 mb-3">
            <label for="" v-if="gmApprovalModel.file.length > 0">Upload Document</label>
            <VueFileAgent
              theme="list"
              :readonly="true"
              :deletable="false"
...
export default {
  ...
  methods: {
    ...
    onApprove: async function () {
      ...
      if(data.STATUS == "Returned to creator") {
        ...
        if(!confirm('Are you sure you want to save this form as draft?')) {
          ...
          toastMessage = `${toastMessage} save Extension Request Entry as draft.`;
      }
    ...
    getById: async function () {
      ...
      if(response.hasOwnProperty('GM_APPROVAL')) {
        this.returned = true;
