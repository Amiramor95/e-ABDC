...
export default {
  ...
  methods: {
    ...
    onApprove: async function () {
      ...
      if(model.submissionStatus === "Rejected") {
    ...
    getById: async function () {
      ...
      this.ceoApprovalModel.justification = response.CEO_APPROVAL.APPROVAL_REMARK;
      ...
      this.fileParser(response.CEO_APPROVAL.DOCUMENTS, this.ceoApprovalModel);
    ...
    onBeforeDelete(fileRecord) {
      ...
      if (i !== -1) {
        ...
        this.ceoApprovalModel.file = this.uploadFileOject;
      } else {
