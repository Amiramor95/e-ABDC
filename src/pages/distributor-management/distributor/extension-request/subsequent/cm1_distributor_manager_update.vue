      ...
      >
        <section slot="pdf-content">
          <section class="pdf-item">
            ...
            <b-collapse id="collapse-1" v-model="collapse" class="mt-3">
              <div class="row">
                <div class="col-md-6">
                  <vue-form-generator
                    :model="model"
  ...
  methods: {
    ...
    onApprove: async function () {
      ...
      if (pass === true) {
        ...
        let res = await servicesModule1.submitSubsequentExtensionRequestApproval(
          form
        );
    ...
    getById: async function () {
      ...
      this.fileParser(
        response.MANAGER_APPROVAL.DOCUMENTS,
        this.managerApprovalModel
      );

      if(response.RD_APPROVAL !== null) {
        this.returned = true;
        this.rdApprovalModel.justification =
          response.RD_APPROVAL.APPROVAL_REMARK;

        this.fileParser(
          response.RD_APPROVAL.DOCUMENTS,
          this.rdApprovalModel
        );
      }
