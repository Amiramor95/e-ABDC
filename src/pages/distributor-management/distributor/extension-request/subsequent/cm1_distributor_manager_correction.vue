  ...
  <va-card>
    ...
    <div class="m-3">
      <va-card>
        <div class="row">
          ...
          <div class="col float-right">
            <div class="float-right">
              <h5>
                <b-badge v-b-toggle.collapse-1 class="mt-3">
                  <i class="fa fa-eye"></i>
                </b-badge>
              </h5>
            </div>
        ...
        <b-collapse id="collapse-1" v-model="collapse1">
          <div class="row">
            <div class="col-md-6">
              <vue-form-generator
                :model="model"
    ...
    <div class="m-3">
      <div class="row">
        <h4 slot="header" class="card-title">Subsequent Time Extension Request</h4>
        <div class="col float-right">
          <div class="float-right">
            <h5>
      ...
      <b-collapse id="collapse-2" v-model="collapse2">
        <div class="col-md-6">
          <!-- <vue-form-generator
...
export default {
  ...
  methods: {
    moment,
    download() {
      if (this.collapse1 === false) {
        this.collapse1 = true;
      }

      if (this.collapse2 === false) {
        this.collapse2 = true;
      }
    ...
    onApprove: async function () {
      ...
      if(model.submissionStatus === "Returned to creator") {
        ...
        if(!confirm('Are youo sure you want to accept this entry')) {
          pass = false;
        }
      ...
      if(pass === true) {
        ...
        let data = {
          ...
          IS_FIMM: this.user.user_type !== 'DISTRIBUTOR' ? true : false,
    ...
    getById: async function () {
      let response = await servicesModule1.getSubsequentCorrectionById(
