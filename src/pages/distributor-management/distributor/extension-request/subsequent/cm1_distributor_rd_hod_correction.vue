  ...
  <va-card>
    <va-card>
      ...
      <b-collapse id="collapse-1">
        ...
        Registration Department Recommendation
          <vue-form-generator
            ...
            <div class="float-right">
              <div class="float-right">
                <button
                  ...
                  @click="rdHodApprovalModel.submissionStatus = 'Draft'"
                >
                ...
                <button
                  ...
                  @click="
                    rdHodApprovalModel.submissionStatus =
                      'Returned to creator'
                  "
                >
                ...
                <button
                  ...
                  @click="
                    rdHodApprovalModel.submissionStatus = 'Approved'
                  "
                >
...
export default {
  ...
  methods: {
    ...
    onApprove: async function () {
      ...
      let model = this.rdHodApprovalModel;
      let pass = true;
      ...
      if(pass === true) {
        ...
        this.$router.push({name: 'fimm-subsequent-extension-request'});
      }
    },
    ...
    onBeforeDelete(fileRecord) {
      ...
      if (i !== -1) {
        ...
        this.rdHodApprovalModel.file = this.uploadFileOject;
      } else {
