      ...
      <div class="row">
        <h4 slot="header" class="card-title">Time Extension Request</h4>
          ...
          <div class="float-right">
            <h5>
              <b-badge v-b-toggle.collapse-1 class="badge badge-primary">
                <i class="fa fa-eye"></i>
              </b-badge>
            </h5>
          </div>
  ...
  methods: {
    ...
    onsubmit: async function() {
      ...
      let data = {
        ...
        EXTENSION_END_DATE: this.subsequentModel.extensionDate.toISOString(),
      ...
      if(pass === true) {
        ...
        this.$router.push({name: 'subsequent-extension-request'});
