          ...
          <div class="float-right">
            <div class="float-right">
              <template v-if="!user.hasOwnProperty('user_type')">
                <a class="btn btn-info btn-fill btn-md mr-2" @click="download">
              ...
              <button
                ...
                @click="
                  managerApprovalModel.submissionStatus = 'Returned to creator'
                "
              >
              ...
              <button
                ...
                @click="
                  managerApprovalModel.submissionStatus = 'Rejected'
                "
              >
...
export default {
  ...
  methods: {
    ...
    onApprove: async function () {
      ...
      if (
        (this.user.hasOwnProperty("user_type") && this.user.user_type !== 'DISTRIBUTOR') &&
      ...
      let data = {
        ...
        IS_FIMM: this.user.hasOwnProperty("user_type") && this.user.user_type !== 'DISTRIBUTOR' ? true : false,
      ...
      if (data.STATUS === "Returned to creator") {
        ...
        toastMessage = `${toastMessage} return Extension Request.`
      } else if (data.STATUS === "Approved") {
        if (!confirm("Are you sure you want to approve this entry?")) {
          pass = false;
        }
          toastMessage = `${toastMessage} approve Extension Request.`
        ...
        if (!confirm("Are you sure you want to reject this entry?")) {
          ...
          toastMessage = `${toastMessage} reject Extension Request entry.`
      }
    ...
    getById: async function () {
      ...
      if(response.hasOwnProperty('RD_APPROVAL') && response.RD_APPROVAL !== null) {
        this.returned = true;
      ...
      if (
        ...
        this.user.user_type !== 'DISTRIBUTOR'
      ) {
