  ...
  <va-card>
    ...
    <div class="row">
      <h4 slot="header" class="card-title">
        <!-- Time Extension Request for: {{model.tableData[0].distributor.DIST_NAME}} -->
        Time Extension Request {{model.onlyApproved ? "History" : "Approval" }} for: {{distName}}
      </h4>
    ...
    >
      ...
      <template slot="REMARK" slot-scope="item">
            ...
            <!-- {{item.rowData}} -->
        <!-- <template v-if="user.USER_GROUP_ID == 4 && item.rowData.rd_approval.task_status.TS_PARAM == 'RETURNED'">
          <template v-if="item.rowData.rd_approval.APPROVAL_PUBLISH_STATUS === true">
            {{item.rowData.rd_approval.APPROVAL_REMARK.split(' ')[0]+'...'}}
            <span
            v-b-tooltip.hover
            @click="showAmendment(item.rowData.EXTENSION_REQUEST_ID)"
            title="Read more"
          ...
          <template v-else>
            {{item.rowData.rd_hod_approval.APPROVAL_REMARK.split(' ')[0]+'...'}}
            <span
            v-b-tooltip.hover
            @click="showAmendment(item.rowData.EXTENSION_REQUEST_ID)"
            title="Read more"
        ...
        <template v-else-if="user.USER_GROUP_ID == 2 && item.rowData.rd_hod_approval.task_status.TS_PARAM == 'RETURNED' && item.rowData.rd_hod_approval.APPROVAL_PUBLISH_STATUS === true">
          {{item.rowData.gm_approval.APPROVAL_REMARK.split(' ')[0]+'...'}}
          <span
          v-b-tooltip.hover
          @click="showAmendment(item.rowData.EXTENSION_REQUEST_ID)"
          title="Read more"
      ...
      <template slot="action" slot-scope="item">
        <h5 class="mt-1">
          <!-- <span
            ...
            v-b-tooltip.hover
            @click="
              redirectPage(item.rowData.EXTENSION_REQUEST_ID, 'view')
            "
          >
            <i class="fa fa-eye"></i>
          </span> -->
          <template v-if="user.user_type !== 'DISTRIBUTOR'">
            ...
            <template v-else-if="user.USER_GROUP_ID == 2"> <!-- HOD RD Block -->
              <template v-if="item.rowData.rd_hod_approval.task_status.TS_PARAM == 'APPROVED'">
                <span
                  class="badge badge-primary mr-2"
                  v-b-tooltip.hover
                  @click="
              ...
              <template v-if="item.rowData.rd_hod_approval.task_status.TS_PARAM == 'PENDING' || item.rowData.rd_hod_approval.task_status.TS_PARAM == 'DRAFT'">
                <span
                  class="badge badge-primary mr-2"
                  v-b-tooltip.hover
                  @click="
            ...
            <template v-else-if="user.USER_GROUP_ID == 3"> <!-- GM RD Block -->
              <template v-if="item.rowData.gm_approval.task_status.TS_PARAM == 'APPROVED'">
                <span
                  class="badge badge-primary mr-2"
                  v-b-tooltip.hover
                  @click="
              ...
              <template v-if="item.rowData.gm_approval.task_status.TS_PARAM == 'PENDING' || item.rowData.gm_approval.task_status.TS_PARAM == 'DRAFT'">
                <span
                  class="badge badge-primary mr-2"
                  v-b-tooltip.hover
                  @click="
            ...
            <template v-else-if="user.USER_GROUP_ID == 1"> <!-- CEO Block -->
              <template v-if="item.rowData.ceo_approval.task_status.TS_PARAM == 'APPROVED'">
                <span
                  class="badge badge-primary mr-2"
                  v-b-tooltip.hover
                  @click="
              ...
              <template v-if="item.rowData.ceo_approval.task_status.TS_PARAM == 'PENDING' || item.rowData.ceo_approval.task_status.TS_PARAM == 'DRAFT'">
                <span
                  class="badge badge-primary mr-2"
                  v-b-tooltip.hover
                  @click="
...
export default {
  ...
  methods: {
    ...
    redirectPage(id, action) {
      ...
      this.$router.push(`extension-request-${action}`);
    },
