    ...
    <va-card class="mt-3">
      <div class="row">
        ...
        <div class="col float-right">
          <div class="float-right">
            <h5>
              <b-badge v-b-toggle.collapse-1 class="mr-1"
              variant="secondary">
                <i class="fa fa-eye"></i>
              </b-badge>
            </h5>
      ...
      <b-collapse id="collapse-1">
        <div class="m-1">
          Staff of Registration Department Recommendation
            ...
            ></vue-form-generator>
            <div class="col-md-12 mb-3">
              <label for="" v-if="rdApprovalModel.file.length > 0">Upload Document</label>
              <VueFileAgent
                theme="list"
                :readonly="true"
                :deletable="false"
            ...
            <hr />
            Registration Head of Department Recommendation
            <vue-form-generator
            ...
            ></vue-form-generator>
            <div class="col-md-12 mb-3">
              <label for="" v-if="rdHodApprovalModel.file.length > 0">Upload Document</label>
              <VueFileAgent
                theme="list"
                :readonly="true"
                :deletable="false"
            ...
            <div class="float-right">
              <div class="float-right">
                ...
                <button
                  type="submit"
                  class="btn btn-info btn-fill btn-md mr-2"
                  @click="rdGmApprovalModel.submissionStatus = 'Draft'"
                >
                ...
                <button
                  ...
                  @click="
                    rdGmApprovalModel.submissionStatus =
                      'Returned to creator'
                  "
                >
                ...
                <button
                  ...
                  @click="
                    rdGmApprovalModel.submissionStatus = 'Approved'
                  "
                >
...
export default {
  ...
  methods: {
    ...
    onApprove: async function () {
      let model = this.rdGmApprovalModel;
      let pass = true;
    ...
    onBeforeDelete(fileRecord) {
      ...
      if (i !== -1) {
        ...
        this.rdGmApprovalModel.file = this.uploadFileOject;
      } else {
