    ...
    <va-card>
      ...
      <va-card class="mt-5 col-12">
		...
		<div class="row">
          ...
          <div class="col float-right">
            <div class="float-right">
              <button @click="UnselectAll" type="button">Unselect All Consultant</button>
            </div>
          </div>
        </div>
		<br/>
...
export default {
  ...
  methods: {
    ...
    getAllRecord: async function () {
      const user = localStorage.getItem("user");
      const response = await servicesModule1.getDistributor_consultant_list(JSON.parse(user).user_id );
      this.RecordList = response;
      this.RecordCount = this.RecordList.length;
    ...
    getDistributorList: async function () {
      const user = localStorage.getItem("user");
      const response = await servicesModule1.getDistributor_consultantDivestment(JSON.parse(user).user_id);
