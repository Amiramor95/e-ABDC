...
export default {
  ...
  methods: {
    ...
    getFundRecord: async function () {
      const user = localStorage.getItem("user");
      const response = await servicesModule1.getDistributor_selected_fund_list(JSON.parse(user).user_id);
    ...
    back() {
      ...
      this.$router.push("/distributor/DistributorDivestment-EditFundConsultant-consultant");
    },
