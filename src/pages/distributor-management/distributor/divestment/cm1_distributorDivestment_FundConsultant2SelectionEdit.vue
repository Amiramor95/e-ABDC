  ...
  <va-card>
    ...
    <va-card class=" col-12">
        ...
        <div class="row">
          ...
          <div class="col float-right">
            <div class="float-right">
              <button @click="selectAll" type="button">Select All Consultant</button>
            </div>
          </div>
        </div>
        <br/>
      ...
      <va-card class="mt-5 col-12">
        ...
        <br/>
        <va-data-table
          :fields="ConsultantRecordFields2"
          :data="ConsultantFilteredData2"
          no-data-label="No data found"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      // back button
      back() {
        this.$router.push('/distributor/DistributorDivestment-EditFundConsultant')
      },
      ...
      Verify: async function () {
        ...
        try {
          ...
          // const user = localStorage.getItem("user");
          //
          // localStorage.setItem("DIVE_ID", 346);
          const data = localStorage.getItem("DIVE_ID");
          const DIVE_ID = JSON.parse(data);
          console.log('DIVE ID:'+ DIVE_ID);
          ...
          this.$router.push("/distributor/DistributorDivestment-FundConsultantSubmission");
      ...
      getStatusFund: async function () {
        ...
        // this.getAllRecord();
        this.getAllRecordConsultant();
        this.getSelectedRecordConsultant();
        // this.getStatusCons();
      ...
      // getAllSelectedRecordConsultant
      getSelectedRecordConsultant: async function () {
        const user = localStorage.getItem("user");
