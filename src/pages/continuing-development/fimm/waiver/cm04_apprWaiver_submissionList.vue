  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Waiver : List of Submissions for Approvals
      </h4>
      <br>
...
export default {
  ...
  methods: {
    ...
    getRecordByDist: async function () {
      ...
      const response = await servicesModule4.getWaiverSubmissionList();
    ...
    async viewRecord(data) {
      localStorage.setItem("review-waiver-submission", JSON.stringify(data));
      this.$router.push({
    ...
    exchange () {
      this.$router.push('/fimm/waiver-approval-list')
    },
  },
