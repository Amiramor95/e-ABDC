  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        List of Academic/Professional Qualification Submission Programs
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalAcademicModuleList");
  ...
  methods: {
    ...
    back() {
      this.$router.push('/fimm/approvalAcademicDistributorList');
    }, // back button
