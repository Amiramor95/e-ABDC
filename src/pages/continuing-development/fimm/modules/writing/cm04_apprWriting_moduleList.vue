  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        List of Writing and Publishing Books/Articles Submission Programs
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalWritingModuleList");
  ...
  methods: {
    ...
    back() {
      // this.$router.go(-1);
      this.$router.push("/fimm/approvalWritingDistributorList");
    }, // back button
