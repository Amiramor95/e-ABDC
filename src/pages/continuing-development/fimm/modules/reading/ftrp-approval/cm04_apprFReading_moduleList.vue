  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        List of FReading Submission Programs
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalFReadingModuleList");
  ...
  methods: {
    ...
    getAllRecord: async function () {
      const response =
        await services07Module4.getModuleApprovalByTRPReading(
