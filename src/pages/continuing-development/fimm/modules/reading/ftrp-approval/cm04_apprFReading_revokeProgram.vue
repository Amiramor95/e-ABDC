...
<script>
  ...
  export default {
    mounted() {
      var data = localStorage.getItem("approval-f-reading-revokeProgram");
    ...
    methods: {
      ...
      revokeCpd: async function () {
        if (confirm("Are you sure to revoke this program?")) {
          ...
          var remarkEntry = "(CPD-FREADING)Program for "+ this.PROGDATA.MODULE_CODE +" has been revoked by FIMM";
