  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Appeal List of FReading Submission Programs
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("f-appealReadingListProgramList");
  ...
  methods: {
    ...
    async editRecord(data) {
     //alert(JSON.stringify(data))
      localStorage.setItem("appealFReadingViewDetails", JSON.stringify(data));
      this.$router.push({
