...
export default {
  ...
  methods: {
    ...
    getRecordByDist: async function () {
      const response = await services07Module4.getModuleByDistributor(2);
    ...
    async viewRecord(data) {
      localStorage.setItem("approvalReadingModuleList", JSON.stringify(data));
      this.$router.push({
    ...
    async viewProgram(data) {
      localStorage.setItem("approval-reading-allProgram", JSON.stringify(data));
      this.$router.push({
