...
export default {
  mounted() {
    var data = localStorage.getItem("approval-reading-allProgram");
  ...
  methods: {
    ...
    back() {
      this.$router.push('/fimm/approvalReadingDistributorList');
    }, // back button
    ...
    async editRecord(data) {
     //alert(JSON.stringify(data))
      ...
      localStorage.setItem(
        "approval-reading-viewSubmission",
        JSON.stringify(data)
      );
      this.$router.push({
    ...
    async revokeRecord(data) {
      localStorage.setItem(
        "approval-reading-revokeProgram",
        JSON.stringify(data)
      );
      this.$router.push({
