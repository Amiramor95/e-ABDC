<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Reading : View Program Details</h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalReadingViewDetails");
  ...
  methods: {
    ...
    async back() {
      this.$router.push('/fimm/approvalReadingModuleList');
    },
