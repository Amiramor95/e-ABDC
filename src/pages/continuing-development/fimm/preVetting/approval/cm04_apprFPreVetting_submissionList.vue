<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title"> Pre-Vetting : List of Program Submissions</h4>
      ...
      >
        ...
        <template slot="actions" slot-scope="props">
          <h5 class="mt-1">
            ...
            <span
              v-b-tooltip.hover
              title="View all program submission"
  ...
  methods: {
    ...
    async viewRecord(data) {
      localStorage.setItem(
        "apprFPreVettingViewProgramList",
        JSON.stringify(data)
      );
      this.$router.push({
    ...
    async viewProgram(data) {
      localStorage.setItem("approval-FpreVetting-allProgram", JSON.stringify(data));
      this.$router.push({
