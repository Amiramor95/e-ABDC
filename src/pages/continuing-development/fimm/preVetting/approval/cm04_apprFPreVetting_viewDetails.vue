  ...
  <va-card>
    ...
    <va-card>
      <div class="ml-2 col-md-12">
        Fimm Training Provider's Person In Charge
        <button
          ...
          <table class="table table-striped">
            <tbody>
              <tr>
                ...
                <td>{{ PROGDATA.TUSERNAME }}</td>
              </tr>
              <tr>
                <td>Email</td>
                <td>{{ PROGDATA.TUSEREMAIL }}</td>
              </tr>
            </tbody>
          </table>
        </b-collapse>
...
export default {
  mounted() {
    var data = localStorage.getItem("apprFPreVettingViewDetails");
  ...
  methods: {
    ...
    async back() {
      this.$router.push('/fimm/apprFPreVettingViewProgramList');
    },
