...
export default {
  mounted() {
    var data = localStorage.getItem("approvalFPreVettingViewDetails");
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure to save as draft this submission?")) {
        this.isReady=false;
    ...
    approveCpd: async function () {
      if (confirm("Are you sure to approve this submission?")) {
        ...
        var remarkEntry = "(CPD-PRE)This entry has been approved by FIMM";
        ...
        //alert(this.PROGDATA.DIST_CREATE_BY)
    ...
    returnCpd: async function () {
      if (confirm("Are you sure to return of this submission?")) {
        ...
        const approvalLevel = await services06Module0.getApprovalLevel(28, 2);
        ...
        data.append("NOTI_LOCATION", "f-preVettingProgramList");
        var remarkEntry = "(CPD-PRE)This Entry has been returned by FIMM";

        data.append("NOTI_REMARK", remarkEntry);
        data.append("DIST_CREATE_BY", this.PROGDATA.CREATE_BY);
        data.append("DISTRIBUTOR_ID", this.PROGDATA.COMPANY_ID);
        data.append("APPR_GROUP_ID", JSON.parse(user).USER_GROUP_ID);
    ...
    rejectCpd: async function () {
      if (confirm("Are you sure to reject this submission?")) {
        ...
        data.append("PARTLIST", JSON.stringify(responsePart));
        data.append("POINT", this.PDATA.PROG_HOURS);


        //notification
        data.append("NOTI_LOCATION", "f-preVettingProgramList");
        var remarkEntry = "(CPD-PRE)This Entry has been rejected by FIMM";
        data.append("NOTI_REMARK", remarkEntry);
        data.append("DIST_CREATE_BY", this.PROGDATA.DIST_CREATE_BY);
        data.append("DISTRIBUTOR_ID", this.PROGDATA.COMPANY_ID);
     ...
     viewParticipant: async function () {
      ...
      localStorage.setItem("approval-FpreVetting-view-participant",this.PROGDATA.PROG_DETAILS_ID);
      this.$router.push({
