...
export default {
  mounted() {
    var data = localStorage.getItem("f-preVettingViewProgramList");
  ...
  methods: {
    ...
    async returnRecord(progData) {
      if (confirm("Are you sure to request return of this submission?")) {
        ...
        data.append("APPR_LIST2", JSON.stringify(approvalLevel2));
          ...
          //notification
      data.append("NOTI_LOCATION", "apprFPreVettingsubmissionList");
      var remarkEntry = "(CPD-PRE)New entry request return for " + this.PROGDATA.PROG_CODE ;
    ...
    async viewRecord(data) {
      localStorage.setItem(
        "f-preVettingViewProgramDetails",
        JSON.stringify(data)
      );
      this.$router.push({
    ...
    async amendRecord(data) {
      localStorage.setItem("f-preVettingAmendProgram", JSON.stringify(data));
      this.$router.push({
        name: "f-preVettingAmendProgram",
      });
    },
    async editRecord(data) {
      localStorage.setItem("f-preVettingEditProgram", JSON.stringify(data));
      this.$router.push({
