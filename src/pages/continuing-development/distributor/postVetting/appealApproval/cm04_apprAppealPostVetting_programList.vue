  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
         Post-Vetting : List of Program Appeal Submissions
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalAppeal-postVetting-programList");
  ...
  methods: {
    ...
    async editRecord(data) {
     //alert(JSON.stringify(data))
      localStorage.setItem("approvalAppeal-postVetting-reviewDetails", JSON.stringify(data));
      this.$router.push({
      ...
      localStorage.setItem(
        "approvalAppeal-postVetting-viewSubmission",
        JSON.stringify(data)
      );
      this.$router.push({
