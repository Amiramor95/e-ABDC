  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Post-Vetting : Review Appeal Program
      </h4>
    </div>
    <br />
    <va-card>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalAppeal-postVetting-reviewDetails");
  ...
  methods: {
    ...
    revokeCpd: async function () {
      if (confirm("Are you sure to revoke this program?")) {
        ...
        var remarkEntry = "(CPD-POST)Your appeal submission has been declined by FIMM";
    ...
    approve: async function () {
      if (confirm("Are you sure you want to approve this program?")) {
        ...
        //notification
        data.append("NOTI_LOCATION", "d-postVettingProgramList");
        var remarkEntry = "(CPD-POST)This program has been approved by FIMM";
        data.append("NOTI_REMARK", remarkEntry);
        data.append("DIST_CREATE_BY", this.PROGDATA.DIST_CREATE_BY);
        data.append("DISTRIBUTOR_ID", this.PROGDATA.COMPANY_ID);
        data.append("POINTS",this.PDATA.PROG_HOURS);
