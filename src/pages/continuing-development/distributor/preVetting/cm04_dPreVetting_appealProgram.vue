<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Pre-Vetting : Appeal Program</h4>
    </div>
    <br />
    <va-card>
...
export default {
  mounted() {
    var data = localStorage.getItem("d-preVettingAppealProgram");
  ...
  methods: {
    ...
    appeal: async function () {
      if (confirm("Are you sure you want to submit appeal?")) {
        ...
        const approvalLevel2 = await services06Module0.getApprovalLevel(13, 1);
