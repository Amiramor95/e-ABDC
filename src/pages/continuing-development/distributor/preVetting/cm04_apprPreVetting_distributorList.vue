    ...
    <va-card>
      <div class="row">
        <h4 slot="header" class="card-title">
          Pre-Vetting : List of Distributors
        </h4>
      </div>
...
export default {
  ...
  methods: {
    ...
    async viewRecord(data) {
      localStorage.setItem("approvalPreVettingProgramList", JSON.stringify(data));
      this.$router.push({
    ...
    async viewProgram(data) {
      localStorage.setItem("approval-preVetting-allProgram", JSON.stringify(data));
      this.$router.push({
