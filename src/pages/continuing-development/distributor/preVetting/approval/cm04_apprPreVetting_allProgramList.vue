...
export default {
  mounted() {
    var data = localStorage.getItem("approval-preVetting-allProgram");
    ...
    async editRecord(data) {
     //alert(JSON.stringify(data))
      ...
      localStorage.setItem(
        "approval-preVetting-viewSubmission",
        JSON.stringify(data)
      );
      this.$router.push({
      ...
      localStorage.setItem(
        "approval-preVetting-revokeProgram",
        JSON.stringify(data)
      );
      this.$router.push({
