...
<!--                  {{this.methodList[4]}}-->
<!--                </template>-->
<!--                <template slot="MEDIA" slot-scope="row">-->
<!--                  {{this.mediaList[row.rowData.MEDIA].LS_MEDIA_NAME}}-->
<!--                </template>-->
<!--                <template slot="ASSESSMENT" slot-scope="row">-->
<!--                  {{this.assessmentList[row.rowData.ASSESSMENT].LS_ASSESSMENT_NAME}}-->
<!--                </template>-->
...
export default {
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      if (confirm("Are you sure to save as draft this program?")) {
    ...
    submit: async function () {
      if (confirm("Are you sure to submit this program?")) {
    ...
    resetSloData(){
        this.model.sloAssessment.ASSESSMENT='',
        this.model.sloHours='',
        this.model.sloMedia.MEDIA='',
        this.model.sloMethod.METHOD='',
        this.model.sloSpeaker='',
        this.model.sloTitle='',
        this.model.sloTopic=''
    },
    ...
    async upload() {
      if (confirm("Are you sure you want to upload this record?")) {
        ...
        fileReader.onload = async function (e) {
          ...
          //calculate total-participant from excel
          ...
          // this.totalParticipant = this.participantList.length;
          ...
          // console.log('test');
          // content[2][0].LS_METHOD_NAME=this.methodList[content[2][0].METHOD]
