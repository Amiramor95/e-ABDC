<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Post-Vetting : View Details Appeal Program</h4>
    </div>
    <br />
    <va-card>
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalAppeal-postVetting-viewSubmission");
  ...
  getSlo: async function () {
   ...
   viewParticipant: async function () {
      ...
      localStorage.setItem("approval-view-participant",this.PDATA.PROG_DETAILS_ID);
      this.$router.push({
