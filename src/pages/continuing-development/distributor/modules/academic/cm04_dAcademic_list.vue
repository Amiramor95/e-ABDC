...
export default {
  ...
  methods: {
    ...
    getAllRecord: async function () {
      ...
      this.recordList = await service07Module4.getModules(USER_ID, 4);
      this.dataReady = true;
    },
    filter(value) {
      this.term = value;
  ...
  data() {
    return {
      dataReady: false,
      title: "List of Academic/Professional Qualification",
      newSubmissionTitle: "New Academic/Professional Qualification Submission",
      recordList: [],
      recordCount: 0,
      term: null,
      termDate: null,
      perPage: 10,
      viewPage: "d-academicEditSubmission",
      appealPage:"d-academicAppealProgram",
      amendPage:"d-academicAmendProgram",
    };
  },
  computed: {
    filterData() {
