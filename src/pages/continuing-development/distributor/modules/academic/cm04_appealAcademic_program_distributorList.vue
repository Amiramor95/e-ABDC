  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Appeal List of Academic Submission Programs
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("d-appealAcademicListProgramList");
  ...
  methods: {
    ...
    getAllRecord: async function () {
      ...
      const response = await servicesModule4.getAcademicModuleByDistId(
    ...
    async editRecord(data) {
     //alert(JSON.stringify(data))
      localStorage.setItem("d-appealAcademicViewDetails", JSON.stringify(data));
      this.$router.push({
