...
export default {
  ...
  methods: {
    ...
    create() {
      this.$router.push("/distributor/d-writingNewSubmission");
    },
    getAllRecord: async function () {
      console.log('here');
      let USER_ID = JSON.parse(localStorage.getItem("user")).user_id;
      this.recordList = await service07Module4.getModules(USER_ID, 1);
      this.dataReady = true;
    },
    filter(value) {
      console.log(value);
  ...
  data() {
    return {
      dataReady: false,
      title: "List of Writing and Publishing Books/Articles",
      newSubmissionTitle: "New Writing and Publishing Books/Articles Submission",
      recordList: [],
      recordCount: 0,
      term: null,
      termDate: null,
      perPage: 10,
      viewPage: "d-writingEditSubmission",
      appealPage:"d-writingAppealProgram",
      amendPage:"d-writingAmendProgram",
    };
  },
  computed: {
    filterData() {
