  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Appeal Writting : List of Distributor
      </h4>
    </div>
...
export default {
  ...
  methods: {
    ...
    getRecordByDist: async function () {
      ...
      const response = await servicesModule4.getWritingByDist(
        2,
        1
      );
    ...
    async viewRecord(data) {
      localStorage.setItem("d-appealWritingListProgramList", JSON.stringify(data));
      this.$router.push({
