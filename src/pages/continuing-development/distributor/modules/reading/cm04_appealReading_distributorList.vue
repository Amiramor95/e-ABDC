  ...
  <va-card v-else>
    <div class="row">
      <h4 slot="header" class="card-title">
        Appeal Reading : List of Distributor
      </h4>
    </div>
...
export default {
  ...
  methods: {
    ...
    getRecordByDist: async function () {
      ...
      const response = await servicesModule4.getReadingListByDist(
        2,
        2
      );
    ...
    async viewRecord(data) {
      localStorage.setItem("d-appealReadingListProgramList", JSON.stringify(data));
      this.$router.push({
