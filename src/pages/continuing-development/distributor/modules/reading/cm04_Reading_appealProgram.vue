<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">Reading : Appeal Program</h4>
    </div>
    <br />
    <va-card>
...
export default {
  mounted() {
    var data = localStorage.getItem("d-readingAppealProgram");
  ...
  methods: {
    ...
    appeal: async function () {
      if (confirm("Are you sure you want to submit appeal?")) {
        ...
        //notification
        data.append("NOTI_LOCATION", "d-appealReadingList");
