...
<script>
  ...
  export default {
    mounted() {
      var data = localStorage.getItem("d-appealReadingViewDetails");
    ...
    methods: {
      ...
      revokeCpd: async function () {
        if (confirm("Are you sure to revoke this program?")) {
          ...
          //notification
          data.append("NOTI_LOCATION", "d-appealReadingListProgramList");
          var remarkEntry = "(CPD-READING)Your appeal submission has been declined by FIMM";
      ...
      approve: async function () {
        if (confirm("Are you sure you want to approve this program?")) {
          ...
          //notification
          data.append("NOTI_LOCATION", "d-appealReadingListProgramList");
          var remarkEntry = "(CPD-READING)This program has been approved by FIMM";
          data.append("NOTI_REMARK", remarkEntry);
          data.append("DIST_CREATE_BY", this.PROGDATA.DIST_CREATE_BY);
          data.append("DISTRIBUTOR_ID", this.PROGDATA.COMPANY_ID);
