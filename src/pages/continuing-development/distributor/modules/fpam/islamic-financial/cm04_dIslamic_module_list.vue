...
export default {
  ...
  methods: {
    ...
    getAllRecord: async function () {
      ...
      this.recordList = await service07Module4.getModules(USER_ID, 5, 2,2);
      this.dataReady = true;
    },
    filter(value) {
      this.term = value;
  ...
  data() {
    return {
      dataReady: false,
      title: "List of Islamic Financial Planner Module",
      newSubmissionTitle: "New Islamic Financial Planner Module Submission",
      recordList: [],
      recordCount: 0,
      term: null,
      termDate: null,
