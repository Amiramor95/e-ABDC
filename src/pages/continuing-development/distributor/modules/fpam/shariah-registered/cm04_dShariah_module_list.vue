...
export default {
  ...
  methods: {
    ...
    getAllRecord: async function () {
      ...
      this.recordList = await service07Module4.getModules(USER_ID, 5, 2,4);
      this.dataReady = true;
    },
    filter(value) {
      if(value.includes('-')){
  ...
  data() {
    return {
      dataReady: false,
      title: "List of Shariah Registered Financial Planner Module",
      newSubmissionTitle: "New Shariah Registered Financial Planner Module Submission",
      recordList: [],
      recordCount: 0,
      term: null,
      termDate: null,
