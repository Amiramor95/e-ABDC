...
<script>
  ...
  export default {
    ...
    mounted() {
      var data = localStorage.getItem("d-fpCertifiedAmendProgram");
    ...
    methods: {
      async back(){
        this.$router.push({
          path:this.backPage,
          query:{
            fpCategory:this.model.fpCategory
          }
        });
      },
      //FUNCTION DATE
      ...
      async downloadRejectedList() {
        await service07Module4.fpDownloadRejectedList(this.module.MODULE_ID);
      },
