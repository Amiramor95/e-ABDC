...
<script>
  ...
  export default {
    ...
    mounted() {
      var data = localStorage.getItem("d-teachingAmendProgram");
    ...
    methods: {
      ...
      async downloadRejectedList() {
        await service07Module4.teachingDownloadRejectedList(this.module.MODULE_ID);
      },
    ...
    data() {
      return {
        submitLoading: false,
        dataReady: false,
        title: "Teaching/Speaking: View Program Detail (Amendment)",
        totalRejected: 0,
        recordList: [],
        recordCount: 0,
        module: null,
