  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Appeal List of Teaching Submission Programs
      </h4>
    </div>
...
export default {
  mounted() {
    var data = localStorage.getItem("d-appealTeachingListProgramList");
  ...
  methods: {
    ...
    getAllRecord: async function () {
      ...
      const response = await servicesModule4.getTeachingModuleByDistId(
    ...
    async editRecord(data) {
     //alert(JSON.stringify(data))
      localStorage.setItem("d-appealTeachingViewDetails", JSON.stringify(data));
      this.$router.push({
