  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        Appeal Teaching : List of Distributor
      </h4>
    </div>
...
export default {
  ...
  methods: {
    ...
    getRecordByDist: async function () {
      ...
      const response = await servicesModule4.getTeachingByDist(
        2,
        3
      );
    ...
    async viewRecord(data) {
      localStorage.setItem("d-appealTeachingListProgramList", JSON.stringify(data));
      this.$router.push({
