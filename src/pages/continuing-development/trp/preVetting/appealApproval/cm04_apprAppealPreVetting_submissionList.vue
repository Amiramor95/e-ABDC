  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        TPre-Vetting : List of Program Appeal Submissions
      </h4>
    </div>
...
<script>
  ...
  export default {
    mounted() {
      var data = localStorage.getItem("approvalAppeal-preVetting-programList");
    ...
    methods: {
      ...
      getAllRecord: async function () {
        ...
        const response = await servicesModule4.getAppealProgramByDistId(
          JSON.parse(localStorage.getItem("user")).TP_COMP_ID,
          3,
          2
        );
      ...
      async editRecord(data) {
        ...
        // localStorage.setItem("approvalAppeal-FpreVetting-reviewDetails", JSON.stringify(data));
        // this.$router.push({
        //   name: "approvalAppeal-TpreVetting-reviewDetails",
        // });

        localStorage.setItem("approvalAppeal-TpreVetting-reviewDetails", JSON.stringify(data));
        this.$router.push({
          name: "approvalAppeal-TpreVetting-reviewDetails",
        });
      },
