  ...
  <va-card v-else>
    <div class="row">
      <h4 slot="header" class="card-title">
        TPre-Vetting : Review Appeal Program
      </h4>
    </div>
    <br />
...
export default {
  mounted() {
    var data = localStorage.getItem("approvalAppeal-TpreVetting-reviewDetails");
  ...
  methods: {
    ...
    revokeCpd: async function () {
      if (confirm("Are you sure to revoke this program?")) {
        ...
        //notification
        data.append("NOTI_LOCATION", "d-preVettingProgramList");
