...
export default {
  props: {},
  mounted() {
    var data = localStorage.getItem("t-preVettingEditProgram");
    ...
    submit: async function () {
      ...
      if (confirm("Are you sure you want to submit this entry?")) {
        ...
        if (this.model.repeat == 0) {
          ...
          //notification
          data.append("NOTI_LOCATION", "apprTPreVettingDistributorList");
          var code = "";
          var remarkEntry = "(TRP-PRE)New entry pending approval";
