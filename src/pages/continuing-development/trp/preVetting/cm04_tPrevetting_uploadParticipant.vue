  ...
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">
        TPre-Vetting : View Participant List
      </h4>
    </div>
    <br />
    <va-card>
    ...
    methods: {
      ...
      getAllParticipant: async function () {
        const response = await servicesModule4.getProgramParticipantByID(
          localStorage.getItem("t-preVettingUploadParticipant")
        );
      ...
      submit: async function () {
        ...
        if (confirm("Are you sure you want to submit?")) {
          ...
          data.append("PROG_DETAILS_ID",localStorage.getItem("t-preVettingUploadParticipant"));
