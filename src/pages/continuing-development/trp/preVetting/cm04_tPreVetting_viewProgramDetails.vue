...
<template>
  ...
  <va-card v-else>
    <div class="row">
      <h4 slot="header" class="card-title">TPre-Vetting : View Program Details</h4>
    </div>
    <br />
    <va-card>
...
export default {
  props: {},
  mounted() {
    var data = localStorage.getItem("t-preVettingViewProgramDetails");
  ...
  methods: {
    ...
    search: debounce(function (term) {
     ...
     viewParticipant: async function () {
      ...
      localStorage.setItem("t-preVettingViewParticipant",this.PROGDATA.PROG_DETAILS_ID);
      this.$router.push({
