...
export default {
  mounted() {
    var data = localStorage.getItem("apprTPreVettingViewProgramList");
  ...
  methods: {
    ...
    back() {
      this.$router.push('/fimm/apprTPreVettingDistributorList');
    }, // back button
    ...
    async readMore(data) {
     ...
     //alert(JSON.stringify(data))
      localStorage.setItem("apprTPreVettingViewDetails", JSON.stringify(data));
      this.$router.push({
