  ...
  <div class="row">
    <div class="col-12">
      <template>
        ...
        <va-card v-else>
          <div class="row">
            <h4 slot="header" class="card-title">TPre-Vetting : View Details Program</h4>
          </div>
          <br />
...
export default {
  mounted() {
    var data = localStorage.getItem("approval-TpreVetting-viewSubmission");
  ...
  getSlo: async function () {
   ...
   viewParticipant: async function () {
      ...
      localStorage.setItem("approval-TpreVetting-view-participant",this.PDATA.PROG_DETAILS_ID);
      this.$router.push({
