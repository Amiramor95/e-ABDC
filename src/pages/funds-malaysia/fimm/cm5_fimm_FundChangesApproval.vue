        ...
        <table class="table table-striped">
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_SYARIAH_COMP == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_SYARIAH_COMP == 2">No</div>
                <div
                  v-if="
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_ANNUAL_MGMT == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_ANNUAL_MGMT == 2">No</div>
                <div
                  v-if="
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_FUND_PERFORMANCE == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_FUND_PERFORMANCE == 2">No</div>
                <div
                  v-if="
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_STATUS_EPF == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_STATUS_EPF == 2">No</div>
                <div
                  v-if="
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_DAILY_NAV == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_DAILY_NAV == 2">No</div>
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_FEEDER == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_FEEDER == 2">No</div>
                <div
                  v-if="
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_FOF_STATUS == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_FOF_STATUS == 2">No</div>
                <div
                  v-if="
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUND_UCITS_STATUS == 1">Yes</div>
                <div v-if="FUNDPROFILE.FUND_UCITS_STATUS == 2">No</div>
                <div
                  v-if="
      ...
      <div>
        <table class="table table-responsive table-borderless">
          <tbody>
            <tr>
              <td>
                <h4 slot="header" class="card-title">Changes Approval</h4>
              </td>
            </tr>
            <tr>
              <td style="width: 15%">
...
export default {
  ...
  methods: {
    gethAllFundProfile: async function () {
      const data = this.$route.params.FUNDPROFILE.FUNDPROFILE_ID;
      const response = await servicesModule5.getFundProfileReviewFIMM(data);
