...
import * as servicesModule4 from "../../../../app/module4/services01";
  ...
  export default {
    mounted() {
      var data = localStorage.getItem("navManagementVerification");
    ...
    if (confirm("Are you sure you want to approve this submission?")) {
      ...
      //notification
      data.append("NOTI_LOCATION", "navManagementApprovalList");
      var remarkEntry = "(NAV MANAGEMENT)New entry pending approval for " +  this.WDATA.DIST_NAME;
