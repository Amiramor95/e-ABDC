<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">NAV Management : List of Submission Pending for Approval</h4>
      <br />
...
export default {
  ...
  methods: {
    ...
    getApprRecordById: async function () {
      const response = await services01Module5.getFimmApprRecordById();
