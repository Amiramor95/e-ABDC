        ...
        <table class="table table-striped">
          <tbody>
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">{{ FUNDPROFILE.DIST_NAME }}</td>
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                {{ FUNDPROFILE.UMBRELLA_FUND_NAME }}
              </td>
              <td style="width: 34%"></td>
            </tr>
            <tr>
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">LP{{ FUNDPROFILE.FUND_LIPPER_CODE }}</td>
            </tr>
            <tr>
              <td style="width: 15%"><b>Fund Name</b></td>
              <td style="width: 1%">:</td>
              <td style="width: 34%">{{ FUNDPROFILE.FUND_NAME }}</td>
            </tr>
          </tbody>
        </table>
      </div>
        ...
        <table class="table table-striped">
          <tbody>
            ...
            <tr>
              ...
              <td style="width: 1%">:</td>
              <td style="width: 34%">
                <div v-if="FUNDPROFILE.FUNDNOTES != null">
                  <div
                    v-for="(fundnote, index) in FUNDPROFILE.FUNDNOTES"
                    :key="index"
                  >
                    <a
                      v-if="
                ...
                <div
                  v-if="
                    FUNDPROFILE.FUNDNOTES == null || FUNDPROFILE.FUNDNOTES == ''
                  "
                >
                  -
                </div>
      ...
      if (response) {
        ...
        try {
          ...
          if (confirm("Are you sure you to return ?")) {
            const response =
              await servicesModule5.updateApprovalFundManagementFundNotesFIMM(data);
