          ...
          <va-card>
            ...
            <div>
              ...
              >
                ...
                <b-tab v-on:click="tabIndex == 1" title="Fund Notes">
                  <br />
                  <div>
                    <!-- <div>
                      <vue-form-generator
                    ...
                    <!-- <div>
                      <b-form-checkbox-group
                        ...
                        :options="options"
                        class="mb-3"
                        value-field="FUNDNOTES_ID"
                        text-field="FUNDNOTES_DESC"
                      ></b-form-checkbox-group>
                    </div> -->

                    <div class="col-md-12 mb-3"
                       v-for="(fundnote, eindex) in fundNotes" :key="eindex">
                      <b-form-group
                        label-for="highest-education"
                        description=""
                        class="required"
                      >
                        <label v-if="eindex==0">Fund Notes: <span class="text-danger">*</span></label>
                        ...
                        <div class="row mt-3" :key="eindex" v-if="fundnote.FUNDNOTES_ID == 6">
                        <b-form-group
                        ...
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundNotes[eindex].FN6DATE1" valueclass="mb-2"></b-form-datepicker>
                        </b-form-group>
                        ...
                        >
                            <b-form-datepicker id="datepicker2" v-model="fundNotes[eindex].FN6DATE2" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" :key="eindex" v-if="fundnote.FUNDNOTES_ID == 7">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date 1"
                          label-for="input-degree-major"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN7DATE1" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        ...
                        <b-form-group
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN7DATE2" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN7DATE3" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" :key="eindex" v-if="fundnote.FUNDNOTES_ID == 8">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date 1"
                          label-for="input-degree-major"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN8DATE1" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        ...
                        <b-form-group
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN8DATE2" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN8DATE3" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN8DATE4" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" :key="eindex" v-if="fundnote.FUNDNOTES_ID == 9">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date 1"
                          label-for="input-degree-major"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN9DATE1" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        ...
                        <b-form-group
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN9DATE2" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN9DATE3" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN9DATE4" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN9DATE5" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" :key="eindex" v-if="fundnote.FUNDNOTES_ID == 21">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date"
                          label-for="input-degree-major"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN21DATE1" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      ...
                      <div class="row mt-3" :key="eindex" v-if="fundnote.FUNDNOTES_ID == 24">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date"
                          label-for="input-degree-major"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.FN24DATE1" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      </b-form-group>

                        <button size="sm" class="btn btn-danger ml-2" type="button" @click="deleteFundNotes(fundnote)" v-if="eindex!=0">
                          <i class="fa fa-trash mr-2"></i>Delete
                        </button>
                      </div>
                      <div class="text-right">

                        <button size="sm" class="btn btn-primary" @click="addFundNotes()" type="button" >
                ...
                <b-tab v-on:click="tabIndex == 2" title="Document">
...
export default {
  ...
  methods: {
    ...
    saveAsDraft: async function () {
      ...
      if (this.model.FUND_NAME == null || this.model.FUND_NAME == "") {
        ...
        try {
          ...
          if (confirm("Save fund creation form as draft?")) {
    ...
    onSubmit: async function () {
      ...
      data.append("FUND_ISSUBMIT", "2");
      data.append("DRAFT_UPDATE", this.FUND_CREATION_DRAFT);
        ...
        if (this.validateFundDetails() == true) {
          try {
            ...
            if (confirm("Are you sure to submit?")) {
              ...
              const response = await servicesModule5.createFundProfile(data);
              console.log(response);
              alert("New Fund Creation has been submitted.");
              this.statusLoad = false;
              this.$router.push("/distributor/fundCreationlist");
            } else {
            }
          ...
          alert("Please recheck your Fund Creation details.");
        }
      } else {
