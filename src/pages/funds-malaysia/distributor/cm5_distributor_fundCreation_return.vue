  ...
  <div>
    <div class="container-fluid">
      ...
      <table class="table table-responsive table-borderless">
        ...
        this.$route.params.FUNDPROFILE.FUND_STATUS_FUND == 'RETURNED'
            "
          >
            <td style="width: 15%">
            ...
            <td style="width: 1%">:</td>
            <td>
              <div v-if="this.remarkFP.APPR_REMARK_FM != null">{{ this.remarkFP.APPR_REMARK_FM }} ({{ this.remarkFP.CREATE_TIMESTAMP }}})</div>
              <div v-else>-</div>
            </td>
          </tr>
          <tr
        ...
        this.$route.params.FUNDPROFILE.FUND_STATUS_FUND == 'RETURNED'
          ...
          >
            ...
            <td style="width: 1%">:</td>
            <td>
              <div v-if="this.remarkFP.APPR_REMARK_FIMM != null" > {{ this.remarkFP.APPR_REMARK_FIMM }} ({{ this.remarkFP.LATEST_UPDATE }})</div>
              <div v-else>-</div>
              </td>
          </tr>
        </tbody>
                  ...
                  <div>
                    ...
                    <div class="col-md-12 mb-3"
                      ...
                      >
                        ...
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.DATE1" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        ...
                        >
                            <b-form-datepicker id="datepicker2" v-model="fundnote.DATE2" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" v-if="fundnote.FUNDNOTES_ID == 7">
                        ...
                        <b-form-group
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.DATE2" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-minor"
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.DATE3" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" v-if="fundnote.FUNDNOTES_ID == 8">
                        ...
                        <b-form-group
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.DATE4" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" v-if="fundnote.FUNDNOTES_ID == 9">
                        ...
                        <b-form-group
                          ...
                          label-for="input-degree-minor"
                        >
                            <b-form-datepicker id="datepicker1" v-model="fundnote.DATE5" class="mb-2"></b-form-datepicker>
                        </b-form-group>
                      </div>
                      <div class="row mt-3" v-if="fundnote.FUNDNOTES_ID == 21">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date"
                      ...
                      <div class="row mt-3" v-if="fundnote.FUNDNOTES_ID == 24">
                        <b-form-group
                          class="required col-md-6"
                          id="fieldset-degree-major"
                          label="Date"
  ...
  methods: {
    ...
    async getFundProfileDataById() {
      ...
      if (response == null) {
        ...
        // alert(this.FPData.FUND_NAME);
        this.model.FUND_NAME = response.FUND_NAME;
        // alert(this.model.FUND_NAME);
        ...
        this.selected = response.FUND_NOTES_ID;
        console.log(this.selected);
        this.getDocumentById();
        // // FUND NOTES SECTION
        // this.model.FUND_NOTES.FUNDNOTES_ID
        // this.model.DATE_1
        // this.model.DATE_2
        // this.model.DATE_3
        // this.model.DATE_4
    ...
    //     data.append("DIST_USER_GROUP", JSON.parse(user).user_id);
