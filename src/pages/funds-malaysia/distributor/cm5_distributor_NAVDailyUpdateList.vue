    ...
    <va-card class="mt-5 col-12">
      ...
      >
        ...
        <template slot="actions" slot-scope="props">
          <h5 class="mt-1">
            <span v-if="props.rowData.Status=='DRAFT' || props.rowData.Status=='RETURNED' || props.rowData.Status=='ACTIVE'"
              v-b-tooltip.hover
              title="edit"
            ...
            ></span>
             <span v-if="props.rowData.Status=='APPROVED'|| props.rowData.Status=='PENDING'"
              v-b-tooltip.hover
              title="view"
                v-on:click="viewRecord(props.rowData)"
              class="badge badge-primary mr-2"
  ...
  methods: {
    ...
    async viewRecord(data) {
     ...
     create() {
      ...
      this.$router.push({ name: "navDailyUpdate" });
    },
  },
