<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">NAV Management : List of Submission Pending for Verification</h4>
      <br />
...
export default {
  ...
  methods: {
    viewList() {
      this.$router.push('/distributor/navManagementOverviewList')
    },
    ...
    getApprRecordById: async function () {
      ...
      const response = await services01Module5.getDistApprRecordById(APPR_GROUP_ID,JSON.parse(user).USER_DIST_ID);
