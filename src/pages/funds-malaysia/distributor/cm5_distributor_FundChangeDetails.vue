          ...
          <va-card>
            ...
            <div>
              ...
              <b-tabs
                ...
                ref="tabs"
              >
                <b-tab v-on:click="tabIndex == 0" title="Fund Profile">
                  <br />
                  <vue-form-generator
                    :model="model"
                  ...
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund2"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm2"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund3"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm3"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund4"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm4"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund5"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm5"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund6"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm6"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund7"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm7"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund8"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm8"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund9"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm9"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund10"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm10"
                    ></vue-form-generator>
                  </div>
                  <br />
                  <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund11"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm11"
                    ></vue-form-generator>
                  </div>
                  <!-- <div>
                    <vue-form-generator
                      :model="model"
                      :schema="schemaNewFund12"
                      :options="formOptions"
                      @model-updated="onModelUpdated"
                      ref="profileFundForm12"
                    ></vue-form-generator>
                  </div> -->
                  <br />
                  <button
                ...
                <b-tab v-on:click="tabIndex == 1" title="Document">
                ...
                <b-tab v-on:click="tabIndex == 2" title="Additional Document">
                  <div>
                    <div style="overflow-x: auto">
                    <table class="table">
                      <thead>
...
export default {
  ...
  mounted() {
    ...
    this.getAllinvestmentFocus();
    this.getAllunitStructure();
    ...
    this.getRunningNoFundCode();

    const status = JSON.parse(fund).APPL_STATUS;
    if (status == 'DRAFT') {
  ...
  methods: {
    ...
    getTempDocumentById: async function () {
      console.log("get fund temp docs")
      const fund = localStorage.getItem("FUNDPROFILE");
      const response = await servicesModule5.getDocForFundManagement(
        JSON.parse(fund).FUND_TEMP_ID
      );
      response.DATADOC.forEach((element) => {
        element.DOCU_BLOB = this.b64toBlobPDF(
          element.DOCU_BLOB,
        ...
        if (element.DOCU_GROUP == 1) {
          ...
          this.file5 = [];
          this.model.file5 = [];
          this.file5 = element.DOCU_BLOB;
          this.model.file5.push(data);
        } else if (element.DOCU_GROUP == 7) {
          this.file6 = [];
          this.model.file6 = [];
          this.file6 = element.DOCU_BLOB;
          this.model.file6.push(data);
        } else if (element.DOCU_GROUP == 8) {
          this.file7 = [];
          this.model.file7 = [];
          this.file7 = element.DOCU_BLOB;
          this.model.file7.push(data);
        }
      });
    },
    ...
    async getFundProfileDataById() {
      ...
      this.getFundTempDataById();
    },
    async getFundTempDataById() {
      const fund = localStorage.getItem("FUNDPROFILE");
      const response2 = await servicesModule5.fund_tempDataDetail(
        JSON.parse(fund).FUND_TEMP_ID
      );
      if (response2 == null) {
      } else {

        if (response2.FUND_NAME != null) {
          this.model.FUND_NAME = response2.FUND_NAME;
        }else {

        }
        this.getTempDocumentById();
        if (response2.FUND_NAME_CHINESE != null) {
          this.model.FUND_NAME_CHINESE = response2.FUND_NAME_CHINESE;
        }else {

        }
        if (response2.FUND_NAME_SHORT != null ) {
          this.model.FUND_NAME_SHORT = response2.FUND_NAME_SHORT;
        }else {

        }
        if (response2.FUND_TYPE != null) {
            if (response2.FUND_TYPE != null) {
            this.model.FUND_TYPE = {
              FMS_FUNDTYPE_ID: response2.FUND_TYPE,
              FUND_TYPE_FULLNAME: response2.FUND_TYPE_FULLNAME,
            };
          }
        } else {

        }
        if (response2.FUND_CATEGORY != null ) {
          this.model.FUND_CATEGORY = {
          FMS_FUNDCATEGORY_ID: response2.FUND_CATEGORY,
          GROUP_ASSET: response2.GROUP_ASSET,
        };
        } else {

        }
        if (response2.FUND_CATEGORY != null ) {
          if (response2.FUND_CATEGORY == 1) {
          this.showFundDateExpiry = true;
          this.model.FUND_DATE_EXPIRY = response2.FUND_DATE_EXPIRY;
        } else if (response2.FUND_CATEGORY == 3) {
          this.showFundDateExpiry = true;
          this.model.FUND_DATE_EXPIRY = response2.FUND_DATE_EXPIRY;
        } else {
          this.showFundDateExpiry = false;
        ...
        if (response2.FUND_DAILY_NAV != null ) {
          this.model.FUND_DAILY_NAV = response2.FUND_DAILY_NAV;
        }else {

        }
        // //add old fund detail append

        if (response2.FUND_SUB_MANAGER != null ) {
          this.model.FUND_SUB_MANAGER = response2.FUND_SUB_MANAGER;

        }else {

        }

        if (response2.FUND_SYARIAH_COMP != null) {
          this.model.FUND_SYARIAH_COMP = response2.FUND_SYARIAH_COMP;
        }else {

        }

        if (response2.DECLARE_FUND_PERFORMANCE != null) {
          this.model.DECLARE_FUND_PERFORMANCE = response2.FUND_FUND_PERFORMANCE;
        }else {

        }

        if (response2.FUND_ANNUAL_MGMT != null) {
          this.model.FUND_ANNUAL_MGMT = response2.FUND_STATUS_ANNUAL_MGMT;
        }else {

        }

        if (response2.FUND_STATUS_SRI_ESG != null ) {
          this.model.FUND_STATUS_SRI_ESG = response2.FUND_STATUS_SRI_ESG;
        }else {

        }

        if (response2.FUND_STATUS_EPF != null) {
          this.model.FUND_STATUS_EPF = response2.FUND_STATUS_EPF;
        }else {

        }

        if (response2.FUND_STATUS_MER != null ) {
          this.model.FUND_STATUS_MER = response2.FUND_STATUS_MER;
        }else {

        }

        if (response2.FUND_STATUS_FEE_PERFORMANCE != null ) {
          this.model.FUND_STATUS_FEE_PERFORMANCE =
          response.FUND_STATUS_FEE_PERFORMANCE;
        }else {
        ...
        if (response2.FUND_STATUS_RATIO != null ) {
          this.model.FUND_STATUS_RATIO = response2.FUND_STATUS_RATIO;
        }else {

        }

        if (response2.FUND_STATUS_HURDLE_RATE != null ) {
          this.model.FUND_STATUS_HURDLE_RATE = response2.FUND_STATUS_HURDLE_RATE;
        }else {

        }

        if (response2.FUND_STATUS_SALE_CHARGE != null ) {
          this.model.FUND_STATUS_SALE_CHARGE = response2.FUND_STATUS_SALE_CHARGE;
        }else {

        }

        if (response2.FUND_STATUS_MINIMUM_SALE_CHARGE != null ) {
          this.model.FUND_STATUS_MINIMUM_SALE_CHARGE =
          response2.FUND_STATUS_MINIMUM_SALE_CHARGE;
        }else {

        }

        if (response2.FUND_STATUS_MAXIMUM_SALE_CHARGE != null ) {
          this.model.FUND_STATUS_MAXIMUM_SALE_CHARGE =
          response2.FUND_STATUS_MAXIMUM_SALE_CHARGE;
        }else {
    ...
    saveAsDraft: async function () {
      ...
      if (this.model.FUND_NAME == null || this.model.FUND_NAME == "") {
        ...
        // alert (fundprofile);
        if (fundprofile == null) {
          data.append("FUND_PROFILE_ID", null);
        } else if (fundprofile != null) {
          data.append(
            "FUND_PROFILE_ID",
            JSON.parse(fundprofile).FUND_PROFILE_ID
          );
          data.append("FUND_TEMP_ID",JSON.parse(fundprofile).FUND_TEMP_ID);
          data.append("STATUS", JSON.parse(fundprofile).TS_ID);
        }
        ...
        if (this.model.setVisibleUmbrellaFund == true) {
          console.log("Self Entry Umbrella Fund");
          data.append("UMBRELLA_FUND", this.model.inputUmbrellaFund ?? "");
        } else {
          data.append(
            "UMBRELLA_FUND",
            this.model.selectedUmbrellaFund.FMS_UMBRELLA_FUND_ID ?? ""
          );
        }
        ...
        data.append("FUND_LIPPER_CODE", this.model.LIPPER_CODE_MEMBER ?? "");
        data.append("FUND_ISIN", this.model.ISIN ?? "");
        data.append("FUND_SC_CODE", this.model.SC_CODE_MEMBER ?? "");
        //add old fund detail append

        data.append("FUND_NAME_CHINESE", this.model.FUND_NAME_CHINESE ?? "");
        data.append("FUND_NAME_SHORT", this.model.FUND_NAME_SHORT ?? "");

        data.append("FUND_TYPE", this.model.FUND_TYPE.FMS_FUNDTYPE_ID ?? "");
        data.append(
          "FUND_CATEGORY",
          this.model.FUND_CATEGORY.FMS_FUNDCATEGORY_ID ?? ""
        );
        data.append(
          "FUND_DOMICILE",
          this.model.FUND_DOMICILE.FUND_DOMICILE_ID ?? ""
        );
        data.append(
          "FUND_CURR_DENOMINATION",
          this.model.FUND_CURR_DENOMINATION.SETTING_GENERAL_ID ?? ""
        );
        data.append(
          "FUND_DATE_EXPIRY",
          moment(this.model.FUND_DATE_EXPIRY).format("YYYY-MM-DD") ?? ""
        ...
        data.append(
          "FUND_FUND_PERFORMANCE",
          this.model.DECLARE_FUND_PERFORMANCE ?? ""
        );

        data.append(
          "FUND_STATUS_SRI_ESG",
          this.model.FUND_STATUS_SRI_ESG ?? ""
        );
        data.append("FUND_STATUS_EPF", this.model.FUND_STATUS_EPF ?? "");
        data.append(
          "FUND_DATE_SRI_ESG_EFFECTIVE_DATE",
          moment(this.model.FUND_DATE_SRI_ESG_EFFECTIVE_DATE).format(
            "YYYY-MM-DD"
          ) ?? ""
        );
        data.append("FUND_EPF_CODE", this.model.FUND_EPF_CODE ?? "");
        // data.append("",moment().format("YYYY-MM-DD"));

        data.append(
          "FUND_STATUS_ANNUAL_MGMT",
          this.model.FUND_ANNUAL_MGMT ?? ""
        );
        data.append("FUND_STATUS_MER", this.model.FUND_STATUS_MER ?? "");
        data.append(
          "FUND_STATUS_FEE_PERFORMANCE",
          this.model.FUND_STATUS_FEE_PERFORMANCE ?? ""
        );
        data.append("FUND_FEE_ANNUAL", this.model.FUND_FEE_ANNUAL ?? "");
        data.append("FUND_MER", this.model.FUND_MER ?? "");
        data.append(
          "FUND_FEE_PERFORMANCE",
          this.model.FUND_FEE_PERFORMANCE ?? ""
        );

        data.append("FUND_STATUS_RATIO", this.model.FUND_STATUS_RATIO ?? "");
        data.append("FUND_RATIO", this.model.FUND_RATIO ?? "");

        data.append(
          "FUND_STATUS_HURDLE_RATE",
          this.model.FUND_STATUS_HURDLE_RATE ?? ""
        );
        data.append(
          "FUND_STATUS_SALE_CHARGE",
          this.model.FUND_STATUS_SALE_CHARGE ?? ""
        );
        data.append(
          "FUND_STATUS_MAXIMUM_SALE_CHARGE",
          this.model.FUND_STATUS_MAXIMUM_SALE_CHARGE
        ...
        if (this.model.FUND_STATUS_SALE_CHARGE == 1) {
          data.append(
            "FUND_SALE_CHARGE_MINIMUM",
            this.model.FUND_SALES_CHARGE_MINIMUM ?? "N/A"
          );
          data.append(
            "FUND_SALE_CHARGE_MAXIMUM",
            this.model.FUND_SALES_CHARGE_MAXIMUM ?? "N/A"
          );
          data.append(
            "FUND_SALE_CHARGE_EFFECTIVE",
            this.model.FUND_SALES_CHARGE_EFFECTIVE ?? "N/A"
          );
        } else {
          data.append("FUND_MINIMUM_SALE_CHARGE", "N/A");
          data.append("FUND_MAXIMUM_SALE_CHARGE", "N/A");
          data.append("FUND_SALES_CHARGE", "N/A");
        }
        ...
        // data.append(
        //   "FUND_SALE_CHARGE_MAXIMUM",
        //   this.model.FUND_SALE_CHARGE_MAXIMUM ?? ""
        // );
        // data.append(
        //   "FUND_SALE_CHARGE_EFFECTIVE",
        //   this.model.FUND_SALE_CHARGE_EFFECTIVE ?? ""
        ...
        data.append(
          "FUND_DATE_LAUNCH",
          moment(this.model.FUND_DATE_LAUNCH).format("YYYY-MM-DD") ?? ""
        );
        data.append("FUND_PRICE_PERUNIT", this.model.FUND_PRICE_PERUNIT ?? "");
        data.append(
          "FUND_YEAR_END",
          moment(this.model.FUND_YEAR_END).format("YYYY-MM-DD") ?? ""
        );
        data.append("FUND_SCHEME", this.model.FUND_SCHEME.FMS_SCHEME_ID ?? "");
        data.append(
          "FUND_UNITS",
          this.model.FUND_UNITS.SETTING_GENERAL_ID ?? ""
        );
        data.append(
          "FUND_INVESTMENT_FOCUS",
          this.model.FUND_FOCUS_INVESTMENT.SETTING_GENERAL_ID ?? ""
        );

        data.append("FUND_FEEDER", this.model.FUND_FEEDER ?? "");
        data.append("FUND_FOF", this.model.FUND_FOF ?? "");
        data.append("FUND_UCITS", this.model.FUND_UCITS ?? "");
        data.append(
          "FUND_ASEAN_CIS_STATUS",
          this.model.FUND_ASEAN_CIS_STATUS ?? ""
        );
        ...
        data.append("FUND_ISDRAFT", "1");

        //File upload
        data.append("file0", this.model.file0);
        data.append("file1", this.model.file1);
        data.append("file2", this.model.file2);
        data.append("file3", this.model.file3);
        data.append("file4", this.model.file4);

        //
        data.append("file5", this.model.file5);
        // data.append("file6", this.model.file6);
        // data.append("file7", this.model.file7);

        try {
          console.log("current data" + JSON.stringify(data));
          if (confirm("Save fund management application form as draft?")) {
            data.append("isSubmit", 1);
            const response = await servicesModule5.submitFundChangeDetails(
              data
            );
            console.log(response);
            this.$router.push("/distributor/fundManagementList");
          } else {
          }
        } catch (error) {
          console.log(error);
    ...
    onSubmit: async function () {
      ...
      data.append("FUND_DOMICILE", this.model.FUND_DOMICILE.FUND_DOMICILE_ID);
      data.append(
        "FUND_CURR_DENOMINATION",
        this.model.FUND_CURR_DENOMINATION.SETTING_GENERAL_ID
      );
      ...
      data.append("FUND_SYARIAH_COMP", this.model.FUND_SYARIAH_COMP);
      data.append("FUND_ANNUAL_MGMT", this.model.FUND_ANNUAL_MGMT);
      data.append("FUND_FUND_PERFORMANCE", this.model.DECLARE_FUND_PERFORMANCE);

      data.append("FUND_STATUS_SRI_ESG", this.model.FUND_STATUS_SRI_ESG);
      data.append("FUND_STATUS_EPF", this.model.FUND_STATUS_EPF);
      data.append(
        "FUND_DATE_SRI_ESG_EFFECTIVE_DATE",
        moment(this.model.FUND_DATE_SRI_ESG_EFFECTIVE_DATE).format("YYYY-MM-DD")
      );
      data.append("FUND_EPF_CODE", this.model.FUND_EPF_CODE);
      // data.append("",moment().format("YYYY-MM-DD"));

      data.append("FUND_STATUS_ANNUAL_MGMT", this.model.FUND_ANNUAL_MGMT);
      data.append("FUND_STATUS_MER", this.model.FUND_STATUS_MER);
      data.append(
        "FUND_STATUS_FEE_PERFORMANCE",
        this.model.FUND_STATUS_FEE_PERFORMANCE
      ...
      // data.append(
      //   "FUND_SALE_CHARGE_EFFECTIVE",
      //   this.model.FUND_SALES_CHARGE_EFFECTIVE ?? ""
      // );
      ...
      data.append(
        "FUND_YEAR_END",
        moment(this.model.FUND_YEAR_END).format("YYYY-MM")
      );
      data.append("FUND_SCHEME", this.model.FUND_SCHEME.FMS_SCHEME_ID);
      data.append("FUND_UNITS", this.model.FUND_UNITS.SETTING_GENERAL_ID);
      data.append(
        "FUND_INVESTMENT_FOCUS",
        this.model.FUND_FOCUS_INVESTMENT.SETTING_GENERAL_ID
      );
      ...
      data.append("FUND_FOF", this.model.FUND_FOF);
      data.append("FUND_UCITS", this.model.FUND_UCITS);
      data.append("FUND_ASEAN_CIS_STATUS", this.model.FUND_ASEAN_CIS_STATUS);

      // FUND NOTES SECTION
      data.append("FUND_NOTES", JSON.stringify(this.fundNotes) ?? "");

      //Fund Status
      data.append("FUND_STATUS_FUND", "2");

      data.append("FUND_ISDRAFT", "2");
      ...
      var remarkEntry = "M - New Fund Management application";
      ...
      if (this.validateFundName() == true) {
        if (this.validateFundDetails() == true) {
          try {
            console.log("current data" + JSON.stringify(data));
            if (confirm("Are you sure to submit?")) {
              ...
              console.log(response);
              alert("New Fund Management application has been submitted.");
              this.statusLoad = false;
              this.$router.push("/distributor/fundManagementList");
            } else {
            }
          ...
          alert("Please recheck your Fund details.");
        }
      } else {
        alert("Please recheck your Fund Profile Name.");
      }
    },
  },
};
