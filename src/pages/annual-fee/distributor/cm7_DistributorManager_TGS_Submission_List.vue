<template>
  <va-card>
    <div class="row">
      <h4 slot="header" class="card-title">TOTAL GROSS SALES AS AT 31 DECEMBER {{new Date().getFullYear()-1}}</h4>
      <br />
...
export default {
  ...
  methods: {
    ...
    // back button
    back () {
      this.$router.push('/distributor/DistributorManager-TGS-Submission')
    },
