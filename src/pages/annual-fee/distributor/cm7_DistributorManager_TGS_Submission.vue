  ...
  <va-card>
    ...
    <va-card class="mt-5 col-12">
      ...
      <div>
        ...
        <div class="float-right">
          <button :disabled="BTN_DISABLE_MODE" @click="submittgs('draft')" type="button" class="mr-2 btn btn-info btn-fill btn-md">
          ...
          <button
            @click="submittgs('complete')" :disabled="((RecordList.length !== tgsEntryIds.length) || BTN_DISABLE_MODE)"
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      viewList () {
        this.$router.push('/distributor/DistributorManager-TGS-Submission-List')
      },
      ...
      async getTgsComment() {
         ...
         this.model.remark = res.data.comment ? res.data.comment.TGS_REMARKS_MANAGER : ''
      }
