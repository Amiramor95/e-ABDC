    ...
    <va-card class="mt-5 col-12">
      ...
      >
        ...
        <template slot="action" slot-scope="row">
          <button type="button" @click="remarksModal(row.rowData)" :class="row.rowData.AUM_REMARKS_RD || FILL_IDS.includes(row.rowData.AUM_ENTRY_ID) ?
      ...
      <div>
        ...
        <div class="float-right">
          <button @click="submit('draft')" type="button" class="mr-2 btn btn-info btn-fill btn-md">
            <i class="fa fa-pencil-square-o"/> &nbsp; Save as draft 
          </button>
          <button @click="submit('return_to_dist')" :disabled="!aumEntryIds.length" type="button" class="mr-2 btn btn-warning btn-fill btn-md">
            <i class="fa fa-reply"/> &nbsp; Return to Distributor
          </button>
          <button @click="submit('return_to_r_a')" :disabled="!aumEntryIds.length" type="button" class="mr-2 btn btn-warning btn-fill btn-md">
            <i class="fa fa-reply"/> &nbsp; Return to R & A
          </button>
          <button @click="submit('complete')" type="button" :disabled="aumEntryIds.length !== RecordList.length" class="ml-1 btn btn-success btn-fill btn-md">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      viewList () {
        this.$router.push('/fimm/AnnualFee-RD-AUMVerification-Details')
      },
      ...
      remarksModal (row) {
        ...
        this.remark = row.AUM_REMARKS_RD
      },
      ...
      saveRemarkModalComment () {
        ...
        this.RecordList[index].AUM_REMARKS_RD = this.remark
      },
      ...
      async submit (mode) {
        if (confirm('Are you sure?')) {
          ...
          if (response.status) {
            this.$toast.success('AMSF  successfully submission')
          }
        }
      },
