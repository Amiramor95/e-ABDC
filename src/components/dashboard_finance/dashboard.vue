  ...
  <div>
    <div class="dashboard">
         <div class="row row-equal">
                <div v-for="(chart, id) in filteredDataFinance" :key="id" :class="chart.style">
   ...
   getFinanceSetting: async function() {
      let settingArray = [];
       ...
       const userGroup=this.userdata.USER_GROUP_ID;
        ...
        const response = await services06Module1.getFinanceSetting(userID,userTYPE,userGroup,userDepartment,userDIVISION);
        console.log("Finance List=",response);
