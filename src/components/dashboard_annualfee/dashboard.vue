...
export default {
  ...
  methods: {
   getAnnualfeeSetting: async function() {
        let settingArray = [];
        ...
        const response = await services07Module0.getAnnualFeeSetting(userID,userTYPE,userGROUP,userDepartment,userDIVISION);
        console.log("Annual List=",response);
