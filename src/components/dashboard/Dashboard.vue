  ...
  <div>
    <div class="dashboard">
      <span
                v-if ="utype == 'fimm'"
                v-b-tooltip.hover
                title ="Main Dashboard Setting"
                v-on:click="main_dashboard_setting1"
       ...
       <br>
        ...
        <card :array="cardArray"></card>
         <div class="row row-equal">
                ...
                <chart :chartId="chart.id" :chartType="chart.type" :chartName= "chart.name" :chartView= "chart.graphid" :chartStyle= "chart.settingstyle" :chartModule= "chart.module"></chart>
                </div>
         </div>
    </div>
