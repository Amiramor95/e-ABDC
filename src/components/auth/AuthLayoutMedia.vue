<template>
  <b-overlay :show="overlay_show" rounded="sm">
    <div class="auth-layout bg-others row align-content--center">
      ...
      <div class="flex xs12 flex-center" style="padding-left: 13rem">
        <p class="texttitle">MEDIA</p>
      </div>
        ...
        <div class="d-flex justify--start">
          <va-card class="auth-layout__card transparent">
            <va-tabs v-model="tabIndex" center>
              ...
              <va-tab>Register As New User</va-tab>
            </va-tabs>
...
export default {
  ...
  created: function () {
    // manage scoping here
    const vm = this;
    Event.$on("signup-media:overlay", function (show) {
