  ...
  <div> 
      <b-form-group class="required">
        <b-form-input class="d-none"
          ...
          type="number" 
          :state="validatePRSFP_PC_Date('UTC_Registration_Date')"
          aria-describedby="utc-registraion-msg">
        </b-form-input>
          
        <b-form-invalid-feedback id="utc-registraion-msg">
          Sorry, You cannot proceed. Your UTS Registration date is less than 5 years to apply for PRS License.
          <br>
      ...
      <b-form-group
        label-for="exemption-PRSFP_PR-docs"
...
export default {
  ...
  methods: {
    ...
    validatePRSFP_PC_Date(UTC_Registration_Date) {
    ...
    getDataToSave() {
      let dataToSave = {
        ...
        EXEMPTION_CATEGORY_DOCUMENT_NAME: 'CONSULTANT_EXEMPTION_PRSFP_PR_DOCUMENT',
      };
      return dataToSave;
    },
    ...
    saveExemptionDocuments(){
      ...
      data.append("TABLE_NAME", 'CONSULTANT_EXEMPTION_PRSFP_PR_DOCUMENT');
      data.append("FIELD_NAME", 'CONSULTANT_EXEMPTION_PRSFP_PR');
    ...
    getExemptionDocument: async function() {
      const response = await services02module2.getConsultantDocuments(this.savedConsultantData.CONSULTANT_ID, 'CONSULTANT_EXEMPTION_PRSFP_PR_DOCUMENT');
      response.forEach(el => {
