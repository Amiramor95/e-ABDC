<template>
  ...
  >
    ...
    <div class="app-layout__container">
      ...
      >
      <!-- <div v-if="isDashboard" class="app-dashboard"></div> -->
        <main
...
<script>
import AppPageLayout from '@/components/consultant/AppPageLayout'
import AppNavbar from '@/components/consultant/app-navbar/AppNavbar'
import AppTopbar from '@/components/consultant/app-topbar/AppTopbar'
import AppSidebar from '@/components/consultant/app-sidebar/AppSidebar'
